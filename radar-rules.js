({ "2047.name":{ _name:"2047",
    ".":[ { title:"分类",
        docs:"https://rssdocs.quickso.cn/bbs.html#2047-fen-lei",
        source:[ "/" ],
        target:"/2047/:category?/:sort?" } ] },
  "12306.cn":{ _name:"12306",
    kyfw:[ { title:"售票信息",
        docs:"https://rssdocs.quickso.cn/travel.html#_12306-shou-shu-piao-piao-xin-shen-xi",
        source:[ "/",
          "/otn/leftTicket/init" ],
        target:(params, url) => {
    ...
    www:[ { title:"最新动态",
        docs:"https://rssdocs.quickso.cn/travel.html#_12306-zui-cuo-xin-dong-tai",
        source:[ "/",
          "/mormhweb/1/:id/index_fl.html" ],
        target:"/12306/zxdt/:id" } ] },
  "18comic.org":{ _name:"18comic 禁漫天堂",
    ".":[ { title:"成人 A 漫",
        docs:"https://rssdocs.quickso.cn/anime.html#18comic-jin-man-tian-tang-cheng-ren-a-man",
        source:[ "/" ],
        target:"/18comic/:category?/:time?/:order?/:keyword?" },
      { title:"搜索",
        docs:"https://rssdocs.quickso.cn/anime.html#18comic-jin-man-tian-tang-sou-suo",
        source:[ "/" ],
        target:"/18comic/search/:option?/:category?:keyword?/:time?/:order?" },
      { title:"专辑",
        docs:"https://rssdocs.quickso.cn/anime.html#18comic-jin-man-tian-tang-zhuan-ji",
        source:[ "/" ],
        target:"/18comic/album/:id" },
      { title:"文庫",
        docs:"https://rssdocs.quickso.cn/anime.html#18comic-jin-man-tian-tang-wen-ku",
        source:[ "/" ],
        target:"/18comic/blogs/:category?" } ] },
  "19lou.com":{ _name:"19 楼",
    ".":[ { title:"头条",
        docs:"https://rssdocs.quickso.cn/bbs.html#19-lou-tou-tiao",
        source:[ "/" ],
  ...
  "2cycd.com":{ _name:"二次元虫洞",
    ".":[ { title:"板块",
        docs:"https://rssdocs.quickso.cn/bbs.html#er-ci-yuan-chong-dong",
        source:"/:path",
        target:(params, url) => {
                    let pid, sort;
  ...
  "35photo.pro":{ _name:"35PHOTO",
    ".":[ { title:"New photos",
        docs:"https://rssdocs.quickso.cn/picture.html#35photo-new-photos",
        source:[ "/new",
          "/" ],
        target:"/35photo/new" },
      { title:"Featured photos",
        docs:"https://rssdocs.quickso.cn/picture.html#35photo-featured-photos",
        source:[ "/new/actual",
          "/" ],
        target:"/35photo/actual" },
      { title:"New interesting",
        docs:"https://rssdocs.quickso.cn/picture.html#35photo-new-interesting",
        source:[ "/new/interesting",
          "/" ],
        target:"/35photo/interesting" },
      { title:"Photos on the world map",
        docs:"https://rssdocs.quickso.cn/picture.html#35photo-photos-on-the-world-map",
        source:[ "/new/map",
          "/" ],
        target:"/35photo/map" },
      { title:"Genre",
        docs:"https://rssdocs.quickso.cn/picture.html#35photo-genre",
        source:[ "/" ],
        target:(params, url) => `/35photo/genre/${url.match(/genre_(\d+)/)[1]}` },
      { title:"Author",
        docs:"https://rssdocs.quickso.cn/picture.html#35photo-author",
        source:[ "/:id",
          "/" ],
        target:"/35photo/author/:id" } ] },
  "36kr.com":{ _name:"36氪",
    ".":[ { title:"资讯",
        docs:"https://rssdocs.quickso.cn/new-media.html#_36kr-zi-xun",
        source:[ "/information/:category",
          "/" ],
        target:"/36kr/information/:category" },
      { title:"快讯",
        docs:"https://rssdocs.quickso.cn/new-media.html#_36kr-kuai-xun",
        source:[ "/newsflashes",
          "/" ],
        target:"/36kr/newsflashes" },
      { title:"用户文章",
        docs:"https://rssdocs.quickso.cn/new-media.html#_36kr-yong-hu-wen-zhang",
        source:[ "/user/:id",
          "/" ],
        target:"/36kr/user/:id" },
      { title:"主题文章",
        docs:"https://rssdocs.quickso.cn/new-media.html#_36kr-zhu-ti-wen-zhang",
        source:[ "/motif/:id",
          "/" ],
        target:"/36kr/motif/:id" },
      { title:"专题文章",
        docs:"https://rssdocs.quickso.cn/new-media.html#_36kr-zhuan-ti-wen-zhang",
        source:[ "/topics/:id",
          "/" ],
        target:"/36kr/topics/:id" },
      { title:"搜索文章",
        docs:"https://rssdocs.quickso.cn/new-media.html#_36kr-sou-suo-wen-zhang",
        source:[ "/search/articles/:keyword",
          "/" ],
        target:"/36kr/search/articles/:keyword" },
      { title:"搜索快讯",
        docs:"https://rssdocs.quickso.cn/new-media.html#_36kr-sou-suo-kuai-xun",
        source:[ "/search/newsflashes/:keyword",
          "/" ],
        target:"/36kr/search/newsflashes/:keyword" } ] },
  "423down.com":{ _name:"423down",
    www:[ { title:"首页",
        docs:"https://rssdocs.quickso.cn/bbs.html#_423down",
        source:"/",
  ...
  "50forum.org.cn":{ _name:"经济 50 人论坛",
    ".":[ { title:"专家文章",
        docs:"https://rssdocs.quickso.cn/new-media.html#jing-ji-50-ren-lun-tan",
        source:[ "/home/article/index/category/zhuanjia.html",
          "/" ],
        target:"/50forum" } ] },
  "52hrtt.com":{ _name:"52hrtt 华人头条",
    ".":[ { title:"新闻",
        docs:"https://rssdocs.quickso.cn/new-media.html#_52hrtt-hua-ren-tou-tiao",
        source:"/",
  ...
  "78dm.net":{ _name:"78动漫",
    ".":[ { title:"新品速递",
        docs:"https://rssdocs.quickso.cn/anime.html#_78-dong-man-xin-pin-su-di",
        source:[ "/news",
          "/" ],
        target:(params, url) =>
                    `/78dm${new URL(url)
                        ...
                        .replace(/\.html$/, '')}` },
      { title:"精彩评测",
        docs:"https://rssdocs.quickso.cn/anime.html#_78-dong-man-jing-cai-ping-ce",
        source:[ "/eval_list",
          "/" ],
        target:(params, url) =>
                    `/78dm${new URL(url)
                        ...
                        .replace(/\.html$/, '')}` },
      { title:"新品速递",
        docs:"https://rssdocs.quickso.cn/anime.html#_78-dong-man-hao-tie-tui-jian",
        source:[ "/ht_list",
          "/" ],
        target:(params, url) =>
                    `/78dm${new URL(url)
  ...
  "7mmtv.tv":{ _name:"7mmtv.tv",
    ".":[ { title:"分类",
        docs:"https://rssdocs.quickso.cn/multimedia.html#7mmtv-fen-lei",
        source:[ "/" ],
        target:(params, url) => `/7mmtv/${new URL(url).toString().match(/\/(en|ja|ko|zh)\/([\w\d-]+\/){0,2}/)[1]}` },
      { title:"制作商",
        docs:"https://rssdocs.quickso.cn/multimedia.html#7mmtv-zhi-zuo-shang",
        source:[ "/" ],
        target:(params, url) => `/7mmtv/${new URL(url).toString().match(/\/(en|ja|ko|zh)\/([\w\d-]+\/){0,2}/)[1]}` } ] },
  "8kcosplay.com":{ _name:"8KCosplay",
    ".":[ { title:"最新",
        docs:"https://rssdocs.quickso.cn/picture.html#_8kcosplay",
        source:[ "/" ],
        target:"/8kcos" },
      { title:"分类",
        docs:"https://rssdocs.quickso.cn/picture.html#_8kcosplay",
  ...
  "8world.com":{ _name:"8视界",
    ".":[ { title:"分类",
        docs:"https://rssdocs.quickso.cn/new-media.html#_8-shi-jie-fen-lei",
        source:[ "/:category",
          "/" ],
        target:"/8world/:category?" },
      { title:"标签",
        docs:"https://rssdocs.quickso.cn/new-media.html#_8-shi-jie-biao-qian",
        source:[ "/topic/:id",
          "/" ],
        target:"/8world/topic/:id" } ] },
  "91porn.com":{ _name:"91porn",
    ".":[ { title:"今日排行",
        docs:"https://rssdocs.quickso.cn/multimedia.html#_91porn",
        source:[ "/index.php" ],
        target:"/91porn" },
      { title:"作者",
        docs:"https://rssdocs.quickso.cn/multimedia.html#_91porn",
  ...
  "95mm.org":{ _name:"MM范",
    ".":[ { title:"分类",
        docs:"https://rssdocs.quickso.cn/picture.html#mm-fan-fen-lei",
        source:"/",
        target:"/95mm/tab/:tab?" },
      { title:"标签",
        docs:"https://rssdocs.quickso.cn/picture.html#mm-fan-biao-qian",
        source:"/",
        target:"/95mm/tag/:tag" },
      { title:"集合",
        docs:"https://rssdocs.quickso.cn/picture.html#mm-fan-ji-he",
        source:"/",
        target:"/95mm/category/:category" } ] },
  "9to5toys.com":{ _name:"9to5",
    ".":[ { title:"Toys 分站",
        docs:"https://rssdocs.quickso.cn/new-media.html#_9to5",
        source:[ "/",
          "/guides/:tag" ],
  ...
  "aamacau.com":{ _name:"論盡媒體 AllAboutMacau Media",
    ".":[ { title:"话题",
        docs:"https://rssdocs.quickso.cn/new-media.html#lun-jin-mei-ti-allaboutmacau-media-hua-ti",
        source:[ "/" ],
        target:"/:category?/:id?" } ] },
  "abmedia.io":{ _name:"abmedia.io",
    www:[ { title:"首页最新新闻",
        docs:"https://rssdocs.quickso.cn/new-media.html#lian-xin-wen-abmedia-shou-ye-zui-xin-xin-wen",
        source:[ "/" ],
        target:"/abmedia/index" },
      { title:"频道",
        docs:"https://rssdocs.quickso.cn/new-media.html#lian-xin-wen-abmedia-lei-bie",
        source:[ "/category/:catehory" ],
        target:"/abmedia/:category" } ] },
  "abskoop.com":{ _name:"A姐分享",
    ".":[ { title:"存档列表",
        docs:"https://rssdocs.quickso.cn/multimedia.html#abskoop",
        source:[ "/archives" ],
        target:"/abskoop" } ] },
  "acfun.cn":{ _name:"AcFun",
    www:[ { tilte:"番剧",
        docs:"https://rssdocs.quickso.cn/anime.html#acfun-fan-ju",
        source:"/bangumi/:id",
        target:(params) => `/acfun/bangumi/${params.id.replace('aa', '')}` },
      { title:"用户投稿",
        docs:"https://rssdocs.quickso.cn/anime.html#acfun-yong-hu-tou-gao",
        source:"/u/:id",
        target:"/acfun/user/video/:id" },
      { title:"文章",
        docs:"https://rssdocs.quickso.cn/anime.html#acfun",
  ...
  "acs.org":{ _name:"American Chemistry Society",
    pubs:[ { title:"Journal",
        docs:"https://rssdocs.quickso.cn/journal.html#american-chemistry-society",
        source:[ "/journal/:id",
          "/" ],
        target:"/acs/journal/:id" } ] },
  "agemys.cc":{ _name:"AGE动漫",
    ".":[ { title:"最近更新",
        docs:"https://rssdocs.quickso.cn/anime.html#age-dong-man",
        source:[ "/update",
          "/" ],
  ...
  "aotter.net":{ _name:"電獺少女",
    agirls:[ { title:"分類",
        docs:"https://rssdocs.quickso.cn/new-media.html##dian-ta-shao-nu",
  ...
  "gitlab.io":{ _name:"GitLab",
    agora0:[ { title:"零博客",
        docs:"https://rssdocs.quickso.cn/blog.html#ling-bo-ke-fen-lei",
        source:[ "/blog/:category",
          "/" ],
        target:"/agora0/:category" } ] },
  "ahjzu.edu.cn":{ _name:"安徽建筑大学",
    news:[ { title:"通知公告",
        docs:"https://rssdocs.quickso.cn/university.html#an-hui-jian-zhu-da-xue",
        source:"/20/list.htm",
        target:"/ahjzu/news" } ] },
  "aicaijing.com":{ _name:"AI 财经社",
    www:[ { title:"最新文章",
        docs:"https://rssdocs.quickso.cn/finance.html#ai-cai-jing-she-zui-xin-wen-zhang",
        source:[ "/" ],
        target:"/aicaijing/latest" },
      { title:"封面文章",
        docs:"https://rssdocs.quickso.cn/finance.html#ai-cai-jing-she-feng-mian-wen-zhang",
        source:[ "/" ],
        target:"/aicaijing/cover" },
      { title:"推荐资讯",
        docs:"https://rssdocs.quickso.cn/finance.html#ai-cai-jing-she-tui-jian-zi-xun",
        source:[ "/" ],
        target:"/aicaijing/recommend" },
      { title:"热点 & 深度",
        docs:"https://rssdocs.quickso.cn/finance.html#ai-cai-jing-she-re-dian-shen-du",
  ...
  "aiea.org":{ _name:"Asian Innovation and Entrepreneurship Association",
    www:[ { title:"Seminar Series",
        docs:"https://rssdocs.quickso.cn/study.html#AIEA-Seminar-Series",
        source:[ "/0504",
          "/" ],
        target:"/aiea/seminars/upcoming" } ] },
  "airchina.com.cn":{ _name:"中国国际航空公司",
    www:[ { title:"服务公告",
        docs:"https://rssdocs.quickso.cn/travel.html#zhong-guo-guo-ji-hang-kong-gong-si",
        source:"/",
        target:"/airchina/announcement" } ] },
  "ajmide.com":{ _name:"阿基米德FM",
    m:[ { title:"播客",
        docs:"https://rssdocs.quickso.cn/multimedia.html#a-ji-mi-de-fm-bo-ke",
        source:[ "/m/brand" ],
        target:(_, url) => {
  ...
  "aliyun.com":{ _name:"阿里云",
    developer:[ { title:"开发者社区 - 主题",
        docs:"https://rssdocs.quickso.cn/programming.html#a-li-yun",
        source:[ "/group/:type" ],
  ...
  "aliyundrive.com":{ _name:"阿里云盘",
    www:[ { title:"文件列表",
        docs:"https://rssdocs.quickso.cn/programming.html#a-li-yun-pan",
        source:[ "/s/:share_id",
          "/s/:share_id/folder/:parent_file_id" ],
        target:"/aliyundrive/files/:share_id/:parent_file_id?" } ] },
  "aljazeera.com":{ _name:"Aljazeera 半岛电视台",
    ".":[ { title:"News",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#aljazeera-ban-dao-dian-shi-tai-xin-wen",
        source:[ "/:category",
          "/" ],
        target:"/aljazeera/english/:category" },
      { title:"Tag",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#aljazeera-ban-dao-dian-shi-tai-biao-qian",
        source:[ "/tag/:id",
          "/" ],
        target:"/aljazeera/english/tag/:id" },
      { title:"Official RSS",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#aljazeera-ban-dao-dian-shi-tai-guan-fang-rss",
  ...
  "allrecode.com":{ _name:"重构",
    ".":[ { title:"推荐",
        docs:"https://rssdocs.quickso.cn/news-media.html#chong-gou-tui-jian",
        source:[ "/recommends",
          "/" ],
        target:"/allrecode/recommends" },
      { title:"快讯",
        docs:"https://rssdocs.quickso.cn/news-media.html#chong-gou-kuai-xun",
        source:[ "/news",
          "/" ],
        target:"/allrecode/news" },
      { title:"资讯",
        docs:"https://rssdocs.quickso.cn/news-media.html#chong-gou-zi-xun",
        source:[ "/:category",
          "/" ],
        target:"/allrecode/:category" } ] },
  "ally.net.cn":{ _name:"艾莱资讯",
    rail:[ { title:"世界轨道交通资讯网",
        docs:"https://rssdocs.quickso.cn/new-media.html#ai-lai-zi-xun",
        source:[ "/",
          "/html/:category?/:topic?" ],
        target:"/ally/rail/:category?/:topic?" } ] },
  "android.com":{ _name:"Android Developers",
    developer:[ { title:"SDK Platform Tools release notes",
        docs:"https://rssdocs.quickso.cn/program-update.html#android-sdk-platform-tools-release-notes",
        source:[ "/studio/releases/platform-tools",
          "/" ],
        target:"/android/platform-tools-releases" } ] },
  "anquanke.com":{ _name:"安全客",
    ".":[ { title:"分类订阅",
        docs:"https://rssdocs.quickso.cn/programming.html#an-quan-ke",
        source:[ "/:category",
          "/" ],
        target:(params) => `/anquanke/${params.category === 'week-list' ? 'week' : params.category}` } ] },
  "apnews.com":{ _name:"AP News",
    ".":[ { title:"话题",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#ap-news",
        source:"/hub/:topic",
        target:"/apnews/topics/:topic" } ] },
  "appcenter.ms":{ _name:"App Center",
    install:[ { title:"App Center Release",
        docs:"https://rssdocs.quickso.cn/program-update.html#app-center",
  ...
  "apple.com":{ _name:"Apple",
    apps:[ { title:"应用更新",
        docs:"https://rssdocs.quickso.cn/program-update.html#app-store-mac-app-store",
  ...
  "appledaily.com":{ _name:"苹果新闻网",
    tw:[ { title:"首頁",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#ping-guo-xin-wen-wang",
        source:[ "/:channel" ],
        target:(params) => {
  ...
  "appleinsider.com":{ _name:"AppleInsider",
    ".":[ { title:"分类",
        docs:"https://rssdocs.quickso.cn/new-media.html#appleinsider-fen-lei",
        source:[ "/:category",
          "/" ],
  ...
  "arknights.jp":{ _name:"明日方舟",
    ak:[ { title:"アークナイツ（日服新闻）",
        docs:"https://rssdocs.quickso.cn/game.html#ming-ri-fang-zhou",
  ...
  "blog.leanstack.com":{ _name:"Ash Maurya's blog",
    ".":[ { title:"Ash Maurya's blog",
        docs:"https://rssdocs.quickso.cn/en/blog.html#ash-maurya",
        source:[ "/" ],
        target:"/ash-maurya" } ] },
  "asiantolick.com":{ _name:"Asian to lick",
    ".":[ { title:"首页",
        docs:"https://rssdocs.quickso.cn/picture.html#asian-to-lick-shou-ye",
        source:[ "/" ],
        target:"/asiantolick" },
      { title:"分类",
        docs:"https://rssdocs.quickso.cn/picture.html#asian-to-lick-fen-lei",
        source:[ "/" ],
        target:(params, url) => `/asiantolick/category/${new URL(url).toString().split('-').pop()}` },
      { title:"标签",
        docs:"https://rssdocs.quickso.cn/picture.html#asian-to-lick-biao-qian",
        source:[ "/" ],
        target:(params, url) => `/asiantolick/tag/${new URL(url).toString().split('-').pop()}` },
      { title:"搜索",
        docs:"https://rssdocs.quickso.cn/picture.html#asian-to-lick-sou-suo",
        source:[ "/search/:keyword",
          "/" ],
        target:"/asiantolick/search/:keyword?" } ] },
  "asus.com.cn":{ _name:"Asus 华硕",
    ".":[ { title:"固件",
        docs:"https://rssdocs.quickso.cn/program-update.html#hua-shuo",
        source:[ "/" ],
  ...
  "atcoder.jp":{ _name:"AtCoder",
    ".":[ { title:"Posts",
        docs:"https://rssdocs.quickso.cn/programming.html#atcoder-posts",
        source:[ "/posts",
          "/" ],
        target:(params, url) => `/atcoder/post/${new URL(url).searchParams.get('lang') ?? 'en'}/${new URL(url).searchParams.get('keyword') ?? ''}` },
      { title:"Contests",
        docs:"https://rssdocs.quickso.cn/programming.html#atcoder-contests",
  ...
  "audiobar.cn":{ _name:"音频应用",
    ".":[ { title:"最新主题",
        docs:"https://rssdocs.quickso.cn/bbs.html#yin-pin-ying-yong",
        source:[ "/all.php" ],
        target:"/audiobar/latest" } ] },
  "baidu.com":{ _name:"百度",
    gushitong:[ { title:"首页指数",
        docs:"https://rssdocs.quickso.cn/finance.html#bai-du-gu-shi-tong",
        source:[ "/" ],
        target:"/gushitong/index" } ],
    tieba:[ { title:"帖子列表",
        docs:"https://rssdocs.quickso.cn/bbs.html#bai-du-tie-ba",
        source:"f",
        target:(params, url) => {
      ...
      { title:"用户帖子",
        docs:"https://rssdocs.quickso.cn/bbs.html#tie-ba",
        source:"/home/main",
        target:(params, url) => {
  ...
  "baijingapp.com":{ _name:"白鲸出海",
    ".":[ { title:"最新",
        docs:"https://rssdocs.quickso.cn/new-media.html#bai-jing-chu-hai",
        source:[ "/article",
          "/" ],
        target:"/baijing" },
      { title:"资讯",
  ...
  "bandcamp.com":{ _name:"Bandcamp",
    ".":[ { title:"Tag",
        docs:"https://rssdocs.quickso.cn/multimedia.html#bandcamp",
        source:[ "/tag/:tag" ],
        target:"/bandcamp/tag/:tag" },
      { title:"Upcoming Live Streams",
        docs:"https://rssdocs.quickso.cn/multimedia.html#bandcamp-upcoming-live-streams",
  ...
  "bangumi.moe":{ _name:"萌番組",
    ".":[ { title:"最新",
        docs:"https://rssdocs.quickso.cn/anime.html#meng-fan-zu-zui-xin",
        source:[ "/" ],
        target:"/bangumi/moe" },
      { title:"标签",
        docs:"https://rssdocs.quickso.cn/anime.html#meng-fan-zu-biao-qian",
        source:[ "/search/index" ],
        target:"/bangumi/moe/:tags?" } ] },
  "bangumi.online":{ _name:"アニメ新番組",
    ".":[ { title:"當季新番",
        docs:"https://rssdocs.quickso.cn/anime.html#アニメ-xin-fan-zu-dang-ji-xin-fan",
        source:[ "/" ],
        target:"/bangumi/online" } ] },
  "bangumi.tv":{ _name:"Bangumi 番组计划",
    ".":[ { title:"小组话题",
        docs:"https://rssdocs.quickso.cn/anime.html#bangumi",
        source:"/group/:id",
  ...
  "barronschina.com.cn":{ _name:"巴伦周刊中文版",
    ".":[ { title:"栏目",
        docs:"https://rssdocs.quickso.cn/finance.html#ba-lun-zhou-kan-zhong-wen-ban-lan-mu",
        source:[ "/" ],
        target:"/barronschina/:category?" } ] },
  "bbcnewslabs.co.uk":{ _name:"BBC News Labs",
    ".":[ { title:"News",
        docs:"https://rssdocs.quickso.cn/programming.html#bbc-news-labs",
        source:"/",
        target:"/bbcnewslabs/news" } ] },
  "behance.net":{ _name:"Behance",
    www:[ { title:"User",
        docs:"https://rssdocs.quickso.cn/design.html#behance-yong-hu-zuo-pin",
        source:[ "/:user",
          "/:user/:types",
  ...
  "bendibao.com":{ _name:"本地宝",
    ".":[ { title:"焦点资讯",
        docs:"https://rssdocs.quickso.cn/new-media.html#ben-di-bao-jiao-dian-zi-xun",
        source:"/",
        target:"/bendibao/news/:city" } ] },
  "bigquant.com":{ _name:"BigQuant",
    ".":[ { title:"专题报告",
        docs:"https://rssdocs.quickso.cn/finance.html#bigquant-zhuan-ti-bao-gao",
        source:"/",
        target:"/bigquant/collections" } ] },
  "bilibili.com":{ _name:"bilibili",
    www:[ { title:"分区视频",
        docs:"https://rssdocs.quickso.cn/social-media.html#bilibili",
        source:[ "/v/*tpath",
          "/documentary",
          "/movie",
          "/tv" ] },
    ...
    manga:[ { title:"漫画更新",
        docs:"https://rssdocs.quickso.cn/social-media.html#bilibili-man-hua-geng-xin",
        source:"/detail/:comicid",
        target:"/bilibili/manga/update/:comicid" } ],
    live:[ { title:"直播开播",
        docs:"https://rssdocs.quickso.cn/live.html#bi-li-bi-li-zhi-bo-zhi-bo-kai-bo",
        source:[ "/:roomID" ],
        target:"/bilibili/live/room/:roomID" } ] },
  "biodiscover.com":{ _name:"生物探索",
    www:[ { title:"频道",
        docs:"https://rssdocs.quickso.cn/new-media.html#sheng-wu-tan-suo",
        source:"/:channel",
        target:"/biodiscover/:channel" } ] },
  "bioone.org":{ _name:"BioOne",
    ".":[ { title:"Featured articles",
        docs:"https://rssdocs.quickso.cn/journal.html#bioone-featured-articles",
        source:"/",
        target:"/bioone/featured" },
      { title:"Journals",
        docs:"https://rssdocs.quickso.cn/journal.html#bioone-journals",
        source:[ "/journals/:journal",
          "/" ],
        target:"/bioone/journals/:journal" } ] },
  "xbiquwx.la":{ _name:"笔趣阁",
    ".":[ { title:"",
        docs:"https://rssdocs.quickso.cn/reading.html#bi-qu-ge-xiao-shuo",
        source:[ "/" ],
  ...
  "bit.edu.cn":{ _name:"北京理工大学",
    rszhaopin:[ { title:"人才招聘",
        docs:"https://rssdocs.quickso.cn/university.html#bei-jing-li-gong-da-xue-ren-cai-zhao-pin",
        source:[ "/" ],
        target:"/bit/:category?" } ] },
  "bitbucket.com":{ _name:"Bitbucket",
    ".":[ { title:"Commits",
        docs:"https://rssdocs.quickso.cn/programming.html#bitbucket",
  ...
  "bitmovin.com":{ _name:"Bitmovin",
    ".":[ { title:"Blog",
        docs:"https://rssdocs.quickso.cn/programming.html#bitmovin",
        source:[ "/blog",
          "/" ],
        target:"/bitmovin/blog" } ] },
  "bjfu.edu.cn":{ _name:"北京林业大学",
    graduate:[ { title:"研究生院培养动态",
        docs:"https://rssdocs.quickso.cn/university.html#bei-jing-lin-ye-da-xue",
        source:"/",
        target:"/bjfu/grs" } ],
    it:[ { title:"信息学院通知",
        docs:"https://rssdocs.quickso.cn/university.html#bei-jing-lin-ye-da-xue",
  ...
  "bjx.com.cn":{ _name:"北极星电力网",
    guangfu:[ { title:"光伏 - 分类",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#bei-ji-xing-dian-li-wang",
        source:[ "/:type",
          "/" ],
        target:"/bjx/gf/:type?" } ],
    huanbao:[ { title:"环保要闻",
  ...
  "theblockbeats.info":{ _name:"律动",
    rszhaopin:[ { title:"快讯",
        docs:"https://rssdocs.quickso.cn/new-media.html#lu-dong-xin-wen-kuai-xun",
        source:[ "/" ],
  ...
  "bookfere.com":{ _name:"书伴",
    ".":[ { title:"分类",
        docs:"https://rssdocs.quickso.cn/reading.html#shu-ban" } ] },
  "brave.com":{ _name:"Brave",
    ".":[ { title:"Release Notes",
        docs:"https://rssdocs.quickso.cn/program-update.html#brave-release-notes",
        source:[ "/latest",
          "/" ],
        target:"/brave/latest" } ] },
  "brooklynmuseum.org":{ _name:"Brooklyn Museum",
    www:[ { title:"Exhibitions",
        docs:"https://rssdocs.quickso.cn/en/travel.html#brooklyn-museum" } ] },
  "bse.cn":{ _name:"北京证券交易所",
    ".":[ { title:"栏目",
        docs:"https://rssdocs.quickso.cn/finance.html#bei-jing-zheng-quan-jiao-yi-suo-lan-mu",
        source:[ "/" ],
        target:"/bse/:category?/:keyword?" } ] },
  "btbtt20.com":{ _name:"BT之家",
    ".":[ { title:"分类",
        docs:"https://rssdocs.quickso.cn/multimedia.html#bt-zhi-jia",
        source:[ "/" ],
        target:"/btzj/:category?" } ] },
  "bupt.edu.cn":{ _name:"北京邮电大学",
    ".":[ { title:"人才招聘",
        docs:"https://rssdocs.quickso.cn/university.html#bei-jing-you-dian-da-xue-ren-cai-zhao-pin",
        source:[ "/" ],
        target:"/bupt/rczp" } ] },
  "c114.com.cn":{ _name:"C114通信网",
    ".":[ { title:"滚动新闻",
        docs:"https://rssdocs.quickso.cn/new-media.html#c114-tong-xin-wang-gun-dong-xin-wen",
        source:[ "/news/roll.asp",
          "/" ],
        target:"/c114/roll" } ] },
  "caareviews.org":{ _name:"caa.reviews",
    ".":[ { title:"Book Reviews",
        docs:"https://rssdocs.quickso.cn/journal.html#caa-reviews",
        source:[ "/reviews/book" ],
  ...
  "cahkms.org":{ _name:"全国港澳研究会",
    ".":[ { title:"分类",
        docs:"https://rssdocs.quickso.cn/new-media.html#quan-guo-gang-ao-yan-jiu-hui-fen-lei",
        source:"/",
        target:"/cahkms/:category?" } ] },
  "cankaoxiaoxi.com":{ _name:"参考消息",
    china:[ { title:"中国新闻",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#can-kao-xiao-xi",
        source:[ "/" ],
  ...
  "cbirc.gov.cn":{ _name:"中国银行保险监督管理委员会",
    ".":[ { title:"分类",
        docs:"https://rssdocs.quickso.cn/government.html#zhong-guo-yin-xing-bao-xian-jian-du-guan-li-wei-yuan-hui",
        source:[ "/:category",
          "/" ],
        target:"/cbirc/:category?" } ] },
  "cbnweek.com":{ _name:"第一财经杂志",
    ".":[ { title:"首页",
        docs:"https://rssdocs.quickso.cn/finance.html#di-yi-cai-jing-za-zhi-shou-ye",
        source:[ "/" ],
        target:"/cbnweek" } ] },
  "ccac.org.mo":{ _name:"澳门廉政公署",
    ".":[ { title:"最新消息",
        docs:"https://rssdocs.quickso.cn/government.html#ao-men-lian-zheng-gong-shu",
        source:[ "/:lang/news.html" ],
        target:"/ccac/news/all/:lang" } ] },
  "ccfcv.ccf.org.cn":{ _name:"计算机视觉专委会",
    www:[ { title:"学术动态 - 学术前沿",
        docs:"https://rssdocs.quickso.cn/study.html#ji-suan-ji-shi-jue-zhuan-wei-hui",
  ...
  "ccreports.com.cn":{ _name:"消费者报道",
    www:[ { title:"要闻",
        docs:"https://rssdocs.quickso.cn/shopping.html#xiao-fei-zhe-bao-dao-yao-wen",
        source:[ "/" ],
        target:"/ccreports/article" } ] },
  "cctv.com":{ _name:"CCTV",
    navi:[ { title:"栏目订阅",
        docs:"https://rssdocs.quickso.cn/multimedia.html#cntv-lan-mu",
        source:[ "/" ],
        target:"/cntv/:column" } ] },
  "cde.org.cn":{ _name:"国家药品监督管理局药品审评中心",
    www:[ { title:"政务新闻",
        docs:"https://rssdocs.quickso.cn/government.html#guo-jia-yao-pin-shen-ping-wang-zhan-shou-ye",
  ...
  "cdi.com.cn":{ _name:"国家高端智库 / 综合开发研究院",
    ".":[ { title:"栏目",
        docs:"https://rssdocs.quickso.cn/new-media.html#guo-jia-gao-duan-zhi-ku-zong-he-kai-fa-yan-jiu-yuan",
        source:[ "/Article/List",
          "/" ],
        target:(params, url) => `/cdi/${new URL(url).searchParams.get('ColumnId')}` } ] },
  "cdzjryb.com":{ _name:"成都住建蓉 e 办",
    zw:[ { title:"商品住房购房登记",
        docs:"https://rssdocs.quickso.cn/other.html#cheng-dou-zhu-jian-rong-e-ban",
        source:[ "/lottery/accept/projectList",
          "/" ],
        target:"/cdzjryb/zw/projectList" } ] },
  "cebbank.com":{ _name:"中国光大银行",
    ".":[ { title:"外汇牌价 - 牌价总览",
        docs:"https://rssdocs.quickso.cn/new-media.html#eprice",
  ...
  "changba.com":{ _name:"唱吧",
    ".":[ { title:"用户",
        docs:"https://rssdocs.quickso.cn/social-media.html#chang-ba",
        source:[ "/s/:userid" ],
        target:"/changba/:userid" } ] },
  "chaoxing.com":{ _name:"超星",
    ".":[ { title:"期刊",
        docs:"https://rssdocs.quickso.cn/reading.html#chao-xing-qi-kan",
        source:[ "/" ],
        target:(params, url) => `/chaoxing/qk/${new URL(url).searchParams.get('mags')}` } ] },
  "chaping.cn":{ _name:"差评",
    ".":[ { title:"图片墙",
        docs:"https://rssdocs.quickso.cn/new-media.html#cha-ping",
        source:[ "/" ],
  ...
  "china.com":{ _name:"中华网",
    military:[ { title:"军事新闻",
        docs:"https://rssdocs.quickso.cn/new-media.html#zhong-hua-wang",
        source:"/news",
  ...
  "chinacef.cn":{ _name:"首席经济学家论坛",
    ".":[ { title:"最新文章列表",
        docs:"https://rssdocs.quickso.cn/finance.html#shou-xi-jing-ji-xue-jia-lun-tan",
        source:[ "/" ],
        target:"/chinacef" },
      { title:"专家文章",
        docs:"https://rssdocs.quickso.cn/finance.html#shou-xi-jing-ji-xue-jia-lun-tan-zhuan-jia",
        source:[ "/index.php/experts/zjmain/experts_id/:experts_id" ],
        target:"/chinacef/:experts_id" },
      { title:"金融热点",
        docs:"https://rssdocs.quickso.cn/finance.html#shou-xi-jing-ji-xue-jia-lun-tan-jin-rong-re-dian",
        source:[ "/index.php/index/index" ],
        target:"/chinacef/portal/hot" } ] },
  "chinadegrees.com.cn":{ _name:"中华人民共和国学位证书查询",
    ".":[ { title:"各学位授予单位学位证书上网进度",
        docs:"https://rssdocs.quickso.cn/study.html#zhong-hua-ren-min-gong-he-guo-xue-wei-zheng-shu-cha-xun",
        source:[ "/help/*province" ],
        target:(params) => `/chinadegrees/${params.province.replace('unitSwqk', '').replace('.html', '')}` } ] },
  "chinafactcheck.com":{ _name:"有据",
    ".":[ { title:"最新文章列表",
        docs:"https://rssdocs.quickso.cn/other.html#you-ju-zui-xin-wen-zhang-lie-biao",
        source:[ "/" ],
        target:"/chinafactcheck" } ] },
  "chinanews.com.cn":{ _name:"中国新闻网",
    ".":[ { title:"最新",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#zhong-xin-wang",
        source:[ "/" ],
        target:"/chinanews" } ] },
  "chinathinktanks.org.cn":{ _name:"中国智库网",
    www:[ { title:"观点与实践",
        docs:"https://rssdocs.quickso.cn/study.html#zhong-guo-zhi-ku-wang",
        source:"",
        target:(params, url) => `/chinathinktanks/${new URL(url).searchParams.get('id')}` } ] },
  "chinaventure.com.cn":{ _name:"投中网",
    ".":[ { title:"分类",
        docs:"https://rssdocs.quickso.cn/new-media.html#tou-zhong-wang",
        source:[ "/" ],
        target:"/chinaventure" } ] },
  "ciidbnu.org":{ _name:"中国收入分配研究院",
    ".":[ { title:"分类",
        docs:"https://rssdocs.quickso.cn/new-media.html#",
        source:[ "/new1.asp",
          "/" ],
        target:(_params, url) => `/ciidbnu/${new URL(url).searchParams.get('pagetype')}` } ] },
  "github.com":{ _name:"GitHub",
    ".":[ { title:"Issues / Pull Requests 评论",
        docs:"https://rssdocs.quickso.cn/programming.html#github",
  ...
  "cmde.org.cn":{ _name:"国家药品监督管理局医疗器械技术审评中心",
    www:[ { title:"通用",
        docs:"https://rssdocs.quickso.cn/government.html#guo-jia-yao-pin-jian-du-guan-li-ju-yi-liao-qi-xie-ji-shu-shen-ping-zhong-xin",
        source:[ "/*cate" ],
        target:(params) => `/cmde/${params.cate.replace('/index.html', '')}` } ] },
  "cn-healthcare.com":{ _name:"健康界",
    ".":[ { title:"首页-资讯",
        docs:"https://rssdocs.quickso.cn/new-media.html#jian-kang-jie",
        source:[ "/" ],
        target:"/cn-healthcare/index" } ] },
  "cnbc.com":{ _name:"CNBC",
    search:[ { title:"全文 RSS",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#cnbc",
  ...
  "cnbeta.com":{ _name:"cnBeta",
    ".":[ { title:"最新",
        docs:"https://rssdocs.quickso.cn/new-media.html#cnbeta-zuixin",
        source:[ "/" ],
        target:"/cnbeta" },
      { title:"分类",
        docs:"https://rssdocs.quickso.cn/new-media.html#cnbeta-fenlei",
        source:[ "/category/:id",
          "/" ],
        target:"/cnbeta/category/:id" },
      { title:"主题",
        docs:"https://rssdocs.quickso.cn/new-media.html#cnbeta-zhuti",
        source:[ "/topics/:id",
          "/" ],
        target:"/cnbeta/topics/:id" } ] },
  "cncf.io":{ _name:"CNCF",
    ".":[ { title:"Blog",
        docs:"https://rssdocs.quickso.cn/programming.html#cncf",
        source:[ "/blog" ],
        target:"/cncf/blog" },
      { title:"News",
        docs:"https://rssdocs.quickso.cn/programming.html#cncf",
  ...
  "cngal.org":{ _name:"CnGal",
    www:[ { title:"每周速报",
        docs:"https://rssdocs.quickso.cn/anime.html#cngal-mei-zhou-su-bao",
        source:[ "/",
          "/weeklynews" ],
        target:"/cngal/weekly" },
      { title:"制作者/游戏新闻",
        docs:"https://rssdocs.quickso.cn/anime.html#cngal-zhi-zuo-zhe-you-xi-xin-wen",
        source:[ "/entries/index/:id" ],
        target:"/cngal/entry/:id" } ] },
  "cnjxol.com":{ _name:"南湖清风",
    ".":[ { title:"嘉兴日报",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#nan-hu-qing-feng-jia-xing-ri-bao",
        source:[ "/" ],
        target:"/cnjxol/jxrb/:id" },
      { title:"南湖晚报",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#nan-hu-qing-feng-nan-hu-wan-bao",
        source:[ "/" ],
        target:"/cnjxol/nhwb/:id" } ] },
  "cnki.net":{ _name:"中国知网",
    navi:[ { title:"期刊",
        docs:"https://rssdocs.quickso.cn/journal.html#zhong-guo-zhi-wang-qi-kan",
        source:[ "/knavi/journals/:name/detail" ],
        target:"/cnki/journals/:name" },
      { title:"网络首发",
        docs:"https://rssdocs.quickso.cn/journal.html#zhong-guo-zhi-wang-wang-luo-shou-fa",
        source:[ "/knavi/journals/:name/detail" ],
        target:"/cnki/journals/debut/:name" } ],
    kns:[ { title:"作者期刊文献",
        docs:"https://rssdocs.quickso.cn/journal.html#zhong-guo-zhi-wang-zuo-zhe-qi-kan-wen-xian",
        source:[ "/kcms/detail/knetsearch.aspx",
          "/" ],
        target:(_, url) => `/cnki/author/${new URL(url).searchParams.get('code')}` } ] },
  "cntheory.com":{ _name:"理论网",
    paper:[ { title:"学习时报",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#li-lun-wang-xue-xi-shi-bao",
        source:[ "/" ],
        target:(params, url) => `/cntheory/paper/${new URL(url).toString().match(/-(\w+)\.htm/)[1]}` } ] },
  "codeforces.com":{ _name:"Codeforces",
    www:[ { title:"最新比赛",
        docs:"https://rssdocs.quickso.cn/programming.html#codeforces-zui-xin-bi-sai",
        source:[ "/contests" ],
        target:"/codeforces/contests" } ] },
  "comicskingdom.com":{ _name:"Comics Kingdom",
    ".":[ { title:"Archive",
        docs:"https://rssdocs.quickso.cn/anime.html#comics-kingdom",
        source:[ "/:name/*",
          "/:name" ],
        target:"/comicskingdom/:name" } ] },
  "consumer.org.hk":{ _name:"消费者委员会",
    ".":[ { title:"文章",
        docs:"https://rssdocs.quickso.cn/new-media.html#xiao-fei-zhe-wei-yuan-hui-wen-zhang",
        source:[ "/" ],
        target:"/consumer/:category?/:language?/:keyword?" } ] },
  "cool18.com":{ _name:"酷 18",
    ".":[ { title:"分站",
        docs:"https://rssdocs.quickso.cn/picture.html#cool-18",
        source:"/",
        target:"/cool18/:id?/:type?/:keyword?" } ] },
  "coolapk.com":{ _name:"酷安",
    ".":[ { title:"图文",
        docs:"https://rssdocs.quickso.cn/social-media.html#ku-an" },
      { title:"头条",
        docs:"https://rssdocs.quickso.cn/social-media.html#ku-an" },
      { title:"看看号",
        docs:"https://rssdocs.quickso.cn/social-media.html#ku-an" },
  ...
  "coomer.party":{ _name:"Coomer",
    ".":[ { title:"Artist",
        docs:"https://rssdocs.quickso.cn/multimedia.html#coomer-artist",
        source:[ "/onlyfans/user/:id",
          "/" ],
        target:"/coomer/artist/:id" },
      { title:"Recent Posts",
        docs:"https://rssdocs.quickso.cn/multimedia.html#coomer-recent-posts",
        source:[ "/posts",
          "/" ],
        target:"/coomer/posts" } ] },
  "ey.gov.tw":{ _name:"行政院消费者保护会",
    cpc:[ { title:"新闻稿",
        docs:"https://rssdocs.quickso.cn/government.html#tai-wan-xing-zheng-yuan-xiao-fei-zhe-bao-hu-hui",
        source:"/Page/:type",
        target:(params) => {
  ...
  "cpuid.com":{ _name:"CPUID",
    ".":[ { title:"News",
        docs:"https://rssdocs.quickso.cn/program-update.html#cpuid",
        source:[ "/news.html",
          "/" ],
        target:"/cpuid/news" } ] },
  "cqwu.net":{ _name:"重庆文理学院",
    www:[ { title:"通知",
        docs:"https://rssdocs.quickso.cn/university.html#chong-qing-wen-li-xue-yuan",
        source:"/:type",
        target:(params) => {
  ...
  "creative-comic.tw":{ _name:"CCC 創作集",
    ".":[ { title:"漫畫",
        docs:"https://rssdocs.quickso.cn/anime.html#ccc-chuang-zuo-ji",
        source:[ "/book/:id/*" ],
        target:"/creative-comic/:id" } ] },
  "csc.edu.cn":{ _name:"国家留学网",
    www:[ { title:"遴选通知",
        docs:"https://rssdocs.quickso.cn/other.html#guo-jia-liu-xue-wang",
        source:"/*",
  ...
  "cscse.edu.cn":{ _name:"中国留学网",
    ".":[ { title:"通知公告",
        docs:"https://rssdocs.quickso.cn/study.html#zhong-guo-liu-xue-wang-tong-zhi-gong-gao",
        source:[ "/cscse/index/tzgg",
          "/" ],
        target:"/cscse/tzgg" } ] },
  "csdn.net":{ _name:"CSDN",
    blog:[ { title:"博客",
        docs:"https://rssdocs.quickso.cn/blog.html#csdn",
        source:[ "/:user" ],
        target:"/csdn/blog/:user" } ] },
  "csu.edu.cn":{ _name:"中南大学",
    cse:[ { title:"计算机学院",
        docs:"https://rssdocs.quickso.cn/university.html#zhong-nan-da-xue",
        source:[ "/index/:type" ],
  ...
  "cts.com.tw":{ _name:"華視",
    news:[ { title:"新聞",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#hua-shi-xin-wen",
        source:"/:category/index.html",
        target:"/cts/:category" } ] },
  "cuc.edu.cn":{ _name:"中国传媒大学",
    yz:[ { title:"研究生招生网",
        docs:"https://rssdocs.quickso.cn/university.html#zhong-guo-chuan-mei-da-xue",
        source:"/*",
        target:"/" } ] },
  "curius.app":{ _name:"Curius",
    ".":[ { title:"用户",
        docs:"https://rssdocs.quickso.cn/social-media.html#curius",
        source:"/:name",
        target:"/curius/links/:name" } ] },
  "cw.com.tw":{ _name:"天下雜誌",
    ".":[ { title:"最新上線",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#tian-xia-za-zhi",
        source:[ "/today",
          "/" ],
        target:"/cw/today" },
      { title:"主頻道",
  ...
  "dahecube.com":{ _name:"大河财立方",
    ".":[ { title:"新闻",
        docs:"https://rssdocs.quickso.cn/new-media.html#da-he-cai-li-fang",
  ...
  "dapenti.com":{ _name:"喷嚏",
    ".":[ { title:"图卦",
        docs:"https://rssdocs.quickso.cn/picture.html#pen-ti",
  ...
  "darwinawards.com":{ _name:"Darwin Awards",
    ".":[ { title:"Award Winners",
        docs:"https://rssdocs.quickso.cn/other.html#darwin-awards-award-winners",
        source:[ "/darwin",
          "/" ],
        target:"/darwinawards" } ] },
  "dayanzai.me":{ _name:"大眼仔旭",
    ".":[ { title:"大眼仔旭",
        docs:"https://rssdocs.quickso.cn/bbs.html#dayanzai",
        source:[ "/:category",
          "/:category/*" ],
        target:"/dayanzai/:category" } ] },
  "buxiuse.com":{ _name:"不羞涩",
    ".":[ { title:"分类",
        docs:"https://rssdocs.quickso.cn/picture.html#bu-xiu-se",
        source:"/",
        target:(_params, url) => `/dbmv${new URL(url).searchParams.has('cid') ? `/${new URL(url).searchParams.get('cid')}` : ''}` } ] },
  "dcard.tw":{ _name:"Dcard",
    www:[ { title:"首頁帖子-最新",
        docs:"https://rssdocs.quickso.cn/bbs.html#dcard",
        source:"/f",
  ...
  "www.ddosi.org":{ _name:"🔰雨苁ℒ🔰",
    ".":[ { title:"首页",
        docs:"https://rssdocs.quickso.cn/blog.html#yu-cong-bo-ke-shou-ye",
        source:[ "/" ],
        target:"/ddosi/" },
      { title:"分类",
        docs:"https://rssdocs.quickso.cn/blog.html#yu-cong-bo-ke-fen-lei",
        source:[ "/category/:category/" ],
        target:"/ddosi/category/:category" } ] },
  "dedao.cn":{ _name:"得到",
    ".":[ { title:"知识城邦",
        docs:"https://rssdocs.quickso.cn/new-media.html#de-dao-zhi-shi-cheng-bang",
  ...
  "igetget.com":{ _name:"得到",
    ".":[ { title:"首页",
        docs:"https://rssdocs.quickso.cn/new-media.html#de-dao-shou-ye",
        source:[ "/" ],
        target:"/dedao/list/:category?" },
      { title:"新闻",
        docs:"https://rssdocs.quickso.cn/new-media.html#de-dao-xin-wen",
        source:[ "/news",
          "/" ],
        target:"/dedao/news" },
      { title:"人物故事",
        docs:"https://rssdocs.quickso.cn/new-media.html#de-dao-ren-wu-gu-shi",
        source:[ "/news",
          "/" ],
        target:"/dedao/figure" },
      { title:"视频",
        docs:"https://rssdocs.quickso.cn/new-media.html#de-dao-shi-pin",
        source:[ "/video",
          "/" ],
        target:"/dedao/video" } ],
    m:[ { title:"用户主页",
        docs:"https://rssdocs.quickso.cn/new-media.html#de-dao-yong-hu-zhu-ye",
        source:[ "/native/mine/account",
          "/" ],
        target:(params, url) => `/dedao/user/${new URL(url).searchParams.get('enId')}` } ] },
  "deepmind.com":{ _name:"DeepMind",
    ".":[ { title:"Blog",
        docs:"https://rssdocs.quickso.cn/new-media.html#deepmind",
        source:[ "/blog",
          "/" ],
        target:"/blog" } ] },
  "dgjyw.com":{ _name:"东莞教研网",
    ".":[ { title:"分类",
        docs:"https://rssdocs.quickso.cn/other.html#dong-guan-jia-yan-wang-fen-lei",
        source:[ "/" ],
        target:(params, url) => `/dgjyw/${new URL(url).toString().match(/dgjyw\.com\/(.*)\.htm$/)[1]}` } ] },
  "dhu.edu.cn":{ _name:"东华大学",
    jw:[ { title:"教务处通知",
        docs:"https://rssdocs.quickso.cn/university.html#dong-hua-da-xue" } ],
    xxgk:[ { title:"最新信息公开",
        docs:"https://rssdocs.quickso.cn/university.html#dong-hua-da-xue" } ] },
  "diandong.com":{ _name:"电动邦",
    ".":[ { title:"资讯",
        docs:"https://rssdocs.quickso.cn/new-media.html#dong-qiu-di",
        source:[ "/news" ],
  ...
  "diershoubing.com":{ _name:"二柄 APP",
    ".":[ { title:"新闻",
        docs:"https://rssdocs.quickso.cn/game.html#er-bing-app",
        source:[ "/" ],
        target:"/diershoubing/news" } ] },
  "disinfo.eu":{ _name:"EU Disinfo Lab",
    ".":[ { title:"Publications",
        docs:"https://rssdocs.quickso.cn/new-media.html#eu-disinfo-lab",
        source:[ "/" ],
        target:"/disinfo/publications" } ] },
  "diskanalyzer.com":{ _name:"What's New",
    ".":[ { title:"Change Log",
        docs:"https://rssdocs.quickso.cn/program-update.html#wiztree-whats-new",
        source:[ "/whats-new",
          "/" ],
        target:"/diskanalyzer/whats-new" } ] },
  "distill.pub":{ _name:"Distill",
    ".":[ { title:"Latest",
        docs:"https://rssdocs.quickso.cn/programming.html#distill",
        source:[ "/" ],
        target:"/distill" } ] },
  "docker.com":{ _name:"Docker Hub",
    hub:[ { title:"镜像有新 Build",
        docs:"https://rssdocs.quickso.cn/program-update.html#docker-hub",
  ...
  docschina:{ _name:"印记中文",
    ".":[ { title:"周刊 - JavaScript",
        docs:"https://rssdocs.quickso.cn/programming.html#yin-ji-zhong-wen-zhou-kan",
        source:[ "/weekly/js/*",
          "/weekly/js",
          "/" ],
  ...
  "domp4.cc":{ _name:"domp4电影",
    ".":[ { title:"最近更新",
        docs:"https://rssdocs.quickso.cn/multimedia.html#domp4-ying-shi",
        source:[ "/",
          "/custom/update.html" ],
  ...
  "douban.com":{ _name:"豆瓣",
    www:[ { title:"用户的广播",
        docs:"https://rssdocs.quickso.cn/social-media.html#dou-ban",
        source:"/people/:user/",
        target:(params, url, document) => {
  ...
  "douyin.com":{ _name:"抖音",
    ".":[ { title:"标签",
        docs:"https://rssdocs.quickso.cn/social-media.html#dou-yin",
        source:"/hashtag/:cid",
    ...
    live:[ { title:"直播间开播",
        docs:"https://rssdocs.quickso.cn/live.html#dou-yin-zhi-bo",
        source:"/:rid",
        target:"/douyin/live/:rid" } ] },
  "douyu.com":{ _name:"斗鱼",
    www:[ { title:"直播间开播",
        docs:"https://rssdocs.quickso.cn/live.html#dou-yu-zhi-bo-zhi-bo-jian-kai-bo",
        source:[ "/:id",
          "/" ],
        target:"/douyu/room/:id" } ],
    yuba:[ { title:"鱼吧帖子",
        docs:"https://rssdocs.quickso.cn/bbs.html#dou-yu-yu-ba-tie-zi",
        source:[ "/group/:id",
          "/group/newself/:id",
          "/group/newall/:id",
          "/" ],
      ...
      { title:"鱼吧跟帖",
        docs:"https://rssdocs.quickso.cn/bbs.html#dou-yu-yu-ba-gen-tie",
        source:[ "/p/:id",
          "/" ],
        target:"/douyu/post/:id" } ] },
  "sehuatang.net":{ _name:"色花堂",
    ".":[ { title:"分区帖子",
        docs:"https://rssdocs.quickso.cn/multimedia.html#se-hua-tang-fen-qu-tie-zi",
        source:[ "/:category",
          "/" ],
        target:(params, url) => {
  ...
  "dtcj.com":{ _name:"DT 财经",
    ".":[ { title:"数据侠专栏",
        docs:"https://rssdocs.quickso.cn/finance.html#dt-cai-jing",
  ...
  "dushu.io":{ _name:"樊登读书会",
    card:[ { title:"福州运营中心",
        docs:"https://rssdocs.quickso.cn/new-media.html#fan-deng-du-shu-fan-deng-fu-zhou-yun-ying-zhong-xin",
        source:[ "*" ],
        target:"/dushu/fuzhou" } ] },
  ...
  "dlut.edu.cn":{ _name:"大连理工大学",
    news:[ { title:"新闻网",
        docs:"https://rssdocs.quickso.cn/university.html#da-lian-li-gong-da-xue-xin-wen-wang",
        source:[ "/" ],
        target:(params, url) => `/dut/${url.match(/:\/\/[\w\d]+\./)[1]}/${url.match(/\.cn\/(.*)\.htm/)[1]}` } ],
    perdep:[ { title:"人事处",
        docs:"https://rssdocs.quickso.cn/university.html#da-lian-li-gong-da-xue-ren-shi-chu",
        source:[ "/" ],
        target:(params, url) => `/dut/${url.match(/:\/\/[\w\d]+\./)[1]}/${url.match(/\.cn\/(.*)\.htm/)[1]}` } ],
    teach:[ { title:"教务处",
        docs:"https://rssdocs.quickso.cn/university.html#da-lian-li-gong-da-xue-jiao-wu-chu",
        source:[ "/" ],
        target:(params, url) => `/dut/${url.match(/:\/\/[\w\d]+\./)[1]}/${url.match(/\.cn\/(.*)\.htm/)[1]}` } ],
    gs:[ { title:"研究生院",
        docs:"https://rssdocs.quickso.cn/university.html#da-lian-li-gong-da-xue-yan-jiu-sheng-yuan",
        source:[ "/" ],
        target:(params, url) => `/dut/${url.match(/:\/\/[\w\d]+\./)[1]}/${url.match(/\.cn\/(.*)\.htm/)[1]}` } ],
    ssdut:[ { title:"软件学院",
        docs:"https://rssdocs.quickso.cn/university.html#da-lian-li-gong-da-xue-ruan-jian-xue-yuan",
        source:[ "/" ],
        target:(params, url) => `/dut/${url.match(/:\/\/[\w\d]+\./)[1]}/${url.match(/\.cn\/(.*)\.htm/)[1]}` } ],
    eda:[ { title:"开发区校区",
        docs:"https://rssdocs.quickso.cn/university.html#da-lian-li-gong-da-xue-kai-fa-qu-xiao-qu",
        source:[ "/" ],
        target:(params, url) => `/dut/${url.match(/:\/\/[\w\d]+\./)[1]}/${url.match(/\.cn\/(.*)\.htm/)[1]}` } ],
    panjin:[ { title:"盘锦校区",
        docs:"https://rssdocs.quickso.cn/university.html#da-lian-li-gong-da-xue-pan-jin-xiao-qu",
        source:[ "/" ],
        target:(params, url) => `/dut/${url.match(/:\/\/[\w\d]+\./)[1]}/${url.match(/\.cn\/(.*)\.htm/)[1]}` } ],
    xsgzb:[ { title:"盘锦校区学生事务办公室",
        docs:"https://rssdocs.quickso.cn/university.html#da-lian-li-gong-da-xue-pan-jin-xiao-qu-xue-sheng-shi-wu-ban-gong-shi",
        source:[ "/" ],
        target:(params, url) => `/dut/${url.match(/:\/\/[\w\d]+\./)[1]}/${url.match(/\.cn\/(.*)\.htm/)[1]}` } ],
    pjteach:[ { title:"盘锦校区教务教学事务办公室",
        docs:"https://rssdocs.quickso.cn/university.html#da-lian-li-gong-da-xue-pan-jin-xiao-qu-jiao-wu-jiao-xue-shi-wu-ban-gong-shi",
        source:[ "/" ],
        target:(params, url) => `/dut/${url.match(/:\/\/[\w\d]+\./)[1]}/${url.match(/\.cn\/(.*)\.htm/)[1]}` } ],
    pjxqzwb:[ { title:"盘锦校区总务部",
        docs:"https://rssdocs.quickso.cn/university.html#da-lian-li-gong-da-xue-pan-jin-xiao-qu-zong-wu-bu",
        source:[ "/" ],
        target:(params, url) => `/dut/${url.match(/:\/\/[\w\d]+\./)[1]}/${url.match(/\.cn\/(.*)\.htm/)[1]}` } ],
    tjpj:[ { title:"体育与健康学院盘锦分院",
        docs:"https://rssdocs.quickso.cn/university.html#da-lian-li-gong-da-xue-ti-yu-jian-kang-xue-yuan-pan-jin-fen-yuan",
        source:[ "/" ],
        target:(params, url) => `/dut/${url.match(/:\/\/[\w\d]+\./)[1]}/${url.match(/\.cn\/(.*)\.htm/)[1]}` } ],
    dutdice:[ { title:"国际合作与交流处（港澳台办）",
        docs:"https://rssdocs.quickso.cn/university.html#da-lian-li-gong-da-xue-guo-ji-he-zuo-yu-jiao-liu-chu-gang-ao-tai-ban",
        source:[ "/" ],
        target:(params, url) => `/dut/${url.match(/:\/\/[\w\d]+\./)[1]}/${url.match(/\.cn\/(.*)\.htm/)[1]}` } ],
    tycgzx:[ { title:"体育场馆中心",
        docs:"https://rssdocs.quickso.cn/university.html#da-lian-li-gong-da-xue-ti-yu-chang-guan-zhong-xin",
        source:[ "/" ],
        target:(params, url) => `/dut/${url.match(/:\/\/[\w\d]+\./)[1]}/${url.match(/\.cn\/(.*)\.htm/)[1]}` } ] },
  "dx2025.com":{ _name:"东西智库",
    ".":[ { title:"分类",
        docs:"https://rssdocs.quickso.cn/multimedia.html#e-hentai-fen-lei",
      ...
      { title:"标签",
        docs:"https://rssdocs.quickso.cn/multimedia.html#e-hentai-biao-qian",
  ...
  "e-hentai.org":{ _name:"E-Hentai",
    ".":[ { title:"分类",
      ...
      { title:"收藏",
        docs:"https://rssdocs.quickso.cn/picture.html#e-hentai",
      ...
      { title:"搜索",
        docs:"https://rssdocs.quickso.cn/multimedia.html#e-hentai-sou-suo",
        source:[ "/:keyword",
          "/" ],
  ...
  "eagle.cool":{ _name:"Eagle",
    cn:[ { title:"更新日志",
        docs:"https://rssdocs.quickso.cn/program-update.html#eagle",
        source:"/changelog",
        target:"/eagle/changelog/cn" },
      { title:"全部",
        docs:"https://rssdocs.quickso.cn/design.html#eagle",
        source:[ "/blog" ],
        target:"/eagle/blog" },
      { title:"设计资源",
        docs:"https://rssdocs.quickso.cn/design.html#eagle",
  ...
  "eastday.com":{ _name:"东方网",
    mini:[ { title:"24 小时热闻",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#dong-fang-wang",
        source:"/",
        target:"/eastday/24" } ],
    sh:[ { title:"上海新闻",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#dong-fang-wang",
        ...
        target:"/eastday/sh" } ],
    www:[ { title:"热点搜索",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#dong-fang-wang-re-dian-sou-suo",
        source:"/",
        target:"/eastday/find" },
      { title:"原创",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#dong-fang-wang-yuan-chuang",
        source:"/",
        target:"/eastday/portrait" } ] },
  "eastmoney.com":{ _name:"东方财富",
    fundbarmob:[ { title:"天天基金用户动态",
        docs:"https://rssdocs.quickso.cn/finance.html#dong-fang-cai-fu",
        source:[ "/" ],
        target:(_param, url) => `/eastmoney/ttjj/user/${new URL(url).searchParams.get('userid')}` } ] },
  "ecnu.edu.cn":{ _name:"华东师范大学",
    acm:[ { title:"所有比赛列表",
        docs:"https://rssdocs.quickso.cn/university.html#hua-dong-shi-fan-da-xue",
        source:[ "/contest/",
          "/" ],
  ...
  "economist.com":{ _name:"The Economist",
    ".":[ { title:"分类",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#the-economist",
        source:[ "/:endpoint" ],
  ...
  "jxjy.ecust.edu.cn":{ _name:"华东理工继续教育学院",
    ".":[ { title:"新闻公告",
        docs:"https://rssdocs.quickso.cn/university.html#hua-dong-li-gong-ji-xu-jiao-yu-xue-yuan",
        source:"/yeDaZhuanLan.aspx?pk=153",
        target:"/ecust-jxjy/news" } ] },
  "elasticsearch.cn":{ _name:"Elastic 中文社区",
    ".":[ { title:"发现",
        docs:"https://rssdocs.quickso.cn/bbs.html#elastic-zhong-wen-she-qu-fa-xian",
        source:[ "/:params",
          "/" ],
        target:"/elasticsearch-cn/:params" } ] },
  "sciencedirect.com":{ _name:"ScienceDirect",
    ".":[ { title:"Journal",
        docs:"https://rssdocs.quickso.cn/journal.html#sciencedirect-journal",
        source:[ "/journal/:id",
          "/" ],
        target:"/sciencedirect/journal/:id" } ] },
  "china-embassy.org":{ _name:"中国驻外使领馆",
    ca:[ { title:"重要通知 - 加拿大大使馆",
        docs:"https://rssdocs.quickso.cn/government.html#zhong-guo-zhu-wai-shi-ling-guan",
        source:[ "/chn/zytz",
          "/" ],
        target:"/embassy/ca" } ],
    jp:[ { title:"通知通告 - 日本大使馆",
  ...
  "ems.com.cn":{ _name:"中国邮政速递物流",
    www:[ { title:"新闻",
        docs:"https://rssdocs.quickso.cn/other.html#zhong-guo-you-zheng-su-di-wu-liu",
  ...
  "eventernote.com":{ _name:"Eventernote",
    www:[ { title:"声优活动及演唱会",
        docs:"https://rssdocs.quickso.cn/anime.html#eventernote",
        source:"/actors/:name/:id/events",
        target:"/eventernote/actors/:name/:id" } ] },
  "ezone.hk":{ _name:"ezone.hk",
    ".":[ { title:"分类",
        docs:"https://rssdocs.quickso.cn/new-media.html#ezone-hk-fen-lei",
        source:[ "/:category",
          "/" ],
        target:"/ezone/:category?" } ] },
  "fantia.jp":{ _name:"Fantia",
    ".":[ { title:"用户投稿",
        docs:"https://rssdocs.quickso.cn/picture.html#fantia",
        source:[ "/fanclubs/:id" ],
        target:"/fantia/user/:id" } ] },
  "fastbull.cn":{ _name:"法布财经",
    ".":[ { title:"新闻",
        docs:"https://rssdocs.quickso.cn/finance.html#fa-bu-cai-jing-xin-wen",
        source:[ "/news",
          "/" ],
        target:"/fastbull/news" },
      { title:"快讯",
        docs:"https://rssdocs.quickso.cn/finance.html#fa-bu-cai-jing-kuai-xun",
        source:[ "/express-news",
          "/" ],
        target:"/fastbull/express-news" } ] },
  "fda.gov":{ _name:"U.S. Food and Drug Administration",
    ".":[ { title:"CDRHNew",
        docs:"https://rssdocs.quickso.cn/government.html#mei-guo-shi-pin-yao-pin-jian-du-guan-li-ju-cdrhnew",
        source:[ "/medical-devices/news-events-medical-devices/cdrhnew-news-and-updates",
          "/" ],
        target:"/fda/cdrh/:titleOnly" } ] },
  "feng.com":{ _name:"威锋",
    ".":[ { title:"社区",
        docs:"https://rssdocs.quickso.cn/bbs.html#wei-feng",
        source:[ "/forum/photo/:id",
          "/forum/:id" ],
        target:"/feng/forum/:id" } ] },
  "filmdeepfocus.com":{ _name:"深焦",
    ".":[ { title:"分类",
        docs:"https://rssdocs.quickso.cn/new-media.html#shen-jiao-fen-lei",
        source:[ "/:category",
          "/" ],
        target:"/filmdeepfocus/:category?" } ] },
  "finviz.com":{ _name:"finviz",
    ".":[ { title:"News",
        docs:"https://rssdocs.quickso.cn/finance.html#finviz-news",
        source:[ "/news.ashx",
          "/" ],
        target:"/finviz/:category?" },
      { title:"US Stock News",
        docs:"https://rssdocs.quickso.cn/finance.html#finviz-mei-gu-gu-piao-xin-wen",
        source:[ "/quote.ashx",
          "/" ],
        target:"/finviz/news/:category?" } ] },
  "firefox.com":{ _name:"Mozilla",
    monitor:[ { title:"Firefox Monitor",
        docs:"https://rssdocs.quickso.cn/other.html#mozilla",
        source:[ "/",
          "/breaches" ],
        target:"/firefox/breaches" } ] },
  "fisher.spb.ru":{ _name:"fisher spb",
    ".":[ { title:"news",
        docs:"https://rssdocs.quickso.cn/en/other.html#fisher-spb",
        source:[ "/news" ],
        target:"/fisher-spb/news" } ] },
  "flyert.com":{ _name:"飞客茶馆",
    ".":[ { title:"优惠信息",
        docs:"https://rssdocs.quickso.cn/travel.html#fei-ke-cha-guan-you-hui-xin-xi",
        source:"/",
        target:"/flyert/preferential" },
      { title:"信用卡",
        docs:"https://rssdocs.quickso.cn/travel.html#fei-ke-cha-guan-xin-yong-ka",
        source:"/",
        target:"/flyert/creditcard/:bank" } ] },
  "focustaiwan.tw":{ _name:"Focus Taiwan",
    ".":[ { title:"Category",
        docs:"https://rssdocs.quickso.cn/new-media.html#focus-taiwan-category",
        source:[ "/:category",
          "/" ],
        target:"/focustaiwan/category?" } ] },
  "foresightnews.pro":{ _name:"Foresight News",
    ".":[ { title:"首页",
        docs:"https://rssdocs.quickso.cn/new-media.html#foresight-news-shou-ye",
        source:[ "/article",
          "/" ],
        target:"/foresightnews" },
      { title:"文章",
        docs:"https://rssdocs.quickso.cn/new-media.html#foresight-news-wen-zhang",
        source:[ "/article",
          "/" ],
        target:"/foresightnews/article" },
      { title:"快讯",
        docs:"https://rssdocs.quickso.cn/new-media.html#foresight-news-kuai-xun",
        source:[ "/news",
          "/" ],
        target:"/foresightnews/news" },
      { title:"专栏",
        docs:"https://rssdocs.quickso.cn/new-media.html#foresight-news-zhuan-lan",
        source:[ "/column/detail/:id",
          "/" ],
        target:"/foresightnews/column/:id" } ] },
  "foreverblog.cn":{ _name:"十年之约",
    www:[ { title:"专题展示",
        docs:"https://rssdocs.quickso.cn/blog.html#shi-nian-zhi-yue",
        source:[ "/feeds.html" ],
        target:"/foreverblog/feeds" } ] },
  "fortunechina.com":{ _name:"财富中文网",
    ".":[ { title:"分类",
        docs:"https://rssdocs.quickso.cn/new-media.html#cai-fu-zhong-wen-wang-fen-lei",
        source:[ "/:category",
          "/" ],
        target:"/fortunechina/:category?" } ] },
  "fosshub.com":{ _name:"FossHub",
    ".":[ { title:"Software Update",
        docs:"https://rssdocs.quickso.cn/program-update.html#fosshub-software-update",
        source:[ "/" ],
        target:(params, url) => `/fosshub/${new URL(url).match(/\/(.*?)\.html$/)[1]}` } ] },
  "freewechat.com":{ _name:"自由微信",
    ".":[ { title:"公众号",
        docs:"https://rssdocs.quickso.cn/new-media.html#zi-you-wei-xin",
        source:[ "/profile/:id" ],
        target:"/freewechat/profile/:id" } ] },
  "ftchinese.com":{ _name:"Financial Times",
    ".":[ { title:"FT 中文网",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#financial-times" },
      { title:"myFT 个人 RSS",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#financial-times" } ] },
  "ft.com":{ _name:"Financial Times",
    ".":[ { title:"myFT personal RSS",
        docs:"https://rssdocs.quickso.cn/en/traditional-media.html#financial-times" } ] },
  "furstar.jp":{ _name:"Furstar",
    ".":[ { title:"安全文摘首頁",
        docs:"https://rssdocs.quickso.cn/shopping.html#an-quan-wen-zhai",
        source:[ "/",
          "/" ],
        target:"/secnews/index" } ] },
  "fx-markets.com":{ _name:"FX-Markets",
    ".":[ { title:"Trading",
        docs:"https://rssdocs.quickso.cn/finance.html#fx-markets",
        source:"/trading",
  ...
  "gameapps.hk":{ _name:"GameApps.hk 香港手机游戏网",
    ".":[ { title:"最新消息",
        docs:"https://rssdocs.quickso.cn/game.html#gameapps-hk-xiang-gang-shou-ji-you-xi-wang",
        source:[ "/" ],
        target:"/gameapps" } ] },
  "gamer.com.tw":{ _name:"巴哈姆特電玩資訊站",
    acg:[ { title:"GNN 新聞",
        docs:"https://rssdocs.quickso.cn/bbs.html#ba-ha-mu-te-dian-wan-zi-xun-zhan",
        source:[ "/news.php" ],
  ...
  "gamersecret.com":{ _name:"Gamer Secret",
    ".":[ { title:"最新資訊",
        docs:"https://rssdocs.quickso.cn/game.html#gamer-secret-zui-xin-zi-xun",
        source:[ "/:type",
          "/:type/:category",
          "/" ],
        target:"/gamersecret" },
      { title:"分類",
        docs:"https://rssdocs.quickso.cn/game.html#gamer-secret-fen-lei",
        source:[ "/:type",
          "/:type/:category",
          "/" ],
        target:"/gamersecret/:type?/:category?" },
      { title:"Latest News",
        docs:"https://rssdocs.quickso.cn/game.html#gamer-secret-latest-news",
        source:[ "/:type",
          "/:type/:category",
          "/" ],
        target:"/gamersecret" },
      { title:"Category",
        docs:"https://rssdocs.quickso.cn/game.html#gamer-secret-category",
        source:[ "/:type",
          "/:type/:category",
          "/" ],
        target:"/gamersecret/:type?/:category?" } ] },
  "gamme.com.tw":{ _name:"卡卡洛普",
    news:[ { title:"宅宅新聞 - 分類",
        docs:"https://rssdocs.quickso.cn/new-media.html#ka-ka-luo-pu",
        source:[ "/category/:category",
          "/" ],
  ...
  "gaze.run":{ _name:"注视影视",
    ".":[ { title:"更新通知",
        docs:"https://rssdocs.quickso.cn//multimedia.html#gaze-run",
        source:[ "/play/:mid" ],
        target:(params) => `/gaze/update/${params.mid}` } ] },
  "gcores.com":{ _name:"机核网",
    ".":[ { title:"分类",
        docs:"https://rssdocs.quickso.cn/new-media.html#ji-he-wang-fen-lei",
        source:[ "/:category" ],
        target:"/gcores/category/:category" },
      { title:"标签",
        docs:"https://rssdocs.quickso.cn/new-media.html#ji-he-wang-biao-qian",
        source:[ "/categories/:tag",
          "/" ],
        target:"/gcores/tag/:tag" } ] },
  "gdut.edu.cn":{ _name:"广东工业大学",
    oas:[ { title:"通知公文网",
        docs:"https://rssdocs.quickso.cn/university.html#guang-dong-gong-ye-da-xue-tong-zhi-gong-wen-wang",
        source:"/seeyon",
        target:"/gdut/oa_news/" } ] },
  "gelonghui.com":{ _name:"格隆汇",
    ".":[ { title:"首页",
        docs:"https://rssdocs.quickso.cn/finance.html#ge-long-hui",
        source:[ "/tag/:tag",
          "/" ],
  ...
  "getdr.com":{ _name:"趨勢科技防詐達人",
    ".":[ { title:"最新詐騙情報",
        docs:"https://rssdocs.quickso.cn/new-media.html#qu-shi-ke-ji-fang-zha-da-ren-zui-xin-zha-pian-qing-bao",
        source:[ "/" ],
        target:"/getdr" } ] },
  "getitfree.cn":{ _name:"正版中国",
    ".":[ { title:"分类",
        docs:"https://rssdocs.quickso.cn/shopping.html#zheng-ban-zhong-guo-fen-lei",
        source:[ "/category/:category",
          "/" ],
        target:"/getitfree/:category?" } ] },
  "sunborngame.com":{ _name:"少女前线",
    ".":[ { title:"情报局",
        docs:"https://rssdocs.quickso.cn/game.html#shao-nv-qian-xian-qing-bao-ju",
        source:[ "/:category",
          "/" ],
        target:"/gf-cn/news/:category?" } ] },
  "gihyo.jp":{ _name:"gihyo.jp",
    ".":[ { title:"記事一覧",
        docs:"https://rssdocs.quickso.cn/programming.html#gihyo-jp",
        source:"/list/group/:id",
        target:"/gihyo/list/group/:id" } ] },
  "gitee.com":{ _name:"Gitee",
    ".":[ { title:"仓库 Releases",
        link:"https://rssdocs.quickso.cn",
  ...
  "gitpod.io":{ _name:"Gitpod",
    ".":[ { title:"博客",
        docs:"https://rssdocs.quickso.cn/programming.html#gitpod",
        source:[ "/blog",
          "/" ],
        target:"/gitpod/blog" },
      { title:"更新日志",
  ...
  "gocn.vip":{ _name:"GoCN",
    ".":[ { title:"文章",
        docs:"https://rssdocs.quickso.cn/programming.html#GoCN",
        source:[ "/" ],
        target:"/gocn" },
      { title:"招聘",
        docs:"https://rssdocs.quickso.cn/programming.html#GoCN",
  ...
  "good.news":{ _name:"Good.news",
    ".":[ { title:"今日要闻",
        docs:"https://rssdocs.quickso.cn/new-media.html#good-news-jin-ri-yao-wen",
        source:[ "/" ],
        target:"/good" } ] },
  "google.com":{ _name:"谷歌",
    chrome:[ { title:"插件更新",
        source:"/webstore/detail/:name/:id",
        docs:"https://rssdocs.quickso.cn/program-update.html#chrome-wang-shang-ying-yong-dian",
        target:"/chrome/webstore/extensions/:id" } ],
    photos:[ { title:"相册",
        docs:"https://rssdocs.quickso.cn/picture.html#google-xiang-ce",
        source:"/share/*",
        target:(params, url, document) => {
    ...
    sites:[ { title:"Sites",
        docs:"https://rssdocs.quickso.cn/blog.html#google-sites",
        source:[ "/site/:id/*",
          "/site/:id" ],
        target:"/google/sites/:id" } ] },
  "ah.gov.cn":{ _name:"安徽省科技厅",
    kjt:[ { title:"科技资讯",
        docs:"https://rssdocs.quickso.cn/government.html#an-hui-sheng-ke-ji-ting-ke-ji-zi-xun",
        source:[ "/*" ],
        target:(params, url) => `/gov/anhui/kjt${new URL(url).href.match(/kjt\.ah\.gov\.cn(.*)\/index.html/)[1] ?? ''}` },
      { title:"科技资源",
        docs:"https://rssdocs.quickso.cn/government.html#an-hui-sheng-ke-ji-ting-ke-ji-zi-yuan",
        source:[ "/*" ],
        target:(params, url) => `/gov/anhui/kjt${new URL(url).href.match(/kjt\.ah\.gov\.cn(.*)\/index.html/)[1] ?? ''}` } ] },
  "beijing.gov.cn":{ _name:"北京市人民政府",
    jw:[ { title:"北京市教育委员会通知公告",
        docs:"https://rssdocs.quickso.cn/government.html#bei-jing-shi-jiao-yu-wei-yuan-tong-zhi-gong-gao",
        source:[ "/tzgg" ],
        target:"/gov/beijing/jw/tzgg" } ],
    kw:[ { title:"北京市科委央地协同",
        docs:"https://rssdocs.quickso.cn/government.html#bei-jing-shi-ke-xue-ji-shu-wei-yuan-hui-zhong-guan-cun-ke-ji-yuan-qu-guan-li-wei-yuan-hui",
    ...
    wjw:[ { title:"北京卫生健康委员会",
        docs:"https://rssdocs.quickso.cn/government.html#bei-jing-shi-wei-sheng-jian-kang-wei-yuan-hui",
        source:"/xwzx_20031/:caty",
        target:"/gov/beijing/mhc/:caty" } ] },
  "bphc.com.cn":{ _name:"北京保障房中心有限公司",
    gycpt:[ { title:"北京市共有产权住房租赁服务平台",
        docs:"https://rssdocs.quickso.cn/government.html#bei-jing-shi-bao-zhang-fang-zhong-xin-you-xian-gong-si",
        source:[ "/*" ],
        target:(params, url) => `/gov/bphc/${new URL(url).href.match(/gycpt\.bphc\.com\.cn\/(.*)/)[1]}` } ] },
  "ccdi.gov.cn":{ _name:"中央纪委国家监委",
    www:[ { title:"要闻",
        docs:"https://rssdocs.quickso.cn/government.html#zhong-yang-ji-wei-guo-jia-jian-wei-yao-wen",
        source:[ "/*" ],
        target:(params, url) => `/gov/ccdi/${new URL(url).href.match(/ccdi\.gov\.cn\/(.*)/)[1]}` } ] },
  "changsha.gov.cn":{ _name:"湖南省人民政府",
    wlwz:[ { title:"市长信箱",
        docs:"https://rssdocs.quickso.cn/government.html#hu-nan-sheng-ren-min-zheng-fu",
        source:[ "/webapp/cs2020/email/*" ],
        target:"/gov/hunan/changsha/major-email" } ] },
  "cmse.gov.cn":{ _name:"中国载人航天",
    www:[ { title:"综合新闻",
        docs:"https://rssdocs.quickso.cn/government.html#zhong-guo-zai-ren-hang-tian",
        source:[ "/xwzx/zhxw" ],
  ...
  "cnnic.net.cn":{ _name:"中国互联网络信息中心",
    www:[ { title:"新闻中心",
        docs:"https://rssdocs.quickso.cn/government.html#zhong-guo-hu-lian-wang-luo-xin-xi-zhong-xin-xin-wen-zhong-xin",
        source:[ "/" ],
        target:(params, url) => `/gov/cnnic/${new URL(url).match(/cnnic\.net\.cn\/(.*)/)[1]}` } ] },
  "customs.gov.cn":{ _name:"中华人民共和国海关总署",
    www:[ { title:"拍卖信息 / 海关法规",
        docs:"https://rssdocs.quickso.cn/government.html#zhong-hua-ren-min-gong-he-guo-hai-guan-zong-shu",
        source:[ "/" ],
        target:"/gov/customs/list" } ] },
  "deyang.gov.cn":{ _name:"德阳市人民政府",
    ".":[ { title:"德阳市政府公开信息",
        docs:"https://rssdocs.quickso.cn/government.html#de-yang-shi-fu-ren-min-zheng-zheng-fu",
        source:[ "/*" ],
        target:"/sichuan/deyang/govpulicinfo/:countyName" } ] },
  "gz.gov.cn":{ _name:"广州市人民政府",
    www:[ { title:"新闻",
        docs:"https://rssdocs.quickso.cn/government.html#guang-zhou-shi-ren-min-zheng-fu",
  ...
  "hebei.gov.cn":{ _name:"河北省人民政府",
    czt:[ { title:"河北省财政厅 - 财政动态",
        docs:"https://rssdocs.quickso.cn/government.html#he-bei-sheng-cai-zheng-ting-cai-zheng-dong-tai",
      ...
      { title:"河北省财政厅 - 综合新闻",
        docs:"https://rssdocs.quickso.cn/government.html#he-bei-sheng-cai-zheng-ting-zong-he-xin-wen",
        source:[ "/xwdt/:category" ],
        target:(params) => {
      ...
      { title:"河北省财政厅 - 通知公告",
        docs:"https://rssdocs.quickso.cn/government.html#he-bei-sheng-cai-zheng-ting-tong-zhi-gong-gao",
        source:[ "/xwdt/:category" ],
        target:(params) => {
  ...
  "homeaffairs.gov.au":{ _name:"Department of Home Affairs",
    immi:[ { title:"Immigration and Citizenship",
        docs:"https://rssdocs.quickso.cn/en/government.html#Australia-Department-of-Home-Affairs",
        source:"/news-media/archive",
        target:() => '/gov/immiau/news' } ] },
  "huizhou.gov.cn":{ _name:"惠州市人民政府",
    www:[ { title:"政务公开 - 政务要闻",
        docs:"https://rssdocs.quickso.cn/government.html#guang-yan-an-dong-sheng-xing-xian-ren-min-zheng-zheng-fu-hui-zhou-shi-fu-ren-min-zheng-zheng-fu-zheng-zheng-wu-gong-kai",
  ...
  "mee.gov.cn":{ _name:"生态环境部",
    www:[ { title:"要闻动态",
        docs:"https://rssdocs.quickso.cn/government.html#zhong-hua-ren-min-gong-he-guo-sheng-tai-huan-jing-bu",
        source:[ "/ywdt/:category" ],
        target:"/gov/mee/ywdt/:category" } ] },
  "mfa.gov.cn":{ _name:"中华人民共和国外交部",
    www:[ { title:"外交动态",
        docs:"https://rssdocs.quickso.cn/government.html#zhong-hua-ren-min-gong-he-guo-wai-jiao-bu-wai-jiao-dong-tai",
        source:[ "/web/wjdt_674879/:category" ],
        target:(params) => `/gov/mfa/wjdt/${params.category.split('_')[0]}` } ] },
  "miit.gov.cn":{ _name:"工业和信息化部",
    ".":[ { title:"部门 文件发布",
        docs:"https://rssdocs.quickso.cn/government.html#zhong-guo-gong-ye-he-xin-xi-hua-bu",
  ...
  "moe.gov.cn":{ _name:"中华人民共和国教育部",
    ".":[ { title:"新闻",
        docs:"https://rssdocs.quickso.cn/government.html#zhong-hua-ren-min-gong-he-guo-jiao-yu-bu",
        source:[ "/" ],
        target:"/gov/moe/newest_file" } ] },
  "mofcom.gov.cn":{ _name:"中华人民共和国商务部",
    ".":[ { title:"新闻发布",
        docs:"https://rssdocs.quickso.cn/government.html#zhong-hua-ren-min-gong-he-guo-shang-wu-bu",
        source:[ "/article/*" ],
  ...
  "nifdc.gov.cn":{ _name:"国家药品监督管理局医疗器械标准管理中心",
    ".":[ { title:"通用",
        docs:"https://rssdocs.quickso.cn/government.html#guo-jia-yao-pin-jian-du-guan-li-ju-yi-liao-qi-xie-biao-zhun-guan-li-zhong-xin",
        source:[ "/*path" ],
        target:(params) => `/gov/nifdc/${params.path.replace('/index.html', '')}` } ] },
  "nmpa.gov.cn":{ _name:"国家药品监督管理局",
    ".":[ { title:"通用",
        docs:"https://rssdocs.quickso.cn/government.html#guo-jia-yao-pin-jian-du-guan-li-ju",
        source:[ "/*path" ],
        target:(params) => `/gov/nmpa/${params.path.replace('/index.html', '')}` } ] },
  "nopss.gov.cn":{ _name:"全国哲学社会科学工作办公室",
    ".":[ { title:"通用",
        docs:"https://rssdocs.quickso.cn/government.html#quan-guo-zhe-xue-she-hui-ke-xue-gong-zuo-ban-gong-shi",
        source:[ "/*path" ],
        target:(params) => `/gov/nopss/${params.path.replace('/index.html', '')}` } ] },
  "nrta.gov.cn":{ _name:"国家广播电视总局",
    ".":[ { title:"分类",
        docs:"https://rssdocs.quickso.cn/government.html#guo-jia-guang-bo-dian-shi-zong-ju",
        source:[ "/col/*category" ],
        target:(params) => `/gov/nrta/news/${params.category.replace('col', '').replace('/index.html', '')}` } ] },
  "nsfc.gov.cn":{ _name:"国家自然科学基金委员会",
    ".":[ { title:"基金要闻",
        docs:"https://rssdocs.quickso.cn/other.html#guo-jia-zi-ran-ke-xue-ji-jin-wei-yuan-hui-ji-jin-yao-wen",
        source:[ "/*" ],
  ...
  "pbc.gov.cn":{ _name:"中国人民银行",
    ".":[ { title:"沟通交流",
        docs:"https://rssdocs.quickso.cn/finance.html#zhong-guo-ren-min-yin-xing",
  ...
  "sh.gov.cn":{ _name:"上海市人民政府",
    wsjkw:[ { title:"上海卫健委 疫情通报",
        docs:"https://rssdocs.quickso.cn/other.html#xin-guan-fei-yan-yi-qing-xin-wen-dong-tai-yi-qing-tong-bao-shang-hai-wei-jian-wei",
        source:[ "/" ],
        target:"/gov/shanghai/wsjkw/yqtb" } ],
    rsj:[ { title:"上海市职业能力考试院 考试项目",
        docs:"https://rssdocs.quickso.cn/government.html#shang-hai-shi-ren-min-zheng-fu-shang-hai-shi-zhi-ye-neng-li-kao-shi-yuan-kao-shi-xiang-mu",
        source:[ "/" ],
        target:"/gov/shanghai/rsj/ksxm" } ],
    yjj:[ { title:"上海市药品监督管理局",
        docs:"https://rssdocs.quickso.cn/government.html#shang-hai-shi-ren-min-zheng-fu-shang-hai-shi-yao-pin-jian-du-guan-li-ju",
        source:[ "/" ],
        target:(params, url) => `/gov/shanghai/yjj/${new URL(url).match(/yjj\.sh\.gov\.cn\/(.*)\/index.html/)[1]}` } ] },
  "shaanxi.gov.cn":{ _name:"陕西省人民政府",
    kjt:[ { title:"陕西省科学技术厅",
        docs:"https://rssdocs.quickso.cn/government.html#shan-xi-sheng-sheng-ren-min-zheng-fu-sheng-ke-xue-ji-shu-ting",
        source:[ "/view/iList.jsp",
          "/" ],
        target:(params, url) => `/gov/shaanxi/kjt/${new URL(url).searchParams.get('cat_id')}` } ] },
  "stats.gov.cn":{ _name:"国家统计局",
    www:[ { title:"统计数据 > 最新发布",
        docs:"https://rssdocs.quickso.cn/government.html#guo-jia-tong-ji-ju-tong-ji-shu-ju-zui-xin-fa-bu",
        source:[ "/*" ],
        target:(params, url) => `/gov/stats/${new URL(url).href.match(/stats\.gov\.cn\/(.*)/)[1]}` } ] },
  "sz.gov.cn":{ _name:"深圳政府在线移动门户",
    hrss:[ { title:"考试院公告",
        docs:"https://rssdocs.quickso.cn/government.html#guang-dong-sheng-ren-min-zheng-fu-shen-zhen-shi-wei-zu-zhi-bu",
        source:[ "/*" ],
        target:"/gov/shenzhen/hrss/szksy/:caty/:page?" } ],
    xxgk:[ { title:"深圳市人民政府",
        docs:"https://rssdocs.quickso.cn/government.html#guang-dong-sheng-ren-min-zheng-fu-guang-dong-sheng-shen-zhen-shi-ren-min-zheng-fu",
        source:[ "/cn/xxgk/zfxxgj/:caty" ],
        target:"/gov/shenzhen/hrss/szksy/:caty/:page?" } ],
    zzb:[ { title:"组工在线公告",
        docs:"https://rssdocs.quickso.cn/government.html#guang-dong-sheng-ren-min-zheng-fu-shen-zhen-shi-kao-shi-yuan",
        source:[ "/*" ],
        target:"/gov/shenzhen/zzb/:caty/:page?" } ] },
  "taiyuan.gov.cn":{ _name:"太原市人民政府",
    rsj:[ { title:"太原市人力资源和社会保障局政府公开信息",
        docs:"https://rssdocs.quickso.cn/government.html#tai-yuan-shi-ren-min-zheng-fu-tai-yuan-shi-ren-li-zi-yuan-he-she-hui-bao-zhang-ju-zheng-fu-gong-kai-xin-xi",
        source:[ "/*" ],
        target:"/taiyuan/rsj/:caty/:page?" } ] },
  "tqyb.com.cn":{ _name:"广州天气",
    www:[ { title:"突发性天气提示",
        docs:"https://rssdocs.quickso.cn/government.html#guang-zhou-tian-qi-tu-fa-xing-tian-qi-ti-shi",
        source:[ "/gz/weatherAlarm/suddenWeather/" ],
        target:"/gov/guangdong/tqyb/tfxtq" },
      { title:"广东省内城市预警信号",
        docs:"https://rssdocs.quickso.cn/government.html#guang-zhou-tian-qi-guang-dong-sheng-nei-cheng-shi-yu-jing-xin-hao",
        source:[ "/gz/weatherAlarm/otherCity/" ],
        target:"/gov/guangdong/tqyb/sncsyjxh" } ] },
  "www.gov.cn":{ _name:"中国政府网",
    ".":[ { title:"最新政策",
        docs:"https://rssdocs.quickso.cn/government.html#zhong-guo-zheng-fu-wang",
  ...
  "xz.gov.cn":{ _name:"徐州市人民政府",
    hrss:[ { title:"徐州市人力资源和社会保障局",
        docs:"https://rssdocs.quickso.cn/government.html#xu-zhou-shi-ren-min-zheng-fu-xu-zhou-shi-ren-li-zi-yuan-he-she-hui-bao-zhang-ju",
        source:[ "/*" ],
        target:(params, url) => `/gov/xuzhou/hrss${new URL(url).href.match(/\/(\d+)\/subPage.html/)[1] ?? ''}` } ] },
  "greasyfork.org":{ _name:"Greasy Fork",
    ".":[ { title:"User scripts",
        docs:"https://rssdocs.quickso.cn/program-update.html#greasy-fork",
        source:[ "/:language",
  ...
  "guancha.cn":{ _name:"观察者网",
    ".":[ { title:"头条",
        docs:"https://rssdocs.quickso.cn/new-media.html#guan-cha-zhe-wang-tou-tiao",
        source:[ "/GuanChaZheTouTiao",
          "/" ],
        target:"/guancha/headline" },
      { title:"首页",
        docs:"https://rssdocs.quickso.cn/new-media.html#guan-cha-zhe-wang-shou-ye",
        source:[ "/" ],
        target:"/guancha/:category?" },
      { title:"观学院",
        docs:"https://rssdocs.quickso.cn/new-media.html#guan-cha-zhe-wang-guan-xue-yuan",
        source:[ "/" ],
        target:"/guancha/:category?" } ],
    app:[ { title:"个人主页文章",
        docs:"https://rssdocs.quickso.cn/new-media.html#guan-cha-zhe-wang-ge-ren-zhu-ye-wen-zhang",
    ...
    user:[ { title:"风闻话题",
        docs:"https://rssdocs.quickso.cn/new-media.html#guan-cha-zhe-wang-feng-wen-hua-ti",
  ...
  "guangdiu.com":{ _name:"逛丢",
    ".":[ { title:"折扣",
        docs:"https://rssdocs.quickso.cn/shopping.html#guang-diu",
        source:[ "/",
          "/cate.php" ],
  ...
  "guanhai.com.cn":{ _name:"观海新闻",
    ".":[ { title:"首页",
        docs:"https://rssdocs.quickso.cn/new-media.html#guan-hai-xin-wen",
        source:[ "/" ],
        target:"/guanhai" } ] },
  "guduodata.com":{ _name:"骨朵数据",
    data:[ { title:"日榜",
        docs:"https://rssdocs.quickso.cn/other.html#gu-duo-shu-ju",
        source:[ "/" ],
        target:"/guduodata/daily" } ] },
  "guggenheim.org":{ _name:"Solomon R. Guggenheim Museum",
    www:[ { title:"Exhibitions",
        docs:"https://rssdocs.quickso.cn/en/travel.html#solomon-r-guggenheim-museum" } ] },
  "gumroad.com":{ _name:"Gumroad",
    ".":[ { title:"产品",
        docs:"https://rssdocs.quickso.cn/shopping.html#gumroad",
        source:[ "/l/:products" ],
        target:(params, url) => {
  ...
  "guokr.com":{ _name:"果壳网",
    ".":[ { title:"科学人",
        docs:"https://rssdocs.quickso.cn/new-media.html#guo-ke-wang-ke-xue-ren",
        source:[ "/scientific",
          "/" ],
        target:"/guokr/scientific" },
      { title:"专栏",
        docs:"https://rssdocs.quickso.cn/new-media.html#guo-ke-wang-zhuan-lan",
        source:[ "/" ],
        target:"/guokr/:channel" } ] },
  "gzh360.com":{ _name:"公众号360",
    web:[ { title:"公众号",
        docs:"https://rssdocs.quickso.cn/new-media.html#gong-zhong-hao-360",
        source:[ "/gzh_articles",
          "/gzh",
          "/" ],
  ...
  "ycombinator.com":{ _name:"Hacker News",
    ".":[ { title:"Section",
        docs:"https://rssdocs.quickso.cn/programming.html#hacker-news",
        source:[ "/:section",
          "/" ],
        target:"/hackernews/:section?/:type?/:user?" } ] },
  "hackertalk.net":{ _name:"Hacker Talk 黑客说",
    ".":[ { title:"最新的帖子",
        docs:"https://rssdocs.quickso.cn/bbs.html#hacker-talk-hei-ke-shuo",
        source:[ "/?tab=new",
          "/" ],
        target:"/hackertalk" } ] },
  "hafu.edu.cn":{ _name:"河南财政金融学院",
    www:[ { title:"河南财政金融学院 - 通知公告",
        docs:"https://rssdocs.quickso.cn/university.html#he-nan-cai-zheng-jin-rong-xue-yuan",
        source:"/*",
        target:(params, url) => {
                    if (url.indexOf('www')) {
  ...
  "hakkatv.org.tw":{ _name:"客家電視台",
    ".":[ { title:"新聞首頁 - 客家電視台",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#ke-jia-dian-shi-tai",
        source:"/news",
        target:"/hakkatv/news" } ] },
  "syosetu.org":{ _name:"hameln",
    ".":[ { title:"章节更新",
        docs:"https://rssdocs.quickso.cn/reading.html#hameln-zhang-jie-geng-xin",
        source:[ "/novel/:id" ],
        target:"/hameln/chapter/:id" } ] },
  "hashnode.dev":{ _name:"hashnode",
    ".":[ { title:"Hashnode Blog",
        docs:"https://rssdocs.quickso.cn/blog.html#hashnode",
        source:"/",
        target:"/hashnode/blog/:username" } ] },
  "hbr.org":{ _name:"Harvard Business Review",
    ".":[ { title:"Topic",
        docs:"https://rssdocs.quickso.cn/new-media.html#harvard-business-review-topic",
        source:[ "/topic/:topic?",
          "/" ],
        target:"/hbr/topic/:topic?/:type?" } ] },
  "hdu.edu.cn":{ _name:"杭州电子科技大学",
    computer:[ { title:"计算机学院 - 通知公告",
        docs:"https://rssdocs.quickso.cn/university.html#hang-zhou-dian-zi-ke-ji-da-xue",
  ...
  "hellobtc.com":{ _name:"白话区块链",
    ".":[ { title:"首页-最新",
        docs:"https://rssdocs.quickso.cn/new-media.html#bai-hua-qu-kuai-lian",
        source:[ "/" ],
  ...
  "hellogithub.com":{ _name:"HelloGitHub",
    ".":[ { title:"热门",
        docs:"https://rssdocs.quickso.cn/programming.html#hellogithub-re-men",
        source:[ "/" ],
        target:(params, url) => {
      ...
      { title:"最近",
        docs:"https://rssdocs.quickso.cn/programming.html#hellogithub-zui-jin",
        source:[ "/" ],
        target:(params, url) => {
                    const sort = new URL(url).searchParams.get('sort_by');
                    const id = new URL(url).searchParams.get('tid');
      ...
      { title:"文章",
        docs:"https://rssdocs.quickso.cn/programming.html#hellogithub-wen-zhang",
        source:[ "/" ],
        target:(params, url) => {
                    const sort = new URL(url).searchParams.get('sort_by');
                    const id = new URL(url).searchParams.get('tid');
      ...
      { title:"排行榜",
        docs:"https://rssdocs.quickso.cn/programming.html#hellogithub-pai-hang-bang",
        source:[ "/report/:type",
          "/" ],
        target:"/hellogithub/report/:type" },
      { title:"月刊",
        docs:"https://rssdocs.quickso.cn/programming.html#hellogithub-yue-kan",
        source:[ "/periodical/volume/:id",
          "/" ],
        target:"/hellogithub/volume" } ] },
  "hex-rays.com":{ _name:"Hex-Rays",
    ".":[ { title:"Hex-Rays News",
        docs:"https://rssdocs.quickso.cn/programming.html#hex-rays",
        source:[ "/",
          "/blog" ],
        target:"/hex-rays/news" } ] },
  "hit.edu.cn":{ _name:"哈尔滨工业大学",
    jwc:[ { title:"哈尔滨工业大学教务处通知公告",
        docs:"https://rssdocs.quickso.cn/university.html#ha-er-bin-gong-ye-da-xue",
        source:"/*",
        target:"/hit/jwc" } ],
    today:[ { title:"今日哈工大",
        docs:"https://rssdocs.quickso.cn/university.html#ha-er-bin-gong-ye-da-xue",
  ...
  "hitwh.edu.cn":{ _name:"哈尔滨工业大学（威海）",
    ".":[ { title:"今日工大 - 通知公告",
        docs:"https://rssdocs.quickso.cn/university.html#ha-er-bin-gong-ye-da-xue-wei-hai",
        source:[ "/1024/list.htm",
          "/" ],
        target:"/hitwh/today" } ] },
  "hizh.cn":{ _name:"珠海网",
    ".":[ { title:"栏目",
        docs:"https://rssdocs.quickso.cn/new-media.html#zhu-hai-wang-lan-mu",
        source:"/",
        target:"/hizu/:column?" } ] },
  "hjedd.com":{ _name:"海角社区",
    ".":[ { title:"热门",
        docs:"https://rssdocs.quickso.cn/bbs.html#hai-jiao-she-qu-re-men",
        source:[ "/" ],
        target:"/hjedd/hot" },
      { title:"新闻",
        docs:"https://rssdocs.quickso.cn/bbs.html#hai-jiao-she-qu-xin-wen",
        source:[ "/" ],
        target:"/hjedd/news" },
      { title:"大事记",
        docs:"https://rssdocs.quickso.cn/bbs.html#hai-jiao-she-qu-da-shi-ji",
        source:[ "/article",
          "/" ],
        target:"/hjedd/event" },
      { title:"原创",
        docs:"https://rssdocs.quickso.cn/bbs.html#hai-jiao-she-qu-da-yuan-chuang",
        source:[ "/" ],
        target:"/hjedd/original" },
      { title:"精华",
        docs:"https://rssdocs.quickso.cn/bbs.html#hai-jiao-she-qu-da-jing-hua",
        source:[ "/" ],
        target:"/hjedd/top" },
      { title:"公告",
        docs:"https://rssdocs.quickso.cn/bbs.html#hai-jiao-she-qu-da-gong-gao",
        source:[ "/" ],
        target:"/hjedd/notice" },
      { title:"最新",
        docs:"https://rssdocs.quickso.cn/bbs.html#hai-jiao-she-qu-da-zui-xin",
        source:[ "/" ],
        target:"/hjedd/latest" },
      { title:"文章",
        docs:"https://rssdocs.quickso.cn/bbs.html#hai-jiao-she-qu-da-wen-zhang",
        source:[ "/article",
          "/" ],
        target:(params, url) => `/hjedd/${new URL(url).searchParams.get('nodeId')}` } ] },
  "hk01.com":{ _name:"香港01",
    ".":[ { title:"热门",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#xiang-gang-01-re-men",
        source:[ "/hot",
          "/" ],
        target:"/hk01/hot" },
      { title:"栏目",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#xiang-gang-01-lan-mu",
        source:[ "/zone/:id",
          "/" ],
        target:"/hk01/zone/:id?" },
      { title:"子栏目",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#xiang-gang-01-zi-lan-mu",
        source:[ "/channel/:id",
          "/" ],
        target:"/hk01/channel/:id?" },
      { title:"专题",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#xiang-gang-01-zhuan-ti",
        source:[ "/issue/:id",
          "/" ],
        target:"/hk01/issue/:id?" },
      { title:"标签",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#xiang-gang-01-biao-qian",
        source:[ "/tag/:id",
          "/" ],
        target:"/hk01/tag/:id?" } ] },
  "hkej.com":{ _name:"信报财经新闻",
    ".":[ { title:"即时新闻",
        docs:"https://rssdocs.quickso.cn/traditional-media.html##xin-bao-cai-jing-xin-wen",
        source:[ "/" ],
        target:"/hkej/:category?" } ] },
  "hkepc.com":{ _name:"HKEPC",
    ".":[ { title:"HKEPC 电脑领域",
        docs:"https://rssdocs.quickso.cn/new-media.html#hkepc",
        source:[ "/:category?" ],
  ...
  "hket.com":{ _name:"香港经济日报",
    china:[ { title:"新闻",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#xiang-gang-jing-ji-ri-bao",
        source:[ "/:category/*" ],
  ...
  "hkjunkcall.com":{ _name:"HKJunkCall資訊中心",
    ".":[ { title:"近期資訊",
        docs:"https://rssdocs.quickso.cn/new-media.html#hkjunkcall-zi-xun-zhong-xin-jin-qi-zi-xun",
        source:[ "/" ],
        target:"/hkjunkcall" } ] },
  "voc.com.cn":{ _name:"华声在线",
    ".":[ { title:"湖南日报",
        docs:"https://rssdocs.quickso.cn/journal.html#hu-nan-ri-bao-dian-zi-kan-wu",
        source:[ "/" ],
        target:"/hnrb/:id" } ] },
  "dh.gov.hk":{ _name:"香港卫生署",
    ".":[ { title:"新闻公报",
        docs:"https://rssdocs.quickso.cn/government.html#xiang-gang-wei-sheng-shu-xin-wen-gong-bao",
        source:[ "/" ],
        target:"/hongkong/dh/:language?" },
      { title:"分类",
        docs:"https://rssdocs.quickso.cn/government.html#xiang-gang-wei-sheng-fang-hu-zhong-xin-fen-lei",
        source:[ "/" ],
        target:"/hongkong/chp/:category?/:language?" } ] },
  "hotchina.news":{ _name:"辛華社",
    ".":[ { title:"首页",
        docs:"https://rssdocs.quickso.cn/new-media.html#xin-hua-she-shou-ye",
        source:[ "/" ],
        target:"/hotchina" },
      { title:"分类",
        docs:"https://rssdocs.quickso.cn/new-media.html#xin-hua-she-fen-lei",
        source:[ "/archives/category/:id",
          "/" ],
        target:"/hotchina/category/:id?" },
      { title:"标签",
        docs:"https://rssdocs.quickso.cn/new-media.html#xin-hua-she-biao-qian",
        source:[ "/archives/tag/:id",
          "/" ],
        target:"/hotchina/tag/:id?" } ] },
  "hotukdeals.com":{ _name:"hotukdeals",
    www:[ { title:"highlights",
        docs:"https://rssdocs.quickso.cn/shopping.html#hotukdeals",
        source:[ "/" ],
  ...
  "houxu.app":{ _name:"后续",
    ".":[ { title:"热点",
        docs:"https://rssdocs.quickso.cn/new-media.html#hou-xu-re-dian",
        source:[ "/" ],
        target:"/houxu" },
      { title:"跟踪",
        docs:"https://rssdocs.quickso.cn/new-media.html#hou-xu-gen-zong",
        source:[ "/memory",
          "/" ],
        target:"/houxu/memory" },
      { title:"专栏",
        docs:"https://rssdocs.quickso.cn/new-media.html#hou-xu-zhuan-lan",
        source:[ "/events",
          "/" ],
        target:"/houxu/events" },
      { title:"Live",
        docs:"https://rssdocs.quickso.cn/new-media.html#hou-xu-live",
        source:[ "/lives/:id",
          "/" ],
        target:"/houxu/lives/:id" } ] },
  "hrbeu.edu.cn":{ _name:"哈尔滨工程大学",
    yjsy:[ { title:"研究生院 - 通知公告",
        docs:"https://rssdocs.quickso.cn/university.html#ha-er-bin-gong-cheng-da-xue",
        source:"/*",
  ...
  "huangz.me":{ _name:"黄健宏博客",
    blog:[ { title:"文章",
        docs:"https://rssdocs.quickso.cn/blog.html#huang-jian-hong-bo-ke",
        source:[ "/*.html" ],
        target:"/huangz" } ] },
  "huanqiu.com":{ _name:"环球网",
    ".":[ { title:"分类",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#huan-qiu",
        source:"/",
        target:"/news/huanqiu/:category?" } ] },
  "hupu.com":{ _name:"虎扑",
    "":[ { title:"首页",
        docs:"https://rssdocs.quickso.cn/bbs.html#hu-pu-shou-ye",
        source:[ "/:category",
          "/" ],
        target:"/hupu/:category" } ],
    bbs:[ { title:"热帖",
        docs:"https://rssdocs.quickso.cn/bbs.html#hu-pu-re-tie",
        source:[ "/:id" ],
        target:"/hupu/all/:id" } ],
    m:[ { title:"首页",
        docs:"https://rssdocs.quickso.cn/bbs.html#hu-pu-shou-ye",
        ...
        target:"/hupu/:category" },
      { title:"社区",
        docs:"https://rssdocs.quickso.cn/bbs.html#hu-pu-she-qu",
        source:[ "/bbs/:id",
          "/" ],
        target:"/hupu/bbs/:id/:order" } ] },
  "huxiu.com":{ _name:"虎嗅",
    ".":[ { title:"首页资讯",
        docs:"https://rssdocs.quickso.cn/new-media.html#hu-xiu",
        source:[ "/article",
          "/" ],
  ...
  "hyqss.cn":{ _name:"衡阳全搜索",
    ".":[ { title:"衡阳日报",
        docs:"https://rssdocs.quickso.cn/journal.html#heng-yang-quan-sou-suo-heng-yang-ri-bao",
        source:[ "/" ],
        target:"/hnrb/hyrb/:id?" },
      { title:"衡阳晚报",
        docs:"https://rssdocs.quickso.cn/journal.html#heng-yang-quan-sou-suo-heng-yang-wan-bao",
        source:[ "/" ],
        target:"/hnrb/hywb/:id?" } ],
    epaper:[ { title:"衡阳日报",
        docs:"https://rssdocs.quickso.cn/journal.html#heng-yang-quan-sou-suo-heng-yang-ri-bao",
  ...
  "https://www.icac.org.hk":{ _name:"廉政公署",
    ".":[ { title:"新闻公布",
        docs:"https://rssdocs.quickso.cn/government.html#xiang-gang-lian-zheng-gong-shu",
        source:[ "/:lang/press/index.html" ],
        target:"/icac/news/:lang" } ] },
  "ieee.org":{ _name:"IEEE",
    www:[ { title:"Journal",
        docs:"https://rssdocs.quickso.cn/journal.html#ieee-xplore",
        source:"/*",
  ...
  "neea.cn":{ _name:"中国教育考试网",
    jlpt:[ { title:"教育部考试中心日本语能力测试重要通知",
        docs:"https://rssdocs.quickso.cn/study.html#jiao-yu-bu-kao-shi-zhong-xin-ri-ben-yu-neng-li-ce-shi-zhong-yao-tong-zhi",
        source:[ "/" ],
        target:"/neea/jlpt" } ] },
  "ifeng.com":{ _name:"凤凰网",
    ".":[ { title:"大风号",
        docs:"https://rssdocs.quickso.cn/new-media.html#feng-huang-wang" } ],
    news:[ { title:"资讯",
        docs:"https://rssdocs.quickso.cn/new-media.html#feng-huang-wang-zi-xun",
        target:(params, url) => `/ifeng/news${new URL(url).toString().match(/ifeng\.com(.*?)$/)[1]}` } ] },
  "iguoguo.net":{ _name:"爱果果",
    ".":[ { title:"最新H5",
        docs:"https://rssdocs.quickso.cn/design.html#ai-guo-guo-h5" } ] },
  "imagemagick.org":{ _name:"Changelog",
    ".":[ { title:"ChangeLog",
        docs:"https://rssdocs.quickso.cn/program-update.html#imagemagick-changelog",
  ...
  "independent.co.uk":{ _name:"PS5 stock UK - The Independent",
    www:[ { title:"News",
        docs:"https://rssdocs.quickso.cn/shopping.html#the-independent",
  ...
  "indiansinkuwait.com":{ _name:"Indians in Kuwait",
    ".":[ { title:"News",
        docs:"https://rssdocs.quickso.cn/en/new-media.html#indians-in-kuwait",
        source:[ "/latest-news",
          "/" ],
        target:"/indiansinkuwait/latest" } ] },
  "infoq.cn":{ _name:"InfoQ 中文",
    ".":[ { title:"推荐",
        docs:"https://rssdocs.quickso.cn/new-media.html#infoq-zhong-wen",
        source:[ "/" ],
  ...
  "iresearch.com.cn":{ _name:"艾瑞",
    www:[ { title:"研究报告",
        docs:"https://rssdocs.quickso.cn/other.html#ai-rui-chan-ye-yan-jiu-bao-gao",
        source:[ "/report.shtml" ],
        target:"/iresearch/report" },
      { title:"周度市场观察",
        docs:"https://rssdocs.quickso.cn/other.html#ai-rui-zhou-du-shi-chang-guan-cha",
        source:[ "/report.shtml?type=3",
          "" ],
        target:"/iresearch/weekly/:category" } ] },
  "islander.cc":{ _name:"島民衛星 Islander",
    ".":[ { title:"事件分析",
        docs:"https://rssdocs.quickso.cn/new-media.html#dao-min-wei-xing-islander",
        source:[ "/" ],
  ...
  "itch.io":{ _name:"itch.io",
    ".":[ { title:"Browse",
        docs:"https://rssdocs.quickso.cn/game.html#itch-io-browse",
        source:[ "/" ],
        target:(params, url) => `/itch${new URL(url).toString().split('itch.io').pop()}` },
      { title:"Developer Logs",
        docs:"https://rssdocs.quickso.cn/game.html#itch-io-developer-logs",
        source:[ "/" ],
        target:(params, url) => {
      ...
      { title:"Posts",
        docs:"https://rssdocs.quickso.cn/game.html#itch-io-posts",
        source:[ "/t/:topic/:id" ],
        target:"/itch/posts/:topic/:id" } ] },
  "ithome.com":{ _name:"IT 之家",
    ".":[ { title:"标签",
        docs:"https://rssdocs.quickso.cn/new-media.html#it-zhi-jia-zhuan-ti",
        source:[ "/tag/:name" ],
      ...
      { title:"专题",
        ...
        target:"/ithome/zt/:id" },
      { title:"24 小时阅读榜",
        docs:"https://rssdocs.quickso.cn/new-media.html#it-zhi-jia-re-bang",
        source:[ "",
          "/*" ],
    ...
    it:[ { title:"IT 资讯",
        docs:"https://rssdocs.quickso.cn/new-media.html#it-zhi-jia-fen-lei-zi-xun",
        source:"/",
        target:"/ithome/it" } ],
    soft:[ { title:"软件之家",
        docs:"https://rssdocs.quickso.cn/new-media.html#it-zhi-jia-fen-lei-zi-xun",
  ...
  "ithome.com.tw":{ _name:"iThome",
    www:[ { title:"Feeds",
        docs:"https://rssdocs.quickso.cn/new-media.html#ithome-tai-wan",
        source:[ "/:category",
          "/:category/feeds" ],
  ...
  "iwara.tv":{ _name:"iwara",
    ecchi:[ { title:"用户视频",
      ...
      { title:"用户订阅列表",
        docs:"https://rssdocs.quickso.cn/anime.html#iwara",
        source:"",
        target:"/iwara/subscriptions" } ] },
  "ixigua.com":{ _name:"西瓜视频",
    ".":[ { title:"用户视频投稿",
        docs:"https://rssdocs.quickso.cn/multimedia.html#xi-gua-shi-pin",
        source:"/home/:uid",
        target:"/ixigua/user/video/:uid" } ] },
  "jandan.net":{ _name:"煎蛋",
    ".":[ { title:"首页",
        docs:"https://rssdocs.quickso.cn/picture.html#jian-dan-shou-ye",
        source:[ "/:category",
          "/" ],
        target:"/jandan/:category?" },
      { title:"板块",
        docs:"https://rssdocs.quickso.cn/picture.html#jian-dan-ban-kuai",
        source:[ "/:category",
          "/" ],
        target:"/jandan/:category?" } ] },
  "javbus.com":{ _name:"JavBus",
    www:[ { title:"有码 - 首页",
        docs:"https://rssdocs.quickso.cn/multimedia.html#javbus",
        source:"/",
        target:"/javbus" },
      { title:"有码 - 分类",
        docs:"https://rssdocs.quickso.cn/multimedia.html#javbus",
  ...
  "javdb.com":{ _name:"JavDB",
    ".":[ { title:"主页",
        docs:"https://rssdocs.quickso.cn/multimedia.html#javdb-zhu-ye",
        source:[ "/" ],
        target:"/javdb" },
      { title:"分類",
        docs:"https://rssdocs.quickso.cn/multimedia.html#javdb-fen-lei",
        source:[ "/tags/:category",
          "/" ],
        target:(params, url) => `/javdb/tags/:category/${new URL(url).searchParams.toString()}` },
      { title:"排行榜",
        docs:"https://rssdocs.quickso.cn/multimedia.html#javdb-pai-hang-bang",
        source:[ "/rankings/:category",
          "/" ],
        target:(params, url) => `/javdb/rankings/:category/${new URL(url).searchParams.get('period') ?? ''}` },
      { title:"搜索",
        docs:"https://rssdocs.quickso.cn/multimedia.html#javdb-sou-suo",
        source:[ "/search",
          "/" ],
        target:(params, url) => `/javdb/search/${new URL(url).searchParams.toString()}` },
      { title:"演員",
        docs:"https://rssdocs.quickso.cn/multimedia.html#javdb-yan-yuan",
        source:[ "/actors/:id",
          "/" ],
        target:(params, url) => `/javdb/actors/:id/${new URL(url).searchParams.toString()}` },
      { title:"系列",
        docs:"https://rssdocs.quickso.cn/multimedia.html#javdb-xi-lie",
        source:[ "/series/:id",
          "/" ],
        target:(params, url) => `/javdb/series/:id/${new URL(url).searchParams.toString()}` },
      { title:"片商",
        docs:"https://rssdocs.quickso.cn/multimedia.html#javdb-pian-shang",
        source:[ "/makers/:id",
          "/" ],
        target:(params, url) => `/javdb/makers/:id/${new URL(url).searchParams.toString()}` } ] },
  "javlibrary.com":{ _name:"JAVLibrary",
    ".":[ { title:"最近讨论的影片",
        docs:"https://rssdocs.quickso.cn/multimedia.html#zui-jin-tao-lun-de-ying-pian",
        source:[ "/:language",
          "/" ],
        target:(params) => `/javlibrary/update/${params.language}` },
      { title:"新发行的影片",
        docs:"https://rssdocs.quickso.cn/multimedia.html#xin-fa-xing-de-ying-pian",
        source:[ "/:language",
          "/" ],
        target:(params, url) => `/javlibrary/newrelease/${params.language}/${new URL(url).searchParams.get('mode')}` },
      { title:"最新加入的影片",
        docs:"https://rssdocs.quickso.cn/multimedia.html#zui-xin-jia-ru-de-ying-pian",
        source:[ "/:language",
          "/" ],
        target:(params) => `/javlibrary/update/${params.language}` },
      { title:"最想要的影片",
        docs:"https://rssdocs.quickso.cn/multimedia.html#zui-xiang-yao-de-ying-pian",
        source:[ "/:language",
          "/" ],
        target:(params, url) => `/javlibrary/mostwanted/${params.language}/${new URL(url).searchParams.get('mode')}` },
      { title:"评价最高的影片",
        docs:"https://rssdocs.quickso.cn/multimedia.html#ping-jia-zui-gao-de-ying-pian",
        source:[ "/:language",
          "/" ],
        target:(params, url) => `/javlibrary/bestrated/${params.language}/${new URL(url).searchParams.get('mode')}` },
      { title:"最佳评论",
        docs:"https://rssdocs.quickso.cn/multimedia.html#zui-jia-ping-lun",
        source:[ "/:language",
          "/" ],
        target:(params, url) => `/javlibrary/bestreviews/${params.language}/${new URL(url).searchParams.get('mode')}` },
      { title:"影片依分类",
        docs:"https://rssdocs.quickso.cn/multimedia.html#ying-pian-yi-fen-lei",
        source:[ "/:language",
          "/" ],
        target:(params, url) => `/javlibrary/genre/${new URL(url).searchParams.get('g')}/${params.language}/${new URL(url).searchParams.get('mode')}` },
      { title:"影片按演员",
        docs:"https://rssdocs.quickso.cn/multimedia.html#ying-pian-an-yan-yuan",
        source:[ "/:language",
          "/" ],
        target:(params, url) => `/javlibrary/star/${new URL(url).searchParams.get('s')}/${params.language}/${new URL(url).searchParams.get('mode')}` },
      { title:"用户发表的文章",
        docs:"https://rssdocs.quickso.cn/multimedia.html#yong-hu-fa-biao-de-wen-zhang",
        source:[ "/:language",
          "/" ],
        target:(params, url) => `/javlibrary/userposts/${new URL(url).searchParams.get('u')}/${params.language}` },
      { title:"用户想要的影片",
        docs:"https://rssdocs.quickso.cn/multimedia.html#yong-hu-xiang-yao-de-ying-pian",
        source:[ "/:language",
          "/" ],
        target:(params, url) => `/javlibrary/userwanted/${new URL(url).searchParams.get('u')}/${params.language}` },
      { title:"用户看过的影片",
        docs:"https://rssdocs.quickso.cn/multimedia.html#yong-hu-kan-guo-de-ying-pian",
        source:[ "/:language",
          "/" ],
        target:(params, url) => `/javlibrary/userwatched/${new URL(url).searchParams.get('u')}/${params.language}` },
      { title:"用户拥有的影片",
        docs:"https://rssdocs.quickso.cn/multimedia.html#yong-hu-yong-you-de-ying-pian",
        source:[ "/:language",
          "/" ],
        target:(params, url) => `/javlibrary/userowned/${new URL(url).searchParams.get('u')}/${params.language}` } ] },
  "jd.com":{ _name:"京东",
    item:[ { title:"商品价格",
        docs:"https://rssdocs.quickso.cn/shopping.html#jing-dong-shang-pin-jia-ge",
        source:[ "/" ],
        target:(params, url) => `/jd/price/${new URL(url).hash.match(/\/(\d+)\.html/)[1]}` } ] },
  "thejewishmuseum.org":{ _name:"Jewish Museum",
    ".":[ { title:"Exhibitions",
        docs:"https://rssdocs.quickso.cn/en/travel.html#the-jewish-museum" } ] },
  "jiemian.com":{ _name:"界面新闻",
    ".":[ { title:"快报",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#jie-mian-xin-wen-kuai-bao",
        source:[ "/list/:id",
          "/" ],
        target:"/jiemian" },
      { title:"栏目",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#jie-mian-xin-wen-lan-mu",
        source:[ "/list/:id",
          "/" ],
        target:"/jiemian/list/:id" } ] },
  "okjike.com":{ _name:"即刻",
    m:[ { title:"用户动态",
        docs:"https://rssdocs.quickso.cn/social-media.html#ji-ke",
        source:"/users/:uid",
  ...
  "jisilu.cn":{ _name:"集思录",
    ".":[ { title:"广场",
        docs:"https://rssdocs.quickso.cn/bbs.html#ji-si-lu-guang-chang",
        source:[ "/home/explore",
          "/explore",
          "/" ],
        target:"/jisilu/:category?/:sort?/:day?" },
      { title:"用户回复",
        docs:"https://rssdocs.quickso.cn/bbs.html#ji-si-lu-yong-hu-hui-fu",
        source:[ "/people/:user" ],
        target:"/jisilu/reply/:user" },
      { title:"用户主题",
        docs:"https://rssdocs.quickso.cn/bbs.html#ji-si-lu-yong-hu-zhu-ti",
        source:[ "/people/:user" ],
        target:"/jisilu/topic/:user" } ] },
  "jornada.com.mx":{ _name:"La Jornada",
    ".":[ { title:"News",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#jornada",
        source:[ "/category/:category",
          "/" ],
        target:(params) => (params.category ? `/jornada/today/${params.category.replacce('.html', '')}` : `/jornada/today`) } ] },
  "jseea.cn":{ _name:"江苏省教育考试院",
    ".":[ { title:"新闻中心",
        docs:"https://rssdocs.quickso.cn/government.html#jiang-su-sheng-ren-min-zheng-fu",
        source:[ "/webfile/news/:type" ],
        target:"/jseea/news/:type" } ] },
  "juejin.cn":{ _name:"掘金",
    ".":[ { title:"标签",
        docs:"https://rssdocs.quickso.cn/programming.html#jue-jin-biao-qian",
        source:"/tag/:tag",
        target:"/juejin/tag/:tag" },
      { title:"小册",
        docs:"https://rssdocs.quickso.cn/programming.html#jue-jin-xiao-ce",
        source:"/books",
        target:"/juejin/books" },
      { title:"沸点",
        docs:"https://rssdocs.quickso.cn/programming.html#jue-jin-fei-dian",
        source:[ "/pins/:type",
          "/pins/topic/:type" ],
        target:(params) => (params.type !== 'recommended' ? '/juejin/pins/:type' : '/juejin/pins') },
      { title:"用户专栏",
        docs:"https://rssdocs.quickso.cn/programming.html#jue-jin-zhuan-lan",
        source:[ "/user/:id",
          "/user/:id/posts" ],
        target:"/juejin/posts/:id" },
      { title:"收藏集",
        docs:"https://rssdocs.quickso.cn/programming.html#jue-jin-shou-cang-ji",
        source:[ "/user/:id",
          "/user/:id/collections" ],
        target:"/juejin/collections/:id" },
      { title:"单个收藏夹",
        docs:"https://rssdocs.quickso.cn/programming.html#jue-jin-dan-ge-shou-cang-jia",
        source:"/collection/:collectionId",
        target:"/juejin/collection/:collectionId" },
      { title:"分享",
        docs:"https://rssdocs.quickso.cn/programming.html#jue-jin",
        source:[ "/user/:userId",
          "/user/:userId/shares" ],
  ...
  "jumpvg.com":{ _name:"jump app",
    "switch":[ { title:"折扣清单",
        docs:"https://rssdocs.quickso.cn/game.html#jump",
        source:[ "/" ],
        target:"/jump/discount/switch" } ] },
  "kakuyomu.jp":{ _name:"kakuyomu",
    ".":[ { title:"章节更新",
        docs:"https://rssdocs.quickso.cn/reading.html#kakuyomu-zhang-jie-geng-xin",
        source:[ "/works/:id" ],
        target:"/kakuyomu/episode/:id" } ] },
  "kbs.co.kr":{ _name:"KBS",
    world:[ { title:"News",
        docs:"https://rssdocs.quickso.cn/new-media.html#kbs",
        source:"/",
        target:"/kbs/news" },
      { title:"Today",
        docs:"https://rssdocs.quickso.cn/new-media.html#kbs",
  ...
  "kcna.kp":{ _name:"朝鲜中央通讯社",
    www:[ { title:"朝鲜劳动党总书记金正恩同志革命活动新闻",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#chao-xian-zhong-yang-tong-xun-she",
  ...
  "gotokeep.com":{ _name:"Keep",
    ".":[ { title:"用户运动日记",
        docs:"https://rssdocs.quickso.cn/social-media.html#keep",
        source:"/users/:id",
        target:"/keep/user/:id" } ] },
  "kemono.party":{ _name:"Kemono",
    ".":[ { title:"Posts",
        docs:"https://rssdocs.quickso.cn/anime.html#kemono-posts",
  ...
  "kuaidi100.com":{ _name:"快递 100",
    ".":[ { title:"快递订单追踪",
        docs:"https://rssdocs.quickso.cn/other.html#kuai-di-100",
        source:"/",
        target:(params, url, document) => {
  ...
  "kuwaitlocal.com":{ _name:"Kuwait Local",
    ".":[ { title:"Latest News",
        docs:"https://rssdocs.quickso.cn/en/new-media.html#kuwait-local",
        source:[ "/news/latest",
          "/news",
          "/" ],
        target:"/kuwaitlocal" },
  ...
  "kyodonews.net":{ _name:"共同网",
    china:[ { title:"最新报道",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#gong-tong-wang-zui-xin-bao-dao",
        source:"/",
  ...
  "lang.live":{ _name:"浪 Play 直播",
    ".":[ { title:"直播间开播",
        docs:"https://rssdocs.quickso.cn/live.html#lang-play-yuan-zhi-bo",
        source:[ "/room/:id" ],
        target:"/lang/live/room/:id" } ] },
  "lanqiao.cn":{ _name:"蓝桥云课",
    ".":[ { title:"作者发布的课程",
        docs:"https://rssdocs.quickso.cn/programming.html#lan-qiao-yun-ke-zuo-zhe-fa-bu-de-ke-cheng",
        source:[ "/users/:uid" ],
        target:"/lanqiao/author/:uid" },
      { title:"全站发布的课程",
        docs:"https://rssdocs.quickso.cn/programming.html#lan-qiao-yun-ke-quan-zhan-fa-bu-de-ke-cheng",
        source:[ "/courses/" ],
        target:"/lanqiao/courses/all" },
      { title:"技术社区",
        docs:"https://rssdocs.quickso.cn/programming.html#lan-qiao-yun-ke-ji-shu-she-qu",
        source:[ "/questions/",
          "/questions/topics/:id" ],
        target:"/lanqiao/questions/:id" } ] },
  "laohu8.com":{ _name:"老虎社区",
    ".":[ { title:"个人主页",
        docs:"https://rssdocs.quickso.cn/finance.html#lao-hu-she-qu",
        source:"/personal/:id",
        target:"/laohu8/personal/:id" } ] },
  "latepost.com":{ _name:"晚点 Latepost",
    ".":[ { title:"报道",
        docs:"https://rssdocs.quickso.cn/new-media.html#wan-dian-latepost-bao-dao",
        source:"/",
        target:(params, url) => `/latepost/${new URL(url).searchParams.get('proma')}` } ] },
  "lativ.com.tw":{ _name:"lativ",
    www:[ { title:"订阅商品价格",
        docs:"https://rssdocs.quickso.cn/shopping.html#lativ",
        source:"/Detail/:id",
        target:"/lativ/:id" } ] },
  "learnku.com":{ _name:"Learn Ku 社区",
    ".":[ { title:"分区",
        docs:"https://rssdocs.quickso.cn/bbs.html#learnku",
        source:[ "/:community" ],
        target:"/learnku/:community" } ] },
  "leetcode.com":{ _name:"LeetCode",
    ".":[ { title:"文章",
        docs:"https://rssdocs.quickso.cn/programming.html#leetcode",
        source:[ "/articles" ],
  ...
  "leiphone.com":{ _name:"雷峰网",
    ".":[ { title:"最新文章",
        docs:"https://rssdocs.quickso.cn/new-media.html#lei-feng-wang-zui-xin-wen-zhang",
        source:[ "/" ],
        target:"/leiphone" },
      { title:"栏目",
        docs:"https://rssdocs.quickso.cn/new-media.html#lei-feng-wang-lan-mu",
        source:[ "/category/:catename" ],
        target:"/leiphone/category/:catname" },
      { title:"业界资讯",
        docs:"https://rssdocs.quickso.cn/new-media.html#lei-feng-wang-ye-jie-zi-xun",
        source:[ "/" ],
        target:"/leiphone/newsflash" } ] },
  "lever.co":{ _name:"Lever",
    ".":[ { title:"Lever HRIS Job Boards Feed",
        docs:"https://rssdocs.quickso.cn/other.html#lever",
        source:[ "/:domain" ],
        target:"/lever/:domain" } ] },
  "iyingdi.com":{ _name:"旅法师营地",
    www:[ { title:"分区",
        docs:"https://rssdocs.quickso.cn/game.html#lv-fa-shi-ying-di",
        source:"/tz/tag/:tag",
  ...
  "lianxh.cn":{ _name:"连享会",
    ".":[ { title:"精彩资讯",
        docs:"https://rssdocs.quickso.cn/programming.html#lian-xiang-hui-jing-cai-zi-xun",
        source:[ "/blogs.html",
          "/" ],
        target:"/lianxh/:category?" } ] },
  "line.me":{ _name:"LINE Today",
    ".":[ { title:"LINE Today",
        docs:"https://rssdocs.quickso.cn/new-media.html#line-today",
        source:[ "/" ],
        target:"/line/today/:edition?/:tab?" } ] },
  linkresearcher:{ _name:"领研",
    ".":[ { title:"论文",
        docs:"https://rssdocs.quickso.cn/study.html#ling-yan",
        source:[ "/theses",
          "/information",
          "/careers" ],
        target:(_, url) => {
  ...
  "linovelib.com":{ _name:"哩哔轻小说",
    ".":[ { title:"小说详情",
        docs:"https://rssdocs.quickso.cn/anime.html#linovelib",
        source:[ "/novel/:id" ],
        target:"/linovellib/novel/:id" } ] },
  "literotica.com":{ _name:"Literotica",
    ".":[ { title:"New Stories",
        docs:"https://rssdocs.quickso.cn/reading.html#literotica-new-stories",
        source:[ "/" ],
        target:"/literotica/new" },
      { title:"Category",
        docs:"https://rssdocs.quickso.cn/reading.html#literotica-category",
        source:[ "/c/:category",
          "/" ],
        target:"/literotica/category/:category" } ] },
  "liulinblog.com":{ _name:"木木博客",
    ".":[ { title:"每天六十秒（60秒）读懂世界",
        docs:"https://rssdocs.quickso.cn/new-media.html#mu-mu-bo-ke",
        source:[ "/kuaixun" ],
  ...
  "lkong.com":{ _name:"龙空",
    ".":[ { title:"分区",
        docs:"https://rssdocs.quickso.cn/bbs.html#long-kong-fen-qu",
        source:[ "/forum/:id",
          "/" ],
        target:"/lkong/forum/:id?/:digest?" },
      { title:"帖子",
        docs:"https://rssdocs.quickso.cn/bbs.html#long-kong-tie-zi",
        source:[ "/thread/:id",
          "/" ],
        target:"/lkong/thread/:id" } ] },
  "lofter.com":{ _name:"Lofter",
    www:[ { title:"话题 (标签)",
        docs:"https://rssdocs.quickso.cn/social-media.html#lofter",
        source:[ "/tag/:name",
          "/tag/:name/:type" ],
  ...
  "logonews.cn":{ _name:"LogoNews 标志情报局",
    ".":[ { title:"首页",
        docs:"https://rssdocs.quickso.cn/design.html#logonews-biao-zhi-qing-bao-ju-shou-ye",
        source:[ "/" ],
        target:"/logonews" },
      { title:"文章分类",
        docs:"https://rssdocs.quickso.cn/design.html#logonews-biao-zhi-qing-bao-ju-wen-zhang-fen-lei",
        source:[ "/category/:category/:type?" ],
        target:"/logonews/category/:category/:type?" },
      { title:"文章标签",
        docs:"https://rssdocs.quickso.cn/design.html#logonews-biao-zhi-qing-bao-ju-wen-zhang-biao-qian",
        source:[ "/tag/:tag" ],
        target:"/logonews/tag/:tag" },
      { title:"作品",
        docs:"https://rssdocs.quickso.cn/design.html#logonews-biao-zhi-qing-bao-ju-zuo-pin",
        source:[ "/work" ],
        target:"/logonews/work" },
      { title:"作品分类",
        docs:"https://rssdocs.quickso.cn/design.html#logonews-biao-zhi-qing-bao-ju-zuo-pin-fen-lei",
        source:[ "/work/categorys/:category" ],
        target:"/logonews/work/categorys/:category" },
      { title:"作品标签",
        docs:"https://rssdocs.quickso.cn/design.html#logonews-biao-zhi-qing-bao-ju-zuo-pin-biao-qian",
        source:[ "/work/tags/:tag" ],
        target:"/logonews/work/tags/:tag" } ] },
  "garena.tw":{ _name:"Garena",
    lol:[ { title:"英雄联盟台服新闻",
        docs:"https://rssdocs.quickso.cn/game.html#ying-xiong-lian-meng-tai-fu-xin-wen",
        source:[ "/news/:category",
          "/news" ],
        target:(params) => '/loltw/news/' + (params.category || '') } ] },
  "lovelive-anime.jp":{ _name:"Love Live 官网",
    www:[ { title:"最新 NEWS",
        docs:"https://rssdocs.quickso.cn/anime.html#lovelive-anime-love-live-guan-wang-zui-xin-news",
        source:[ "/",
          "/news" ],
        target:"/lovelive-anime/news" },
      { title:"分类 Topics",
        docs:"https://rssdocs.quickso.cn/anime.html#lovelive-anime-love-live-guan-wang-fen-lei-topics",
        source:[ "/:abbr/topics/",
          "/:abbr/topics.php" ],
        target:(params, url) => {
      ...
      { title:"Schedule",
        docs:"https://rssdocs.quickso.cn/anime.html#lovelive-anime-love-live-guan-wang-schedule",
        source:[ "/schedule/" ],
        target:(params, url) => {
  ...
  "luogu.com.cn":{ _name:"洛谷",
    ".":[ { title:"日报",
        docs:"https://rssdocs.quickso.cn/programming.html#luo-gu",
  ...
  "lvv2.com":{ _name:"LVV2",
    ".":[ { title:"热门",
        docs:"https://rssdocs.quickso.cn/new-media.html#lvv2",
        source:[ "/sort-hot" ],
  ...
  "sonymusic.co.jp":{ _name:"Sony Music",
    www:[ { title:"LiSA News",
        docs:"https://rssdocs.quickso.cn/en/live.html#lisa",
        source:[ "/artist/lisa/",
          "/artist/lisa/info/" ],
        target:"/lxixsxa/info" },
      { title:"LiSA Albums",
  ...
  "macfilos.com":{ _name:"Macfilos",
    ".":[ { title:"Blog",
        docs:"https://rssdocs.quickso.cn/new-media.html#macfilos-blog",
        source:[ "/blog",
          "/" ],
        target:"/macfilos/blog" } ] },
  "manhuagui.com":{ _name:"漫画柜",
    www:[ { title:"漫画柜个人订阅",
        docs:"https://rssdocs.quickso.cn/anime.html#kan-man-hua",
  ...
  "mcachicago.org":{ _name:"MCA Chicago",
    ".":[ { title:"Exhibitions",
        docs:"https://rssdocs.quickso.cn/en/travel.html#museum-of-contemporary-art-chicago" } ] },
  "mckinsey.com.cn":{ _name:"McKinsey Greater China",
    ".":[ { title:"汽车 | 洞见",
        docs:"https://rssdocs.quickso.cn/finance.html#mai-ken-xi",
  ...
  "mdpi.com":{ _name:"MDPI",
    www:[ { title:"Journal",
        docs:"https://rssdocs.quickso.cn/journal.html#MDPI",
        source:"/journal/:journal",
        target:"/mdpi/:journal" } ] },
  "medsci.cn":{ _name:"梅斯医学",
    ".":[ { title:"资讯",
        docs:"https://rssdocs.quickso.cn/new-media.html#mei-si-yi-xue-zi-xun",
        source:[ "/department/details",
          "/" ],
        target:(params) => `/medsci${params.s_id ? `/${params.s_id}${params.t_id ? `/${params.s_id}` : ''}` : ''}` } ] },
  "meituclub.com":{ _name:"妹图社",
    ".":[ { title:"最新",
        docs:"https://rssdocs.quickso.cn/picture.html#mei-tu-she-zui-xin",
        source:[ "/" ],
        target:"/meituclub/latest" } ] },
  "meteor.today":{ _name:"Meteor",
    ".":[ { title:"看板",
        docs:"https://rssdocs.quickso.cn/bbs.html#meteor",
        source:[ "/board/:board",
          "/board/:board/new" ],
  ...
  "metmuseum.org":{ _name:"The Metropolitan Museum of Art",
    www:[ { title:"Exhibitions",
        docs:"https://rssdocs.quickso.cn/en/travel.html#the-metropolitan-museum-of-art" } ] },
  "hoyoverse.com":{ _name:"米哈游",
    genshin:[ { title:"原神 - 新闻",
        docs:"https://rssdocs.quickso.cn/game.html##mi-ha-you",
        source:"/:location/news",
        target:"/mihoyo/ys/:location" } ] },
  "mihoyo.com":{ _name:"米哈游",
    bbs:[ { title:"米游社 - 官方公告",
        docs:"https://rssdocs.quickso.cn/game.html#mi-ha-you-mi-you-she-guan-fang-gong-gao",
        source:[ "/:game/home/28",
          "/:game/home/6",
          "/:game/home/31",
          "/:game/home/33",
  ...
  "mindmeister.com":{ _name:"MindMeister",
    ".":[ { title:"分类",
        docs:"https://rssdocs.quickso.cn/study.html#mindmeister",
  ...
  "mingpao.com":{ _name:"明报",
    ".":[ { title:"即时新闻",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#ming-bao",
        source:[ "/" ],
  ...
  "miris.design":{ _name:"Stratechery by Ben Thompson",
    blog:[ { title:"Articles",
        docs:"https://rssdocs.quickso.cn/en/blog.html#stratechery-by-ben-thompson" } ] },
  "mirror.xyz":{ _name:"Mirror",
    ".":[ { title:"User",
        docs:"https://rssdocs.quickso.cn/new-media.html#mirror-user",
        source:[ "/:id",
          "/" ],
        target:(params, url) => {
  ...
  "mobilism.org":{ _name:"Mobilism",
    ".":[ { title:"论坛",
        docs:"https://rssdocs.quickso.cn/bbs.html#mobilism",
        source:"/" },
      { title:"门户",
        docs:"https://rssdocs.quickso.cn/bbs.html#mobilism",
        source:"/portal.php",
      ...
      { title:"电子书",
        docs:"https://rssdocs.quickso.cn/reading.html#mobilism",
        source:"/" } ] },
  "mohw.gov.tw":{ _name:"台灣衛生福利部",
    ".":[ { title:"即時新聞澄清",
        docs:"https://rssdocs.quickso.cn/government.html#tai-wan-wei-sheng-fu-li-bu-ji-shi-xin-wen-cheng-qing",
        source:[ "/" ],
        target:"/mohw/clarification" } ] },
  "mox.moe":{ _name:"Mox.moe",
    ".":[ { title:"首頁",
        docs:"https://rssdocs.quickso.cn/anime.html#mox-moe-shou-ye",
        source:[ "/l/:category",
          "/" ],
        target:"/mox/:category?" } ] },
  "52bdys.com":{ _name:"哔嘀影视",
    ".":[ { title:"首页",
        docs:"https://rssdocs.quickso.cn/multimedia.html#bi-di-ying-shi",
        source:[ "/" ],
        target:"/mp4er/:type?/:caty?/:area?/:year?/:order?" } ] },
  "mpaypass.com.cn":{ _name:"移动支付网",
    ".":[ { title:"新闻",
        docs:"https://rssdocs.quickso.cn/new-media.html#yi-dong-zhi-fu-wang",
        source:"/",
  ...
  "mtime.com":{ _name:"时光网",
    news:[ { title:"时光新闻",
        docs:"https://rssdocs.quickso.cn/multimedia.html#shi-guang-wang",
        source:"/",
        target:"/mtime/news" } ] },
  "mwm.net.cn":{ _name:"管理世界",
    ".":[ { title:"分类",
        docs:"https://rssdocs.quickso.cn/journal.html#guan-li-shi-jie-fen-lei",
        source:[ "/web/:category",
          "/" ],
        target:"/mvm/:category?" } ] },
  "mydrivers.com":{ _name:"快科技",
    ".":[ { title:"新闻",
        docs:"https://rssdocs.quickso.cn/new-media.html#kuai-ke-ji-xin-wen",
        source:[ "/" ],
        target:"/mydrivers/:type?/:id?" } ] },
  "myfigurecollection.net":{ _name:"MyFigureCollection",
    ".":[ { title:"活動",
        docs:"https://rssdocs.quickso.cn/shopping.html#MyFigureCollection-huo-dong",
      ...
      { title:"資料庫",
        docs:"https://rssdocs.quickso.cn/shopping.html#MyFigureCollection-zi-liao-ku",
        source:[ "/browse",
          "/" ],
        target:"/myfigurecollection/:category?/:language?" },
      { title:"圖片",
        docs:"https://rssdocs.quickso.cn/shopping.html#MyFigureCollection-tu-pian",
  ...
  "mygopen.com":{ _name:"MyGoPen",
    ".":[ { title:"分類",
        docs:"https://rssdocs.quickso.cn/new-media.html#mygopen-fen-lei",
        source:[ "/search/label/:label",
          "/" ],
        target:"/mygopen/:label?" } ] },
  "mysql.com":{ _name:"MySQL",
    dev:[ { title:"Release Notes",
        docs:"https://rssdocs.quickso.cn/programming.html#mysql-release-notes",
        source:[ "/" ],
  ...
  "natgeomedia.com":{ _name:"国家地理",
    ".":[ { title:"分类",
        docs:"https://rssdocs.quickso.cn/travel.html#guo-jia-di-li",
        source:[ "/:cat/:type",
          "/" ],
        target:"/natgeo/:cat/:type" } ] },
  "nature.com":{ _name:"Nature",
    ".":[ { title:"最新成果",
        docs:"https://rssdocs.quickso.cn/journal.html#nature-xi-lie",
  ...
  "nautil.us":{ _name:"Nautilus",
    ".":[ { title:"Topics",
        docs:"https://rssdocs.quickso.cn/en/new-media.html#nautilus",
        source:[ "/topics/:tid" ],
        target:"/nautil/topic/:tid" } ] },
  "nbd.com.cn":{ _name:"每经网",
    ".":[ { title:"分类",
        docs:"https://rssdocs.quickso.cn/finance.html#mei-jing-wang",
        source:"/",
        target:"/nbd" },
      { title:"重磅原创",
        docs:"https://rssdocs.quickso.cn/finance.html#mei-jing-wang",
  ...
  "ncepu.edu.cn":{ _name:"华北电力大学研究生院",
    yjsy:[ { title:"通知公告",
        docs:" https://rssdocs.quickso.cn/university.html#hua-bei-dian-li-da-xue",
  ...
  "ncwu.edu.cn":{ _name:"华北水利水电大学",
    ".":[ { title:"学校通知",
        docs:"https://rssdocs.quickso.cn/university.html#hua-bei-shui-li-shui-dian-da-xue",
        source:"/xxtz.htm",
        target:"/ncwu/notice" } ] },
  "neatdownloadmanager.com":{ _name:"Neat Download Manager",
    ".":[ { title:"Download",
        docs:"https://rssdocs.quickso.cn/program-update.html#neat-download-manager-download",
        source:[ "/index.php",
          "/" ],
        target:"/neatdownloadmanager/download/:os?" } ] },
  "163.com":{ _name:"网易",
    ds:[ { title:"大神",
        docs:"https://rssdocs.quickso.cn/game.html#wang-yi-da-shen",
        source:"/user/:id",
        target:"/netease/ds/:id" } ],
    open:[ { title:"公开课 - 精品课程",
        docs:"https://rssdocs.quickso.cn/study.html#wang-yi-gong-kai-ke",
        source:"/",
        target:"/open163/vip" },
      { title:"公开课 - 最新课程",
        docs:"https://rssdocs.quickso.cn/study.html#wang-yi-gong-kai-ke",
    ...
    music:[ { title:"云音乐 - 用户歌单",
        docs:"https://rssdocs.quickso.cn/multimedia.html#wang-yi-yun-yin-yue",
        source:"/",
        target:(params, url) => {
  ...
  "neu.edu.cn":{ _name:"东北大学",
    neunews:[ { title:"新闻网",
        docs:"https://rssdocs.quickso.cn/university.html#dong-bei-da-xue",
  ...
  "newmuseum.org":{ _name:"New Museum",
    www:[ { title:"Exhibitions",
        docs:"https://rssdocs.quickso.cn/en/travel.html#new-museum" } ] },
  "news.cn":{ _name:"新华网",
    ".":[ { title:"新华社新闻",
        docs:"https://rssdocs.quickso.cn/new-media.html#xin-hua-wang-xin-hua-she-xin-wen",
        source:[ "/" ],
        target:"/news/whxw" } ] },
  "newsmarket.com.tw":{ _name:"上下游News&amp;Market",
    ".":[ { title:"分類",
        docs:"https://rssdocs.quickso.cn/new-media.html#shang-xia-you-news-market",
        source:[ "/blog/category/:category",
          "/" ],
        target:"/newsmarket/:category?" } ] },
  "nextapple.com":{ _name:"壹蘋新聞網",
    tw:[ { title:"最新新聞",
        docs:"https://rssdocs.quickso.cn/new-media.html#yi-ping-xin-wen-wang",
        source:[ "/",
          "/realtime/:category" ],
        target:"/nextapple/realtime/:category?" } ] },
  "nga.cn":{ _name:"NGA",
    bbs:[ { title:"分区帖子",
        docs:"https://rssdocs.quickso.cn/bbs.html#nga-fen-qu-tie-zi",
        source:"/thread.php",
        target:(params, url) => new URL(url).searchParams.get('fid') && `/nga/forum/${new URL(url).searchParams.get('fid')}` },
      { title:"帖子",
        docs:"https://rssdocs.quickso.cn/bbs.html#nga-tie-zi",
        source:"/read.php",
  ...
  "ngocn2.org":{ _name:"NGOCN",
    ".":[ { title:"分类",
        docs:"https://rssdocs.quickso.cn/new-media.html#ngocn2-fen-lei",
        source:[ "/" ],
        target:"/ngocn2/:category?" } ] },
  "nhk.or.jp":{ _name:"NHK",
    www3:[ { title:"News Web Easy",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#nhk",
        source:[ "/news/easy/",
          "/" ],
  ...
  "nifd.cn":{ _name:"国家金融与发展实验室",
    www:[ { title:"周报",
        docs:"https://rssdocs.quickso.cn/finance.html#guo-jia-jin-rong-yu-fa-zhan-shi-yan-shi-yan-jiu",
        source:[ "/Research" ],
        target:(_, url) => {
  ...
  "nikkei.com":{ _name:"日本経済新聞",
    www:[ { title:"ホームページ",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#ri-ben-jing-ji-xin-wen",
        source:"/",
        target:"/nikkei/index" } ] },
  "nintendo.com":{ _name:"Nintendo",
    ".":[ { title:"直面会",
        docs:"https://rssdocs.quickso.cn/game.html#nintendo",
  ...
  "nippon.com":{ _name:"走进日本",
    www:[ { title:"政治外交",
        docs:"https://rssdocs.quickso.cn/travel.html#zou-jin-ri-ben",
        source:[ "/nippon/:category?",
          "/cn" ],
        target:"/nippon/:category?" } ] },
  "njit.edu.cn":{ _name:"南京工程学院",
    jwc:[ { title:"南京工程学院教务处",
        docs:"https://rssdocs.quickso.cn/university.html#nan-jing-gong-cheng-xue-yuan-nan-jing-gong-cheng-xue-yuan-jiao-wu-chu",
        source:"/index/:type",
        target:(params) => `/njit/jwc/${params.type.replace('.htm', '')}` } ],
    www:[ { title:"南京工程学院通知公告",
        docs:"https://rssdocs.quickso.cn/university.html#nan-jing-gong-cheng-xue-yuan-nan-jing-gong-cheng-xue-yuan-tong-zhi-gong-gao",
        source:"/",
        target:"/njit/tzgg" } ] },
  "njnu.edu.cn":{ _name:"南京师范大学",
    ceai:[ { title:"计算机与电子信息学院-人工智能学院",
        docs:"https://rssdocs.quickso.cn/university.html#nan-jing-shi-fan-da-xue",
        source:"/",
  ...
  "nju.edu.cn":{ _name:"南京大学",
    admission:[ { title:"本科迎新",
        docs:"https://rssdocs.quickso.cn/university.html#nan-jing-da-xue-ben-ke-ying-xin",
        source:[ "/tzgg/index.html",
          "/tzgg",
          "/" ],
        target:"/nju/admission" } ],
    dafls:[ { title:"大学外语部",
        docs:"https://rssdocs.quickso.cn/university.html#nan-jing-da-xue-da-xue-wai-yu-bu",
        source:[ "/13167/list.html",
          "/" ],
        target:"/nju/dafls" } ],
    elite:[ { title:"本科生交换生系统",
        docs:"https://rssdocs.quickso.cn/university.html#nan-jing-da-xue-ben-ke-sheng-yuan-jiao-huan-sheng-xi-tong",
        source:[ "/exchangesystem/index/more",
          "/exchangesystem",
          "/" ],
        target:(_, url) => `/nju/exchangesys/${new URL(url).searchParams.get('type') === 'xw' ? 'news' : 'proj'}` } ],
    grawww:[ { title:"研究生院",
        docs:"https://rssdocs.quickso.cn/university.html#nan-jing-da-xue-yan-jiu-sheng-yuan",
        source:[ "/main.htm",
          "/" ],
        target:"/nju/gra" } ],
    hospital:[ { title:"校医院",
        docs:"https://rssdocs.quickso.cn/university.html#nan-jing-da-xue-xiao-yi-yuan",
        source:[ "/ggtz/index.html" ],
        target:"/nju/hospital" } ],
    itsc:[ { title:"ITSC信息中心",
        docs:"https://rssdocs.quickso.cn/university.html#nan-jing-da-xue-itsc-xin-xi-zhong-xin",
        source:[ "/tzgg/list.htm" ],
        target:"/nju/itsc" } ],
    jjc:[ { title:"基建处",
        docs:"https://rssdocs.quickso.cn/university.html#nan-jing-da-xue-ji-jian-chu",
        source:[ "/main.htm",
          "/" ],
        target:"/nju/jjc" } ],
    jw:[ { title:"本科生院",
        docs:"https://rssdocs.quickso.cn/university.html#nan-jing-da-xue-ben-ke-sheng-yuan",
        source:[ "/:type/list.htm" ],
        target:"/nju/jw/:type" } ],
    rczp:[ { title:"人才招聘网",
        docs:"https://rssdocs.quickso.cn/university.html#nan-jing-da-xue-ren-cai-zhao-pin-wang",
        source:[ "/sylm/:type/index.html" ],
        target:"/nju/rczp/:type" } ],
    scit:[ { title:"科学技术处",
        docs:"https://rssdocs.quickso.cn/university.html#nan-jing-da-xue-ke-xue-ji-shu-chu",
        source:[ "/:type/list.htm" ],
        target:(params) => `/nju/scit/${params.type === '11003' ? 'kydt' : 'tzgg'}` } ],
    webplus:[ { title:"后勤集团",
        docs:"https://rssdocs.quickso.cn/university.html#nan-jing-da-xue-hou-qin-ji-tuan",
        source:[ "/_s25/main.psp" ],
        target:"/nju/hqjt" } ],
    zbb:[ { title:"招标办公室",
        docs:"https://rssdocs.quickso.cn/university.html#nan-jing-da-xue-zhao-biao-ban-gong-shi",
    ...
    zcc:[ { title:"资产管理处",
        docs:"https://rssdocs.quickso.cn/university.html#nan-jing-da-xue-zi-chan-guan-li-chu",
  ...
  "njupt.edu.cn":{ _name:"南京邮电大学",
    jwc:[ { title:"教务处通知与新闻",
        docs:"https://rssdocs.quickso.cn/university.html#nan-jing-you-dian-da-xue",
        source:"/*/list.htm",
        target:(_params, url) => {
                    url = new URL(url);
  ...
  "njust.edu.cn":{ _name:"南京理工大学",
    jwc:[ { title:"教务处",
        docs:"https://rssdocs.quickso.cn/university.html#nan-jing-li-gong-da-xue",
        source:[ "/:type/list.htm" ],
        target:(params) => {
                    let type = '';
                    switch (params.type) {
  ...
  "njxzc.edu.cn":{ _name:"南京晓庄学院",
    www:[ { title:"通知公告",
        docs:"https://rssdocs.quickso.cn/university.html#nan-jing-xiao-zhuang-xue-yuan-tong-zhi-gong-gao",
        source:[ "/89/list.htm",
          "/" ],
        target:"/njxzc/tzgg" } ] },
  "nltimes.nl":{ _name:"NL Times",
    ".":[ { title:"News",
        docs:"https://rssdocs.quickso.cn/new-media.html#nl-times",
  ...
  "nmbxd1.com":{ _name:"X岛匿名版",
    www:[ { title:"串",
        docs:"https://rssdocs.quickso.cn/bbs.html#x-dao-ni-ming-ban",
        source:[ "/Forum/timeline/id/:id",
          "/f/:id" ],
        target:"/nmbxd1/:id" } ] },
  "nmtv.cn":{ _name:"内蒙古广播电视台",
    ".":[ { title:"点播",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#nei-meng-gu-guang-bo-dian-shi-tai-dian-bo",
        source:[ "/" ],
        target:(params, url) => `/nmtv/column/${new URL(url).toString.split(/\/folder/).pop()}` } ] },
  "nodejs.org":{ _name:"Node.js",
    ".":[ { title:"News",
        docs:"https://rssdocs.quickso.cn/programming.html#nodejs-news",
        source:[ "/:language/blog",
          "/" ],
        target:"/nodejs/blog/:language?" } ] },
  "nogizaka46.com":{ _name:"乃木坂46",
    news:[ { title:"新闻",
        docs:"https://rssdocs.quickso.cn/new-media.html#ban-dao-xi-lie-guan-wang-zi-xun-nai-mu-ban-46-xin-wen",
        source:[ "/s/n46/news/list" ],
        target:"/nogizaka46/news" } ],
    blog:[ { title:"博客",
        docs:"https://rssdocs.quickso.cn/new-media.html#ban-dao-xi-lie-guan-wang-zi-xun-nai-mu-ban-46-bo-ke",
        source:[ "/s/n46/diary/MEMBER" ],
        target:"/nogizaka46/blog" } ] },
  "news.now.com":{ _name:"Now 新聞",
    ".":[ { title:"新聞",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#now-xin-wen",
        source:[ "/" ],
        target:"/now/news/:category?/:id?" } ] },
  "nowcoder.com":{ _name:"牛客网",
    ".":[ { title:"面经",
        docs:"https://rssdocs.quickso.cn/bbs.html#niu-ke-wang-mian-jing",
        source:[ "/" ],
        target:"/nowcoder/experience" },
      { title:"讨论区",
        docs:"https://rssdocs.quickso.cn/bbs.html#niu-ke-wang",
        source:[ "/discuss" ],
        target:(_params, url) => {
  ...
  "npmjs.com":{ _name:"npm",
    ".":[ { title:"包",
        docs:"https://rssdocs.quickso.cn/program-update.html#npm",
        source:[ "/package/:name" ],
        target:"/npm/package/:name" } ] },
  "ntdtv.com":{ _name:"新唐人电视台",
    www:[ { title:"频道",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#xin-tang-ren-dian-shi-tai",
        source:"/:language/:id",
        target:"/ntdtv/:language/:id" } ] },
  "nua.edu.cn":{ _name:"南京艺术学院",
    index:[ { title:"官网信息",
        docs:"https://rssdocs.quickso.cn/university.html#nan-jing-yi-shu-xue-yuan",
        source:[ "/:type/list.htm" ],
  ...
  "nuaa.edu.cn":{ _name:"南京航空航天大学",
    aao:[ { title:"教务处",
        docs:"https://rssdocs.quickso.cn/university.html#nan-jing-hang-kong-hang-tian-da-xue" } ],
    cae:[ { title:"自动化学院",
        docs:"https://rssdocs.quickso.cn/university.html#nan-jing-hang-kong-hang-tian-da-xue" } ],
    cs:[ { title:"计算机科学与技术学院",
        docs:"https://rssdocs.quickso.cn/university.html#nan-jing-hang-kong-hang-tian-da-xue" } ],
  ...
  "nuist.edu.cn":{ _name:"南京信息工程大学",
    bulletin:[ { title:"信息公告栏",
        docs:"https://rssdocs.quickso.cn/university.html#nan-jing-xin-xi-gong-cheng-da-xue",
  ...
  "nyaa.si":{ _name:"nyaa",
    ".":[ { title:"nyaa 的搜索结果、指定用户、指定用户的搜索结果",
        docs:"https://rssdocs.quickso.cn/multimedia.html#nyaa",
        source:[ "/",
          "/user/:username" ],
        target:(params, url) => {
                    url = new URL(url);
  ...
  "nytimes.com":{ _name:"纽约时报",
    ".":[ { title:"新闻简报",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#niu-yue-shi-bao",
  ...
  "oceanengine.com":{ _name:"巨量算数",
    trendinsight:[ { title:"抖音/头条指数波峰",
        docs:"https://rssdocs.quickso.cn/other.html#ju-liang-suan-shu-suan-shu-zhi-shu",
  ...
  "odaily.news":{ _name:"Odaily 星球日报",
    ".":[ { title:"快讯",
        docs:"https://rssdocs.quickso.cn/new-media.html#odaily-xing-qiu-ri-bao-kuai-xun",
        source:[ "/newsflash",
          "/" ],
        target:"/odaily/newsflash" },
      { title:"文章",
        docs:"https://rssdocs.quickso.cn/new-media.html#odaily-xing-qiu-ri-bao-wen-zhang",
        source:[ "/" ],
        target:"/odaily/:id?" },
      { title:"用户文章",
        docs:"https://rssdocs.quickso.cn/new-media.html#odaily-xing-qiu-ri-bao-yong-hu-wen-zhang",
        source:[ "/user/:id",
          "/" ],
        target:"/odaily/user/:id" },
      { title:"活动",
        docs:"https://rssdocs.quickso.cn/new-media.html#odaily-xing-qiu-ri-bao-huo-dong",
        source:[ "/activityPage",
          "/" ],
  ...
  "oilchem.net":{ _name:"隆众资讯",
    ".":[ { title:"资讯",
        docs:"https://rssdocs.quickso.cn/new-media.html#long-zhong-zi-xun" } ] },
  "on.cc":{ _name:"东网",
    hk:[ { title:"港澳",
        docs:"https://rssdocs.quickso.cn/other.html#guo-jia-zi-ran-ke-xue-ji-jin-wei-yuan-hui",
  ...
  "oo-software.com":{ _name:"O&O Software",
    ".":[ { title:"Changelog",
        docs:"https://rssdocs.quickso.cn/program-update.html#oo-software-changelog",
        source:[ "/en/changelog" ],
        target:(params, url) => `/oo-software/changelog/${new URL(url).match(/\/en\/(.*?)\/changelog/)[1]}` } ] },
  "openwrt.org":{ _name:"Openwrt",
    ".":[ { title:"Model Releases",
        docs:"https://rssdocs.quickso.cn/program-update.html#openwrt",
        source:"/toh/:band/:model",
        target:"/openwrt/releases/:model" } ] },
  "orcid.org":{ _name:"ORCID",
    ".":[ { title:"作品列表",
        docs:"https://rssdocs.quickso.cn/study.html#orcid",
        source:[ "/:id",
          "/" ],
        target:"/ocrid/:id" } ] },
  "oreno3d.com":{ _name:"俺の3Dエロ動画",
    ".":[ { title:"关键词搜索",
        docs:"https://rssdocs.quickso.cn/anime.htm#an-の3dエロ-dong-hua-oreno3d-guan-jian-ci-sou-suo",
        source:[ "/search" ],
        target:(_params, url) => {
                    const searchParams = new URL(url).searchParams;
      ...
      { title:"角色搜索",
        docs:"https://rssdocs.quickso.cn/anime.html#an-の3dエロ-dong-hua-oreno3d-jiao-se-sou-suo",
      ...
      { title:"作者搜索",
        docs:"https://rssdocs.quickso.cn/anime.html#an-の3dエロ-dong-hua-oreno3d-zuo-zhe-sou-suo",
      ...
      { title:"标签搜索",
        docs:"https://rssdocs.quickso.cn/anime.html#an-の3dエロ-dong-hua-oreno3d-biao-qian-sou-suo",
        source:[ "/tags/:tagid" ],
        target:(params, url) => {
                    const searchParams = new URL(url).searchParams;
      ...
      { title:"原作搜索",
        docs:"https://rssdocs.quickso.cn/anime.html#an-の3dエロ-dong-hua-oreno3d-yuan-zuo-sou-suo",
  ...
  "oschina.net":{ _name:"开源中国",
    ".":[ { title:"资讯",
        docs:"https://rssdocs.quickso.cn/programming.html#kai-yuan-zhong-guo",
        source:[ "/news/:category" ],
  ...
  "oup.com":{ _name:"Oxford University Press",
    academic:[ { title:"期刊",
        docs:"https://rssdocs.quickso.cn/journal.html#oxford-university-press",
        source:[ "/",
          "/:name/issue" ],
        target:"/oup/journals/:name" } ] },
  "outage.report":{ _name:"Outage.Report",
    ".":[ { title:"Report",
        docs:"https://rssdocs.quickso.cn/forecast.html#outage-report",
        source:[ "/" ],
        target:(params, url) => `/outagereport/${new URL(url).toString().split('/').pop()}` } ] },
  "panewslab.com":{ _name:"PANews",
    ".":[ { title:"深度",
        docs:"https://rssdocs.quickso.cn/new-media.html#panews-shen-du",
        source:"/",
        target:"/panewslab/:category?" },
      { title:"快讯",
        docs:"https://rssdocs.quickso.cn/new-media.html#panews-kuai-xun",
        source:"/",
        target:"/panewslab/news" },
      { title:"专栏",
        docs:"https://rssdocs.quickso.cn/new-media.html#panews-zhuan-lan",
        source:"/",
        target:"/panewslab/author/:id" },
      { title:"专题",
        docs:"https://rssdocs.quickso.cn/new-media.html#panews-zhuan-ti",
        source:"/",
        target:"/panewslab/topic/:id" } ] },
  "penguinrandomhouse.com":{ _name:"Penguin Random House",
    ".":[ { title:"Penguin Random House Book Lists",
        docs:"https://rssdocs.quickso.cn/reading.html#penguin-random-house",
  ...
  "people.com.cn":{ _name:"人民网",
    ".":[ { title:"通用",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#ren-min-wang-tong-yong",
        source:"/",
        target:"/people/:site?/:category?" } ],
    liuyan:[ { title:"领导留言板",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#ren-min-wang-ling-dao-liu-yan-ban",
        source:"/",
        target:"/people/liuyan/:id/:state?" } ] },
  "peopo.org":{ _name:"PeoPo 公民新聞",
    ".":[ { title:"新聞分類",
        docs:"https://rssdocs.quickso.cn/new-media.html#peopo-gong-min-xin-wen",
        source:"/topic/:topicId",
        target:"/peopo/topic/:topicId" } ] },
  "pianyuan.org":{ _name:"片源网",
    ".":[ { title:"电影和剧集",
        docs:"https://rssdocs.quickso.cn/multimedia.html#pian-yuan",
        source:"/",
        target:"/pianyuan/index" } ] },
  "picuki.com":{ _name:"Picuki",
    www:[ { title:"用户",
        docs:"https://rssdocs.quickso.cn/social-media.html#picuki-yong-hu",
        source:"/profile/:id",
        target:"/picuki/profile/:id" } ] },
  "pincong.rocks":{ _name:"品葱",
    ".":[ { title:"发现",
        docs:"https://rssdocs.quickso.cn/bbs.html#pin-cong",
        source:"/",
        target:(_params, url) => {
                    const sortMap = {
                        'sort_type-new': 'new',
  ...
  "pixiv.net":{ _name:"Pixiv",
    www:[ { title:"用户收藏",
        docs:"https://rssdocs.quickso.cn/social-media.html#pixiv",
  ...
  "pku.edu.cn":{ _name:"北京大学",
    admission:[ { title:"硕士招生",
        docs:"https://rssdocs.quickso.cn/university.html#bei-jing-da-xue",
    ...
    hr:[ { title:"人事处",
        docs:"https://rssdocs.quickso.cn/university.html#bei-jing-da-xue-ren-shi-chu",
        source:[ "/" ],
  ...
  "playno1.com":{ _name:"PLAYNO.1玩樂達人",
    stno1:[ { title:"情趣",
        docs:"https://rssdocs.quickso.cn/bbs.html#playno-1-wan-le-da-ren",
        source:[ "/stno1/:catid/" ],
  ...
  "plurk.com":{ _name:"Plurk",
    ".":[ { title:"話題",
        docs:"https://rssdocs.quickso.cn/social-media.html#plurk",
        source:[ "/topic/:topic" ],
  ...
  "pmthinking.com":{ _name:"产品沉思录",
    ".":[ { title:"首页",
        docs:"https://rssdocs.quickso.cn/new-media.html#chan-pin-chen-si-lu-shou-ye",
        source:[ "/" ],
        target:"/pmthinking" } ] },
  "polkadot.network":{ _name:"Polkadot",
    ".":[ { title:"Blog",
        docs:"https://rssdocs.quickso.cn/blog.html#polkadot",
        source:[ "/",
          "/blog/",
          "/blog/*" ],
  ...
  "polkaworld.org":{ _name:"PolkaWorld",
    www:[ { title:"最新资讯",
        docs:"https://rssdocs.quickso.cn/blog.html#polkaworld",
        source:[ "/",
          "/articles/:name" ],
        target:"/polkaworld/newest" } ] },
  "postman.com":{ _name:"Postman",
    ".":[ { title:"Release Notes",
        docs:"https://rssdocs.quickso.cn/program-update.html#postman-release-notes",
        source:[ "/downloads/release-notes",
          "/" ],
        target:"/postman/release-notes" } ] },
  "prestige-av.com":{ _name:"Prestige 蚊香社",
    ".":[ { title:"系列作品",
        docs:"https://rssdocs.quickso.cn/multimedia.html#prestige-wen-xiang-she",
  ...
  "producthunt.com":{ _name:"Product Hunt",
    www:[ { title:"Today Popular",
        docs:"https://rssdocs.quickso.cn/other.html#product-hunt",
        source:[ "/" ],
        target:"/producthunt/today" } ] },
  "pts.org.tw":{ _name:"公視新聞網 PNN",
    news:[ { title:"即時新聞",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#gong-shi-xin-wen-wang-ji-shi-xin-wen",
        source:[ "/dailynews",
          "/" ],
        target:"/pts/dailynews" },
      { title:"專題策展",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#gong-shi-xin-wen-wang-zhuan-ti-ce-zhan",
        source:[ "/curations",
          "/" ],
        target:"/pts/curations" },
      { title:"整理報導",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#gong-shi-xin-wen-wang-zheng-li-bao-dao",
        source:[ "/live/:id",
          "/" ],
        target:"/pts/live/:id" },
      { title:"觀點",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#gong-shi-xin-wen-wang-guan-dian",
        source:[ "/opinion",
          "/" ],
        target:"/pts/opinion" },
      { title:"數位敘事",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#gong-shi-xin-wen-wang-shu-wei-xu-shi",
        source:[ "/projects",
          "/" ],
        target:"/pts/projects" },
      { title:"深度報導",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#gong-shi-xin-wen-wang-shen-du-bao-dao",
        source:[ "/report",
          "/" ],
        target:"/pts/report" },
      { title:"分類",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#gong-shi-xin-wen-wang-fen-lei",
        source:[ "/category/:id",
          "/" ],
        target:"/pts/category/:id" },
      { title:"標籤",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#gong-shi-xin-wen-wang-biao-qian",
        source:[ "/tag/:id",
          "/" ],
        target:"/pts/tag/:id" } ] },
  "pubmed.ncbi.nlm.nih.gov":{ _name:"PubMed",
    ".":[ { title:"Trending articles",
        docs:"https://rssdocs.quickso.cn/journal.html#pubmed-trending-articles",
        source:[ "/trending",
          "/" ],
  ...
  "chiark.greenend.org.uk":{ _name:"PuTTY",
    www:[ { title:"Change Log",
        docs:"https://rssdocs.quickso.cn/program-update.html#putty-change-log",
        source:[ "/~sgtatham/putty/changes.html",
          "/" ],
        target:"/putty/changes" } ] },
  "qbittorrent.org":{ _name:"qBittorrent",
    ".":[ { title:"News",
        docs:"https://rssdocs.quickso.cn/program-update.html#qbittorrent",
        source:[ "/news.php",
          "/" ],
        target:"/qbittorrent/news" } ] },
  "qianzhan.com":{ _name:"前瞻网",
    ".":[ { title:"文章列表",
        docs:"https://rssdocs.quickso.cn/finance.html#qian-zhan-wang",
        source:[ "/analyst",
          "/analyst/list/:html" ],
        target:(params) => {
                    if (params.html) {
  ...
  "qidian.com":{ _name:"起点",
    book:[ { title:"章节",
        docs:"https://rssdocs.quickso.cn/reading.html#qi-dian",
        source:"/info/:id",
  ...
  "qidiantu.com":{ _name:"起点图",
    ".":[ { title:"首订",
        docs:"https://rssdocs.quickso.cn/reading.html#qi-dian-tu-shou-ding",
        source:[ "/shouding",
          "/" ],
        target:"/qidiantu/shouding" },
      { title:"榜单",
        docs:"https://rssdocs.quickso.cn/reading.html#qi-dian-tu-bang-dan",
        source:[ "/bang/:category/:type",
          "/" ],
        target:"/qidiantu/:category?/:type?/:is_history?" } ] },
  "qingting.fm":{ _name:"蜻蜓 FM",
    ".":[ { title:"专辑",
        docs:"https://rssdocs.quickso.cn/multimedia.html#qing-ting-fm",
        source:"/channels/:id",
  ...
  "qm120.com":{ _name:"全民健康网",
    ".":[ { title:"新闻",
        docs:"https://rssdocs.quickso.cn/new-media.html#quan-min-jian-kang-wang-xin-wen",
        source:[ "/" ],
        target:"/qm120/news/:category?" } ] },
  "qq.com":{ _name:"腾讯",
    egame:[ { title:"企鹅电竞直播间",
        docs:"https://rssdocs.quickso.cn/live.html#qi-e-dian-jing-zhi-bo-jian-kai-bo",
        source:"/:id",
        target:(params) => {
    ...
    "mp.weixin":[ { title:"微信公众号栏目",
        docs:"https://rssdocs.quickso.cn/new-media.html#gong-zhong-hao-lan-mu-fei-tui-song-li-shi-xiao-xi",
        source:"/mp/homepage",
      ...
      { title:"微信公众号话题",
        docs:"https://rssdocs.quickso.cn/new-media.html#wei-xin-gong-zhong-hao-wen-zhang-hua-ti-tag",
    ...
    pvp:[ { title:"王者荣耀 - 新闻中心",
        docs:"https://rssdocs.quickso.cn/game.html#wang-zhe-rong-yao",
        source:[ "/web201706/*",
          "/" ],
        target:"/tencent/pvp/newsindex/all" } ],
    v:[ { title:"视频 - 播放列表",
        docs:"https://rssdocs.quickso.cn/multimedia.html#teng-xun-shi-pin",
        source:"/x/cover/:id",
        target:(params) => {
    ...
    "wiki.connect":[ { title:"QQ 互联 SDK 更新日志",
        docs:"https://rssdocs.quickso.cn/program-update.html#qq-hu-lian-sdk",
        source:"/",
        target:(_params, url) => `/tencent/qq/sdk/changelog/${new URL(url).pathname === '/ios_sdk历史变更' ? 'iOS' : 'Android'}` } ] },
  "qq88.info":{ _name:"秋爸日字",
    ".":[ { title:"分类",
        docs:"https://rssdocs.quickso.cn/multimedia.html#qiu-ba-ri-zi",
        source:"/",
  ...
  "getquicker.net":{ _name:"Quicker",
    ".":[ { title:"动作分享",
        docs:"https://rssdocs.quickso.cn/programming.html#quicker-dong-zuo-fen-xiang",
        source:[ "/Share/:category",
          "/" ],
        target:"/quicker/share/:category?" },
      { title:"讨论区",
        docs:"https://rssdocs.quickso.cn/programming.html#quicker-tao-lun-qu",
        source:[ "/QA",
          "/" ],
        target:(params, url) => `/quicker/qa/${new URL(url).searchParams.get('category') ?? ''}/${new URL(url).searchParams.get('state') ?? ''}` },
      { title:"用户动作更新",
        docs:"https://rssdocs.quickso.cn/programming.html#quicker-yong-hu-dong-zuo-geng-xin",
        source:[ "/QA",
          "/" ],
        target:(params, url) => `/quicker/qa/${new URL(url).searchParams.get('category') ?? ''}/${new URL(url).searchParams.get('state') ?? ''}` },
      { title:"版本更新",
        docs:"https://rssdocs.quickso.cn/programming.html#quicker-ban-ben-geng-xin",
        source:[ "/Help/Versions",
          "/" ],
        target:"/quicker/versions" } ] },
  "radio.cn":{ _name:"云听",
    ".":[ { title:"专辑",
        docs:"https://rssdocs.quickso.cn/multimedia.html#yun-ting-zhuan-ji",
        source:[ "/pc-portal/sanji/detail.html",
          "/share/albumDetail",
          "/" ],
        target:(params, url) => `/radio/album/${new URL(url).searchParams.get('columnId')}` },
      { title:"节目",
        docs:"https://rssdocs.quickso.cn/multimedia.html#yun-ting-jie-mu",
        source:[ "/pc-portal/sanji/detail.html",
          "/share/albumDetail",
          "/" ],
        target:(params, url) => `/radio/${new URL(url).searchParams.get('columnId')}` },
      { title:"直播",
        docs:"https://rssdocs.quickso.cn/multimedia.html#yun-ting-zhi-bo",
  ...
  "ici.radio-canada.ca":{ _name:"Radio Canada",
    ".":[ { title:"Latest News",
        docs:"https://rssdocs.quickso.cn/new-media.html#jia-na-da-guo-ji-guang-bo-dian-tai-zui-xin-xiao-xi",
        source:[ "/rci/:lang",
          "/" ],
        target:"/radio-canada/latest/:language?" } ] },
  "rarehistoricalphotos.com":{ _name:"Rare Historical Photos",
    ".":[ { title:"Home",
        docs:"https://rssdocs.quickso.cn/en/picture.html#rare-historical-photos",
        source:[ "/" ],
        target:"/rarehistoricalphotos" } ] },
  "readhub.cn":{ _name:"Readhub",
    ".":[ { title:"分类",
        docs:"https://rssdocs.quickso.cn/new-media.html#readhub",
        source:[ "/",
          "/:category" ],
        target:(params) => `/readhub/${params.category ? params.category : ''}` } ] },
  "remnote.com":{ _name:"RemNote",
    ".":[ { title:"Changelog",
        docs:"https://rssdocs.quickso.cn/program-update.html#remnote",
        source:[ "/changelog",
          "/" ],
        target:"/remnote/changelog" } ] },
  "reuters.com":{ _name:"路透社",
    ".":[ { title:"分类/话题/作者",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#lu-tou-she",
  ...
  "rfa.org":{ _name:"自由亚洲电台",
    ".":[ { title:"新闻",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#zi-you-ya-zhou-dian-tai",
        source:"/:language/:channel/:subChannel",
        target:"/rfa/:language/:channel/:subChannel" } ] },
  "rfi.fr":{ _name:"法国国际广播电台",
    ".":[ { title:"滚动新闻",
        docs:"https://rssdocs.quickso.cn/multimedia.html#fa-guo-guo-ji-guang-bo-dian-tai-gun-dong-xin-wen",
        source:[ "/" ],
        target:"/rfi/news" } ] },
  "rsshub.app":{ _name:"RSSHub",
    docs:[ { title:"有新路由啦",
        docs:"https://rssdocs.quickso.cn/program-update.html#rsshub",
        source:[ "",
          "/*tpath" ],
  ...
  "ruancan.com":{ _name:"软餐",
    ".":[ { title:"首页",
        docs:"https://rssdocs.quickso.cn/new-media.html#ruan-can-shou-ye",
        source:[ "/" ],
        target:"/ruancan" },
      { title:"分类",
        docs:"https://rssdocs.quickso.cn/new-media.html#ruan-can-fen-lei",
        source:[ "/sort/:sort",
          "/" ],
        target:"/ruancan/sort/:sort" },
      { title:"标签",
        docs:"https://rssdocs.quickso.cn/new-media.html#ruan-can-biao-qian",
        source:[ "/tag/:tag",
          "/" ],
        target:"/ruancan/tag/:tag" } ] },
  "ruc.edu.cn":{ _name:"中国人民大学",
    hr:[ { title:"人事处",
        docs:"https://rssdocs.quickso.cn/university.html#zhong-guo-ren-min-da-xue-ren-shi-chu",
        source:[ "/" ],
        target:"/ruc/hr/:category?" } ] },
  "rustcc.cn":{ _name:"Rust语言中文社区",
    ".":[ { title:"招聘",
        docs:"https://rssdocs.quickso.cn/programming.html#rust-yu-yan-zhong-wen-she-qu",
        source:[ "/" ],
        target:"/rustcc/jobs" } ] },
  "sakurazaka46.com":{ _name:"櫻坂46",
    ".":[ { title:"公式ブログ",
        docs:"https://rssdocs.quickso.cn/new-media.html#ban-dao-xi-lie-guan-wang-zi-xun-ying-ban-46-bo-ke",
        source:[ "/s/s46/diary/blog/list",
          "/" ],
        target:(params, url) => `/sakurazaka46/blog/${new URL(url).searchParams.get('ct')}` },
      { title:"ニュース",
        docs:"https://rssdocs.quickso.cn/new-media.html#ban-dao-xi-lie-guan-wang-zi-xun-ying-ban-46-xin-wen",
        source:[ "/s/s46/news/list",
          "/" ],
        target:"/sakurazaka46/news" } ] },
  "samsung.com":{ _name:"Samsung",
    research:[ { title:"Research Blog",
        docs:"https://rssdocs.quickso.cn/new-media.html#samsung-research-blog",
        source:[ "/blog",
          "/" ],
        target:"/samsung/research/blog" } ] },
  "saraba1st.com":{ _name:"Saraba1st",
    bbs:[ { title:"论坛",
        docs:"https://rssdocs.quickso.cn/bbs.html#saraba1st",
        source:"/2b/:id",
        target:(params) => {
                    let id = params.id;
                    // For Digest
  ...
  "science.org":{ _name:"Science Magazine",
    ".":[ { title:"本期刊物",
        docs:"https://rssdocs.quickso.cn/journal.html#science-xi-lie",
        source:[ "/journal/:journal",
          "/toc/:journal/current" ],
  ...
  "sciencenet.cn":{ _name:"科学网",
    blog:[ { title:"精选博客",
        docs:"https://rssdocs.quickso.cn/new-media.html#ke-xue-wang-jing-xuan-bo-ke",
        source:[ "/blog.php",
          "/" ],
  ...
  "scitation.org":{ _name:"scitation",
    ".":[ { title:"journal",
        docs:"https://rssdocs.quickso.cn/journal.html#scitation",
  ...
  "scmp.com":{ _name:"South China Morning Post",
    ".":[ { title:"News",
        docs:"https://rssdocs.quickso.cn/en/traditional-media.html#south-china-morning-post",
        source:[ "/rss/:category_id/feed" ],
        target:"/scmp/:category_id" } ] },
  "sctv.com":{ _name:"四川广播电视台",
    ".":[ { title:"电视回放",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#si-chuan-guang-bo-dian-shi-tai-dian-shi-hui-fang",
        source:[ "/column/list",
          "/column/detail",
          "/" ],
  ...
  "scvtc.edu.cn":{ _name:"四川职业技术学院",
    ".":[ { title:"学院公告",
        docs:"https://rssdocs.quickso.cn/university.html#si-chuan-zhi-ye-ji-shu-xue-yuan",
        source:[ "/ggfw1/xygg.htm",
          "/" ],
        target:"/scvtc/xygg" } ] },
  "sdu.edu.cn":{ _name:"山东大学",
    "xinwen.wh":[ { title:"(威海)新闻网|校园要闻",
        docs:"https://rssdocs.quickso.cn/university.html#shan-dong-da-xue-wei-hai",
        source:[ "/*path",
          "/" ],
    ...
    "www.cmse":[ { title:"材料科学与工程学院通知",
        docs:"https://rssdocs.quickso.cn/university.html#shan-dong-da-xue",
        source:[ "/*path",
          "/" ],
        target:(params) => {
                    let type;
  ...
  "secrss.com":{ _name:"安全内参",
    ".":[ { title:"分类",
        docs:"https://rssdocs.quickso.cn/programming.html#an-quan-nei-can",
        source:[ "/articles",
          "/" ],
  ...
  "seekingalpha.com":{ _name:"Seeking Alpha",
    ".":[ { title:"Summary",
        docs:"https://rssdocs.quickso.cn/en/finance.html#seeking-alpha",
  ...
  "segmentfault.com":{ _name:"SegmentFault",
    ".":[ { title:"频道",
        docs:"https://rssdocs.quickso.cn/programming.html#segmentfault",
        source:[ "/channel/:name" ],
  ...
  "sensortower.com":{ _name:"Sensor Tower",
    ".":[ { title:"Blog",
        docs:"https://rssdocs.quickso.cn/new-media.html#sensor-tower-blog",
        source:[ "/blog",
          "/zh-CN/blog",
          "/ja/blog",
          "/ko/blog",
  ...
  "shmeea.edu.cn":{ _name:"上海市教育考试院",
    www:[ { title:"消息速递",
        docs:"https://rssdocs.quickso.cn/other.html#shang-hai-shi-jiao-yu-kao-shi-yuan",
        source:[ "/" ],
        target:"/shmeea" },
      { title:"自学考试通知公告",
        docs:"https://rssdocs.quickso.cn/other.html#shang-hai-shi-jiao-yu-kao-shi-yuan",
  ...
  "shmtu.edu.cn":{ _name:"上海海事大学",
    jwc:[ { title:"教务信息",
        docs:"https://rssdocs.quickso.cn/university.html#shang-hai-dian-li-da-xue",
        source:[ "/:type" ],
  ...
  "shopback.com.tw":{ _name:"ShopBack",
    ".":[ { title:"Store",
        docs:"https://rssdocs.quickso.cn/shopping.html#shopback-store",
        source:[ "/:category",
          "/" ],
        target:"/shopback/:store" } ] },
  "shuiguopai.com":{ _name:"水果派",
    ".":[ { title:"首页",
        docs:"https://rssdocs.quickso.cn/new-media.html#shui-guo-pai-shou-ye",
        source:[ "/" ],
        target:"/shuiguopai" } ] },
  "sicau.edu.cn":{ _name:"",
    dky:[ { title:"招生就业",
        docs:"https://rssdocs.quickso.cn/university.html#si-chuan-nong-ye-da-xue-zhao-sheng-jiu-ye",
        source:[ "/" ],
        target:"/sicau/zsjy/:category?" },
      { title:"动物科技学院",
        docs:"https://rssdocs.quickso.cn/university.html#si-chuan-nong-ye-da-xue",
        source:[ "/" ],
  ...
  "blog.simpleinfo.cc":{ _name:"簡訊設計",
    ".":[ { title:"志祺七七",
        docs:"https://rssdocs.quickso.cn/new-media.html#jian-xun-she-ji",
        source:"/shasha77",
  ...
  "sinchew.com.my":{ _name:"星洲网",
    ".":[ { title:"首页",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#xing-zhou-wang-shou-ye",
        source:[ "/" ],
        target:"/sinchew" },
      { title:"最新",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#xing-zhou-wang-zui-xin",
        source:[ "/latest",
          "/" ],
        target:"/sinchew/latest" },
      { title:"分类",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#xing-zhou-wang-fen-lei",
        source:[ "/category/:category",
          "/" ],
        target:(params, url) => `/sinchew/category/${new URL(url).toString().match(/\/category\/(.*)$/)[1]}` } ] },
  "sis001.com":{ _name:"第一会所",
    ".":[ { title:"子版块",
        docs:"https://rssdocs.quickso.cn/bbs.html#di-yi-hui-suo",
        source:[ "/forum/:id" ],
        target:(params) => `/sis001/forum/${params.id.replace('forum-', '').replace('-1.html', '')}` } ] },
  "slowmist.com":{ _name:"慢雾科技 SLOWMIST",
    ".":[ { title:"动态",
        docs:"https://rssdocs.quickso.cn/new-media.html#man-wu-ke-ji",
        source:[ "/zh/news.html" ],
        target:"/slowmist/:type?" } ] },
  "smzdm.com":{ _name:"什么值得买",
    post:[ { title:"好文",
        docs:"https://rssdocs.quickso.cn/shopping.html#shen-me-zhi-de-mai",
        source:"/:day",
  ...
  "sobooks.net":{ _name:"SoBooks",
    ".":[ { title:"分类",
        docs:"https://rssdocs.quickso.cn/reading.html#sobooks",
        source:[ "/:category" ],
  ...
  "sohu.com":{ _name:"搜狐",
    ".":[ { title:"搜狐号",
        docs:"https://rssdocs.quickso.cn/new-media.html#sou-hu-hao",
        source:[ "/a/:id" ],
        target:(params) => `/sohu/mp/${params.id.split('_')[1]}` } ] },
  "solidot.org":{ _name:"Solidot",
    www:[ { title:"最新消息",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#solidot",
        source:[ "/" ],
        target:"/solidot/www" } ],
    linux:[ { title:"最新消息",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#solidot",
  ...
  "soundofhope.org":{ _name:"希望之声",
    ".":[ { title:"频道",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#xi-wang-zhi-sheng",
        source:[ "/:channel/:id" ],
        target:"/soundofhope/:channel/:id" } ] },
  "spotify.com":{ _name:"Spotify",
    open:[ { title:"播放列表",
        docs:"https://rssdocs.quickso.cn/multimedia.html#spotify",
        source:[ "/playlist/:id" ],
  ...
  "springer.com":{ _name:"Springer",
    www:[ { title:"latest",
        docs:"https://rssdocs.quickso.cn/journal.html#Springer",
        source:"/journal/:journal/*",
        target:"/springer/journal/:journal" } ] },
  "sputniknews.cn":{ _name:"俄罗斯卫星通讯社",
    ".":[ { title:"分类",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#e-luo-si-wei-xing-tong-xun-she-fen-lei",
        source:[ "/:category",
          "/" ],
        target:"/sputniknews/:category/:language" } ] },
  "sse.com.cn":{ _name:"上海证券交易所",
    bond:[ { title:"可转换公司债券公告",
        docs:"https://rssdocs.quickso.cn/finance.html#shang-hai-zheng-quan-jiao-yi-suo",
  ...
  "ssm.gov.mo":{ _name:"澳门卫生局",
    www:[ { title:"最新消息",
        docs:"https://rssdocs.quickso.cn/government.html#ao-men-wei-sheng-ju-zui-xin-xiao-xi",
        source:[ "/",
          "/portal" ],
        target:"/ssm/news" } ] },
  "sspai.com":{ _name:"少数派",
    ".":[ { title:"首页",
        docs:"https://rssdocs.quickso.cn/new-media.html#shao-shu-pai-sspai",
        source:"/index",
        target:"/sspai/index" },
      { title:"最新上架付费专栏",
        docs:"https://rssdocs.quickso.cn/new-media.html#shao-shu-pai-sspai",
  ...
  "startuplatte.com":{ _name:"創新拿鐵",
    ".":[ { title:"分类",
        docs:"https://rssdocs.quickso.cn/new-media.html#chuang-xin-na-tie-fen-lei",
        source:[ "/category/:category",
          "/" ],
        target:"/startuplatte/:category?" } ] },
  "stcn.com":{ _name:"证券时报网",
    ".":[ { title:"要闻",
        docs:"https://rssdocs.quickso.cn/finance.html#zheng-quan-shi-bao-wang-yao-wen",
        source:[ "/xw/:id",
          "/gd",
          "/" ],
        target:(params, url) => `/stcn${new URL(url).pathname}` },
      { title:"快讯",
        docs:"https://rssdocs.quickso.cn/finance.html#zheng-quan-shi-bao-wang-kuai-xun",
        source:[ "/kuaixun/:id",
          "/kuaixun",
          "/" ],
        target:(params, url) => `/stcn${new URL(url).pathname}` },
      { title:"股市",
        docs:"https://rssdocs.quickso.cn/finance.html#zheng-quan-shi-bao-wang-gu-shi",
        source:[ "/stock/:id",
          "/stock",
          "/" ],
        target:(params, url) => `/stcn${new URL(url).pathname}` },
      { title:"数据",
        docs:"https://rssdocs.quickso.cn/finance.html#zheng-quan-shi-bao-wang-shu-ju",
        source:[ "/data/:id",
          "/data",
          "/" ],
        target:(params, url) => `/stcn${new URL(url).pathname}` } ] },
  "stheadline.com":{ _name:"星島日報",
    std:[ { title:"即時",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#xing-dao-ri-bao",
        source:[ "/realtime/*category" ],
        target:(params) => `/stdheadline/std/realtime/${params.category}` } ] },
  "storm.mg":{ _name:"風傳媒",
    ".":[ { title:"分类",
        docs:"https://rssdocs.quickso.cn/new-media.html#feng-chuan-mei",
        source:[ "/:category/:id" ],
        target:"/storm/:category?/:id?" } ] },
  "studygolang.com":{ _name:"Go 语言中文网",
    ".":[ { title:"招聘",
        docs:"https://rssdocs.quickso.cn/programming.html#go-yu-yan-zhong-wen-wang",
        source:[ "/" ],
        target:"/studygolang/jobs" } ] },
  "subhd.tv":{ _name:"Sub HD",
    ".":[ { title:"字幕",
        docs:"https://rssdocs.quickso.cn/multimedia.html#subhd-zi-mu",
        source:[ "/sub/:category",
          "/" ],
        target:"/subhd/sub/:category?" },
      { title:"字幕组",
        docs:"https://rssdocs.quickso.cn/multimedia.html#subhd-zi-mu-zu",
        source:[ "/zu/:category",
          "/" ],
        target:"/subhd/zu/:category?" } ] },
  "supchina.com":{ _name:"SupChina",
    ".":[ { title:"Feed",
        docs:"https://rssdocs.quickso.cn/new-media.html#supchina-feed",
        source:[ "/feed",
          "/" ],
        target:"/supchina" },
      { title:"Podcasts",
        docs:"https://rssdocs.quickso.cn/new-media.html#supchina-podcasts",
        source:[ "/podcasts",
          "/" ],
        target:"/supchina/podcasts" } ] },
  "swissinfo.ch":{ _name:"swissinfo",
    ".":[ { title:"Category",
        docs:"https://rssdocs.quickso.cn/new-media.html#swissinfo-category",
        source:[ "/:language/:category",
          "/" ],
        target:"/swissinfo/:language?/:category?" } ] },
  "swpu.edu.cn":{ _name:"西南石油大学",
    ".":[ { title:"办公网",
        docs:"https://rssdocs.quickso.cn/university.html#xi-nan-shi-you-da-xue",
        source:[ "/" ],
        target:"" },
      { title:"教务处",
        docs:"https://rssdocs.quickso.cn/university.html#xi-nan-shi-you-da-xue",
  ...
  "syosetu.com":{ _name:"syosetu",
    ncode:[ { title:"章节更新",
        docs:"https://rssdocs.quickso.cn/reading.html#syosetu-zhang-jie-geng-xin",
        source:[ "/:id" ],
  ...
  "sysu.edu.cn":{ _name:"中山大学",
    cse:[ { title:"计算机学院（软件学院）",
        docs:"https://rssdocs.quickso.cn/universities.html#zhong-shan-da-xue-ji-suan-ji-xue-yuan",
        source:[ "/" ],
        target:"/sysu/cse" } ] },
  "szse.cn":{ _name:"深圳证券交易所",
    ".":[ { title:"上市公告 - 可转换债券",
        docs:"https://rssdocs.quickso.cn/finance.html#shen-zhen-zheng-quan-jiao-yi-suo-shang-shi-gong-gao-ke-zhu-huan-zheng-zhi-quan",
        source:[ "/disclosure/notice/company/index.html",
          "/" ],
        target:"/szse/notice" },
      { title:"问询函件",
        docs:"https://rssdocs.quickso.cn/finance.html#shen-zhen-zheng-quan-jiao-yi-suo-wen-xun-huan-jian",
        source:[ "/disclosure/supervision/inquire/index.html",
          "/" ],
        target:"/szse/inquire" },
      { title:"最新规则",
        docs:"https://rssdocs.quickso.cn/finance.html#shen-zhen-zheng-quan-jiao-yi-suo-zui-xin-gui-ze",
        source:[ "/lawrules/rule/new",
          "/" ],
        target:"/szse/rule" } ],
    listing:[ { title:"创业板项目动态",
        docs:"https://rssdocs.quickso.cn/finance.html#shen-zhen-zheng-quan-jiao-yi-suo-chuang-ye-ban-xiang-mu-dong-tai",
  ...
  "taiwannews.com.tw":{ _name:"台灣英文新聞",
    ".":[ { title:"最新熱門消息",
        docs:"httsp://rssdocs.quickso.cn/traditional-media.html#tai-wan-ying-wen-xin-wen",
        source:"/:lang/index",
        target:"/taiwannews/hot/:lang" } ] },
  "taobao.com":{ _name:"淘宝",
    izhongchou:[ { title:"淘宝众筹全部",
        docs:"https://rssdocs.quickso.cn/shopping.html#tao-bao-zhong-chou-zhong-chou-xiang-mu",
        source:[ "/list.htm" ],
        target:(params, url) => {
  ...
  "taoguba.com.cn":{ _name:"淘股吧",
    ".":[ { title:"淘股论坛",
        docs:"https://rssdocs.quickso.cn/finance.html#tao-gu-ba-tao-gu-lun-tan",
        source:[ "/:category",
          "/" ],
        target:"/taoguba/:category" },
      { title:"用户博客",
        docs:"https://rssdocs.quickso.cn/finance.html#tao-gu-ba-yong-hu-bo-ke",
        source:[ "/blog/:id",
          "/" ],
        target:"/taoguba/blog/:id" } ] },
  "taptap.com":{ _name:"TapTap",
    ".":[ { title:"游戏论坛",
        docs:"https://rssdocs.quickso.cn/game.html#taptap",
        source:[ "/app/:id/topic",
          "/app/:id" ],
  ...
  "techflowpost.com":{ _name:"深潮TechFlow",
    ".":[ { title:"首页",
        docs:"https://rssdocs.quickso.cn/new-media.html#shen-chao-techflow-shou-ye",
        source:[ "/" ],
        target:"/techflowpost" },
      { title:"快讯",
        docs:"https://rssdocs.quickso.cn/new-media.html#shen-chao-techflow-kuai-xun",
        source:[ "/express" ],
        target:"/techflowpost/express" } ] },
  "t.me":{ _name:"Telegram",
    ".":[ { title:"频道",
        docs:"https://rssdocs.quickso.cn/social-media.html#telegram",
        source:"/:username",
        target:(params, url, document) => {
  ...
  "telegram.org":{ _name:"Telegram",
    ".":[ { title:"Telegram Blog",
        docs:"https://rssdocs.quickso.cn/social-media.html#telegram-telegram-blog",
        source:"/blog",
        target:"/telegram/blog" } ] },
  "tencent.com":{ _name:"腾讯云",
    ".":[ { title:"云+社区专栏",
        docs:"https://rssdocs.quickso.cn/programming.html#teng-xun-yun-yun-she-qu-zhuan-lan",
  ...
  "tesla.cn":{ _name:"特斯拉中国",
    ".":[ { title:"价格",
        docs:"https://rssdocs.quickso.cn/shopping.html#te-si-la-zhong-guo",
        source:[ "/model3/design",
          "/" ],
        target:"/tesla/price" } ] },
  "thecatcity.com":{ _name:"貓奴日常",
    ".":[ { title:"貓物分享｜流行小物、貓咪用品",
        docs:"https://rssdocs.quickso.cn/new-media.html#mao-nu-ri-chang",
  ...
  "thecover.cn":{ _name:"封面新闻",
    ".":[ { title:"频道",
        docs:"https://rssdocs.quickso.cn/new-media.html#the-cover",
        source:[ "/:id",
          "/" ],
        target:(params) => `/thecover/channel/${params.id.replace('channel_', '')}` } ] },
  "theinitium.com":{ _name:"端传媒",
    ".":[ { title:"专题・栏目",
        docs:"https://rssdocs.quickso.cn/new-media.html#duan-chuan-mei",
        source:"/channel/:type",
  ...
  "thenewslens.com":{ _name:"The News Lens 關鍵評論",
    ".":[ { title:"最新",
        docs:"https://rssdocs.quickso.cn/new-media.html#the-news-lens-guan-jian-ping-lun",
  ...
  "thepaper.cn":{ _name:"澎湃新闻",
    ".":[ { title:"首页头条",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#peng-pai-xin-wen-shou-ye-tou-tiao",
        source:[ "/" ],
        target:"/thepaper/featured" },
      { title:"频道",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#peng-pai-xin-wen-pin-dao",
        source:[ "/" ],
        target:(params, url) => `/thepaper/channel/${new URL(url).search(/channel_(\d+)/)}` },
      { title:"栏目",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#peng-pai-xin-wen-lie-biao",
        source:[ "/" ],
        target:(params, url) => `/thepaper/list/${new URL(url).search(/list_(\d+)/)}` },
      { title:"澎湃美数组作品集",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#peng-pai-xin-wen-peng-pai-mei-shu-zuo-pin-ji",
        source:[ "/" ],
        target:"/thepaper/839studio/:id" } ] },
  "factpaper.cn":{ _name:"澎湃新闻",
    ".":[ { title:"明查",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#peng-pai-xin-wen-ming-cha",
        source:[ "/" ],
        target:"/thepaper/factpaper/:status" } ] },
  "theverge.com":{ _name:"The Verge",
    ".":[ { title:"The Verge",
        docs:"https://rssdocs.quickso.cn/new-media.html#the-verge",
        source:[ "/:hub",
          "/" ],
        target:"/theverge/:hub?" } ] },
  "thwiki.cc":{ _name:"THBWiki",
    ".":[ { title:"日历",
        docs:"https://rssdocs.quickso.cn/#thbwiki",
        source:[ "/",
          "/日程表" ],
        target:"/thwiki/calendar" } ] },
  "tiktok.com":{ _name:"TikTok",
    ".":[ { title:"User",
        docs:"https://rssdocs.quickso.cn/en/social-media.html#tiktok",
        source:[ "/:user" ],
        target:"/tiktok/user/:user" } ] },
  "timednews.com":{ _name:"时刻新闻",
    ".":[ { title:"新闻",
        docs:"https://rssdocs.quickso.cn/new-media.html#shi-ke-xin-wen",
  ...
  "dl.gov.cn":{ _name:"停水通知",
    swj:[ { title:"大连市",
        docs:"https://rssdocs.quickso.cn/forecast.html#ting-shui-tong-zhi",
  ...
  "tisi.org":{ _name:"腾讯研究院",
    ".":[ { title:"最近更新",
        docs:"https://rssdocs.quickso.cn/new-media.html#teng-xun-yan-jiu-yuan",
        source:[ "/" ],
        target:(_params, url) => {
  ...
  "tju.edu.cn":{ _name:"天津大学",
    cic:[ { title:"智能与计算学部 - 学部新闻",
        docs:"https://rssdocs.quickso.cn/university.html#tian-jin-da-xue-zhi-neng-yu-ji-suan-xue-bu",
    ...
    news:[ { title:"新闻网 - 聚焦天大",
        docs:"https://rssdocs.quickso.cn/university.html#tian-jin-da-xue-xin-wen-wang",
        source:[ "/jjtd.htm",
          "/" ],
    ...
    oaa:[ { title:"教务处 - 新闻动态",
        docs:"https://rssdocs.quickso.cn/university.html#tian-jin-da-xue-jiao-wu-chu",
        source:[ "/xwdt.htm",
          "/" ],
        target:"/tju/oaa/news" },
      { title:"教务处 - 通知公告",
    ...
    yzb:[ { title:"研究生招生网 - 校级公告",
        docs:"https://rssdocs.quickso.cn/university.html#tian-jin-da-xue-yan-jiu-sheng-zhao-sheng-wang",
        source:[ "/xwzx/zxxx/",
          "/" ],
  ...
  "tokeninsight.com":{ _name:"TokenInsight",
    ".":[ { title:"博客",
        docs:"https://rssdocs.quickso.cn/new-media.html#tokeninsight",
        source:[ "/:lang/blogs" ],
  ...
  "topys.cn":{ _name:"TOPYS",
    ".":[ { title:"关键字",
        docs:"https://rssdocs.quickso.cn/new-media.html#topys-guan-jian-zi",
        source:[ "/search/:keyword",
          "/" ],
        target:"/topys/:keyword?" } ] },
  "tradingview.com":{ _name:"TradingView",
    ".":[ { title:"Blog",
        docs:"https://rssdocs.quickso.cn/program-update.html#tradingview-blog",
        source:[ "/blog/:language",
          "/" ],
        target:"/tradingview/blog" } ] },
  "toutiao.com":{ _name:"今日头条",
    so:[ { title:"热搜关键词聚合追踪",
        docs:"https://rssdocs.quickso.cn/social-media.html#re-sou-ju-he",
        source:[ "/search" ],
        target:(params, url) => `/trending/${new URL(url).searchParams.get('keyword')}` } ] },
  "weibo.com":{ _name:"微博",
    ".":[ { title:"博主",
        docs:"https://rssdocs.quickso.cn/social-media.html#wei-bo",
        source:[ "/u/:id",
          "/:id" ],
        target:(params, url, document) => {
  ...
  "zhihu.com":{ _name:"知乎",
    www:[ { title:"收藏夹",
        docs:"https://rssdocs.quickso.cn/social-media.html#zhi-hu",
        source:"/collection/:id",
  ...
  "tribalfootball.com":{ _name:"Tribal Football",
    ".":[ { title:"Latest News",
        docs:"https://rssdocs.quickso.cn/new-media.html#tribal-football",
        source:[ "/" ],
        target:"/tribalfootball" } ] },
  "trow.cc":{ _name:"The Ring of Wonder",
    ".":[ { title:"首页更新",
        docs:"https://rssdocs.quickso.cn/bbs.html#the-ring-of-wonder",
        source:[ "/" ],
        target:"/portal" } ] },
  "tvb.com":{ _name:"无线新闻",
    ".":[ { title:"新闻",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#wu-xian-xin-wen-xin-wen",
        source:[ "/:language/:category",
          "/" ],
        target:"/tvb/news/:category?/:language?" } ] },
  "twitter.com":{ _name:"Twitter",
    ".":[ { title:"用户时间线",
        docs:"https://rssdocs.quickso.cn/social-media.html#twitter",
        source:"/:id",
        target:(params) => {
  ...
  "twreporter.org":{ _name:"報導者",
    ".":[ { title:"最新",
        docs:"https://rssdocs.quickso.cn/new-media.html#bao-dao-zhe",
        source:[ "/" ],
  ...
  "txrjy.com":{ _name:"通信人家园",
    ".":[ { title:"论坛 频道",
        docs:"https://rssdocs.quickso.cn/bbs.html#tong-xin-ren-jia-yuan",
  ...
  "tynu.edu.cn":{ _name:"太原师范学院",
    ".":[ { title:"通知公告",
        docs:"https://rssdocs.quickso.cn/university.html#tai-yuan-shi-fan-xue-yuan",
  ...
  "u3c3.com":{ _name:"u3c3",
    ".":[ { title:"分类",
        docs:"https://rssdocs.quickso.cn/multimedia.html#u3c3-fen-lei",
        source:"/",
        target:(params, url) => {
                    const searchParams = new URL(url).searchParams;
      ...
      { title:"关键词搜索",
        docs:"https://rssdocs.quickso.cn/multimedia.html#u3c3-guan-jian-ci-sou-suo",
        source:"/",
        target:(params, url) => {
                    const searchParams = new URL(url).searchParams;
  ...
  "uber.com":{ _name:"Uber Blog",
    www:[ { title:"Engineering",
        docs:"https://rssdocs.quickso.cn/blog.html#you-bu",
        source:[ "/blog/pittsburgh/engineering" ],
        target:"/uber/blog" } ] },
  "udn.com":{ _name:"聯合新聞網",
    ".":[ { title:"即時新聞",
        docs:"https://rssdocs.quickso.cn/new-media.html#lian-he-xin-wen-wang-ji-shi-xin-wen",
        source:[ "/news/breaknews/1/:id",
          "/" ],
        target:"/udn/news/breakingnews/:id" } ],
    global:[ { title:"轉角國際 - 首頁",
        docs:"https://rssdocs.quickso.cn/new-media.html#lian-he-xin-wen-wang-zhuan-jiao-guo-ji-shou-ye",
        source:[ "/global_vision/index/:category",
          "/" ],
        target:"/udn/global/:category?" },
      { title:"轉角國際 - 標籤",
        docs:"https://rssdocs.quickso.cn/new-media.html#lian-he-xin-wen-wang-zhuan-jiao-guo-ji-biao-qian",
        source:[ "/search/tagging/1020/:tag",
          "/" ],
        target:"/udn/global/tag/:tag?" } ] },
  "uibe.edu.cn":{ _name:"对外经济贸易大学",
    hr:[ { title:"人力资源处",
        docs:"https://rssdocs.quickso.cn/university.html#dui-wai-jing-ji-mao-yi-da-xue-ren-li-zi-yuan-chu",
  ...
  "ulapia.com":{ _name:"乌拉邦 ulapia",
    www:[ { title:"今日晨报",
        docs:"https://rssdocs.quickso.cn/finance.html#wu-la-bang-pin-dao",
        source:[ "/" ],
        target:"/ulapia/reports/brokerage_news" },
      { title:"最新研报",
        docs:"https://rssdocs.quickso.cn/finance.html#wu-la-bang-zui-xin-yan-bao",
        source:[ "/" ],
  ...
  "unusualwhales.com":{ _name:"Unusual Whales",
    ".":[ { title:"News Flow",
        docs:"https://rssdocs.quickso.cn/en/finance.html#unusual-whales",
        source:[ "/news",
          "/" ],
  ...
  "usepanda.com":{ _name:"Panda",
    ".":[ { title:"Feeds",
        docs:"https://rssdocs.quickso.cn/other.html#panda" } ] },
  "ustb.edu.cn":{ _name:"北京科技大学",
    gs:[ { title:"研究生院",
        docs:"https://rssdocs.quickso.cn/university.html#bei-jing-ke-ji-da-xue",
        source:"/:type",
        target:"/ustb/yjsy/news/:type" } ] },
  "ustc.edu.cn":{ _name:"中国科学技术大学",
    ".":[ { title:"官网通知公告",
        docs:"https://rssdocs.quickso.cn/university.html#zhong-guo-ke-xue-ji-shu-da-xue",
        source:"/",
        target:"/ustc/news" } ],
  ...
  "usts.edu.cn":{ _name:"苏州科技大学",
    jwch:[ { title:"教务动态",
        docs:"https://rssdocs.quickso.cn/university.html#su-zhou-ke-ji-da-xue",
        source:[ "/jwdt.htm" ],
  ...
  "gixnetwork.org":{ _name:"University of Washington",
    ".":[ { title:"Global Innovation Exchange News",
        docs:"https://rssdocs.quickso.cn/university.html#university-of-washington",
        source:[ "/news/:category" ],
  ...
  "baden-wuerttemberg.de":{ _name:"Constitutional Court of Baden-Württemberg (Germany)",
    verfgh:[ { title:"Press releases",
        docs:"https://rssdocs.quickso.cn/en/government.html#constitutional-court-of-baden-wurttemberg-germany",
        source:[ "/de/presse-und-service/pressemitteilungen/" ],
        target:"/verfghbw/press" } ] },
  "vimeo.com":{ _name:"Vimeo",
    ".":[ { title:"User videos",
        docs:"https://rssdocs.quickso.cn/social-media.html#vimeo-yong-hu-ye-mian",
        source:"/:username/",
        target:(params, url, document) => {
      ...
      { title:"User Video Category",
        ...
        source:"/" },
      { title:"Channel",
        docs:"https://rssdocs.quickso.cn/social-media.html#vimeo-channel",
        source:[ "/channels/:channel",
          "/channels/:channel/videos",
          "/channels/:channel/videos/:sort/:format" ],
        target:"/vimeo/channel/:channel" },
      { title:"Category",
        docs:"https://rssdocs.quickso.cn/social-media.html#vimeo-category",
        source:[ "/categories/:category",
  ...
  "vlive.tv":{ _name:"V LIVE",
    ".":[ { title:"Board",
        docs:"https://rssdocs.quickso.cn/en/live.html#v-live",
        source:"/channel/:board/board/:board",
        target:"/vlive/channel/:board/board/:board" } ] },
  "vmware.com":{ _name:"VMware",
    flings:[ { title:"Flings",
        docs:"https://rssdocs.quickso.cn/program-update.html#vmware-flings",
        source:[ "/flings",
          "/" ],
        target:"/vmware/flings" } ] },
  "vom.mn":{ _name:"蒙古之声",
    ".":[ { title:"新闻",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#meng-gu-zhi-sheng",
        source:[ "/:lang",
          "/" ],
        target:"/vom/featured/:lang" } ] },
  "wallhaven.cc":{ _name:"wallhaven",
    ".":[ { title:"Latest",
        docs:"https://rssdocs.quickso.cn/picture.html#wallhaven-zhu-zhu-ti",
        source:[ "/:category",
          "/" ],
        target:(params) => {
      ...
      { title:"Search",
        docs:"https://rssdocs.quickso.cn/picture.html#wallhaven-sou-xiao-sou-shao-suo",
        source:[ "/" ],
        target:"/wallhaven/search/:filter?/:needDetails?" } ] },
  "wallpaperhub.app":{ _name:"WallpaperHub",
    ".":[ { title:"壁纸",
        docs:"https://rssdocs.quickso.cn/picture.html#wallpaperhub",
        source:[ "/wallpaperhub",
          "/" ],
        target:"/wallpaperhub" } ] },
  "wallstreetcn.com":{ _name:"华尔街见闻",
    ".":[ { title:"资讯",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#hua-er-jie-jian-wen-zi-xun",
        source:[ "/news/:category",
          "/" ],
        target:"/wallstreetcn/news/:category?" },
      { title:"实时快讯",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#hua-er-jie-jian-wen-shi-shi-kuai-xun",
        source:[ "/live/:category",
          "/" ],
        target:"/wallstreetcn/live/:category?" },
      { title:"最热文章",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#hua-er-jie-jian-wen-zui-re-wen-zhang",
        source:[ "/" ],
        target:"/wallstreetcn/hot/:period?" } ] },
  "wangqiutiyu.com":{ _name:"旺球体育",
    ".":[ { title:"直播间开播",
        docs:"https://rssdocs.quickso.cn/live.html#wang-qiu-ti-yu-zhi-bo-jian-kai-bo",
        source:[ "/anchor/:id",
          "/" ],
        target:"/wangqiutiyu/anchor/:id" } ] },
  "warthunder.com":{ _name:"War Thunder",
    ".":[ { title:"News",
        docs:"https://rssdocs.quickso.cn/game.html#war-thunder-ying-wen-news",
        source:[ "/en/news",
          "/" ],
        target:"/warthunder/news" } ] },
  "watchout.tw":{ _name:"沃草",
    ".":[ { title:"文件列表",
        docs:"https://rssdocs.quickso.cn/new-media.html#wo-cao-wen-jian-lie-biao",
        source:[ "/" ],
        target:"/watchout" } ] },
  "wdc.com":{ _name:"",
    support:[ { title:"Western Digital",
        docs:"https://rssdocs.quickso.cn/program-update.html#western-digital-download",
        source:[ "/downloads.aspx",
          "/" ],
        target:(params, url) => `/wdc/download/${new URL(url).searchParams.get('p')}` } ] },
  "web3caff.com":{ _name:"web3caff",
    ".":[ { title:"发现",
        docs:"https://rssdocs.quickso.cn/new-media.html#web3caff-fa-xian",
        source:[ "/" ],
        target:(params, url) => `/web3caff${new URL(url).toString().match(/\.com(.*)/)[1]}` } ] },
  "careerengine.us":{ _name:"微信",
    posts:[ { title:"公众号（CareerEngine 来源）",
        docs:"https://rssdocs.quickso.cn/new-media.html#wei-xin",
  ...
  "wenku8.net":{ _name:"轻小说文库",
    www:[ { title:"轻小说列表",
        docs:"https://rssdocs.quickso.cn/reading.html#qing-xiao-shuo-wen-ku-shou-ye-fen-lei",
      ...
      { title:"章节",
        docs:"https://rssdocs.quickso.cn/reading.html#qing-xiao-shuo-wen-ku-zhang-jie",
        source:[ "/book/:id" ],
        target:(params) => `/wenku8/chapter/${params.id.split('.')[0]}` },
      { title:"最新卷",
        docs:"https://rssdocs.quickso.cn/reading.html#qing-xiao-shuo-wen-ku-zui-xin-juan",
        source:[ "/book/:id" ],
        target:(params) => `/wenku8/volume/${params.id.split('.')[0]}` } ] },
  "wfu.edu.cn":{ _name:"潍坊学院",
    jwc:[ { title:"教务处通知",
        docs:"https://rssdocs.quickso.cn/university.html#wei-fang-xue-yuan",
        source:"/",
        target:"/wfu/jwc" } ],
    news:[ { title:"新闻",
        docs:"https://rssdocs.quickso.cn/university.html#wei-fang-xue-yuan",
  ...
  "whitehouse.gov":{ _name:"美国白宫办公厅",
    ".":[ { title:"简报室",
        docs:"https://rssdocs.quickso.cn/government.html#mei-guo-bai-gong-ban-gong-ting",
  ...
  "who.int":{ _name:"世界卫生组织 WHO",
    ".":[ { title:"新闻稿",
        docs:"https://rssdocs.quickso.cn/government.html#shi-jie-wei-sheng-zu-zhi-who",
        source:"/news",
        target:"/who/news" },
      { title:"媒体中心",
        docs:"https://rssdocs.quickso.cn/government.html#shi-jie-wei-sheng-zu-zhi-who",
  ...
  "whoscall.com":{ _name:"Whoscall",
    ".":[ { title:"最新文章",
        docs:"https://rssdocs.quickso.cn/blog.html#whoscall-zui-xin-wen-zhang",
        source:[ "/zh-hant/blog/articles",
          "/" ],
        target:"/whoscall" },
      { title:"分類",
        docs:"https://rssdocs.quickso.cn/blog.html#whoscall-fen-lei",
        source:[ "/zh-hant/blog/categories/:category",
          "/" ],
        target:"/whoscall/categories/:category?" },
      { title:"標籤",
        docs:"https://rssdocs.quickso.cn/blog.html#whoscall-biao-qian",
        source:[ "/zh-hant/blog/tags/:tag",
          "/" ],
        target:"/whoscall/tags/:tag?" } ] },
  "wikinews.org":{ _name:"维基新闻",
    zh:[ { title:"最新新闻",
        docs:"https://rssdocs.quickso.cn/new-media.html#wei-ji-xin-wen",
  ...
  "worldjournal.com":{ _name:"世界新聞網",
    ".":[ { title:"新聞",
        docs:"https://rssdocs.quickso.cn/new-media.html#shi-jie-xin-wen-wang",
        source:[ "/wj/*path" ],
        target:"/worldjournal/:path" } ] },
  "wp-china.com":{ _name:"中国工人出版社",
    ".":[ { title:"新闻中心",
        docs:"https://rssdocs.quickso.cn/new-media.html#zhong-guo-gong-ren-chu-ban-she",
        source:[ "/" ],
        target:"/wp-china/news" } ] },
  "wsj.com":{ _name:"华尔街日报 The Wall Street Journal (WSJ)",
    cn:[ { title:"新闻",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#hua-er-jie-ri-bao-the-wall-street-journal-wsj",
        souce:"/",
        target:"/wsj/zh-cn" } ],
    www:[ { title:"新闻",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#hua-er-jie-ri-bao-the-wall-street-journal-wsj",
  ...
  "wsyu.edu.cn":{ _name:"新闻中心",
    www:[ { title:"学校要闻",
        docs:"https://rssdocs.quickso.cn/other.html#wu-chang-shou-yi-xue-yuan",
        source:"/*",
  ...
  "wyzxwk.com":{ _name:"乌有之乡",
    ".":[ { title:"栏目",
        docs:"https://rssdocs.quickso.cn/new-media.html#wu-you-zhi-xiang-lan-mu",
        source:[ "/Article/:id",
          "/" ],
        target:"/wyzxwk/article/:id?" } ] },
  "wzu.edu.cn":{ _name:"温州大学",
    ".":[ { title:"温州大学 - 主站新闻",
        docs:"https://rssdocs.quickso.cn/university.html#wen-zhou-da-xue" } ] },
  "xaut.edu.cn":{ _name:"西安理工大学",
    index:[ { title:"学校官网",
        docs:"https://rssdocs.quickso.cn/university.html#xi-an-li-gong-da-xue" } ],
    jwc:[ { title:"教务处",
        docs:"https://rssdocs.quickso.cn/university.html#xi-an-li-gong-da-xue" } ],
    rsc:[ { title:"人事处",
        docs:"https://rssdocs.quickso.cn/university.html#xi-an-li-gong-da-xue" } ] },
  "xiaohongshu.com":{ _name:"小红书",
    ".":[ { title:"用户笔记",
        docs:"https://rssdocs.quickso.cn/social-media.html#xiao-hong-shu",
  ...
  "xiaoyuzhoufm.com":{ _name:"小宇宙",
    ".":[ { title:"发现",
        docs:"https://rssdocs.quickso.cn/multimedia.html#xiao-yu-zhou",
        source:[ "/" ],
        target:"/xiaoyuzhou" },
      { title:"播客",
        docs:"https://rssdocs.quickso.cn/multimedia.html#xiao-yu-zhou",
  ...
  "xiaozhuanlan.com":{ _name:"小专栏",
    ".":[ { title:"专栏",
        docs:"https://rssdocs.quickso.cn/new-media.html#xiao-zhuan-lan",
        source:"/:id",
        target:"/xiaozhuanlan/column/:id" } ] },
  "xidian.edu.cn":{ _name:"西安电子科技大学",
    jwc:[ { title:"教务处",
        docs:"https://rssdocs.quickso.cn/university.html#xi-an-dian-zi-ke-ji-da-xue",
        source:[ "/:category" ],
        target:(params) => `/xidian/jwc${params.category ? `/${params.category}` : ''}` } ] },
  "xjtu.edu.cn":{ _name:"西安交通大学",
    "2yuan":[ { title:"第二附属医院新闻",
        docs:"https://rssdocs.quickso.cn/university.html#xi-an-jiao-tong-da-xue-di-er-fu-shu-yi-yuan-xin-wen",
        source:[ "/" ],
        target:(params, url) => `/xjtu/2yuan/news/${new URL(url).toString().match(/\/Columns\/(\d+)\//)[1]}` } ],
    dean:[ { title:"教务处",
        docs:"https://rssdocs.quickso.cn/university.html#xi-an-jiao-tong-da-xue-jiao-wu-chu",
        source:[ "/" ],
        target:"/xjtu/dean/:subpath+" } ],
    ee:[ { title:"电气学院",
        docs:"https://rssdocs.quickso.cn/university.html#xi-an-jiao-tong-da-xue-dian-qi-xue-yuan",
        source:[ "/" ],
        target:"/xjtu/ee/:id?" } ],
    gs:[ { title:"研究生院通知公告",
        docs:"https://rssdocs.quickso.cn/university.html#xi-an-jiao-tong-da-xue-yan-jiu-sheng-xue-yuan-tong-zhi-gong-gao",
        source:[ "/" ],
        target:"/xjtu/gs/tzgg" } ],
    international:[ { title:"国际处通知",
        docs:"https://rssdocs.quickso.cn/university.html#xi-an-jiao-tong-da-xue-guo-ji-chu-tong-zhi",
        source:[ "/" ],
        target:"/xjtu/international/:subpath+" } ],
    std:[ { title:"科技在线",
        docs:"https://rssdocs.quickso.cn/university.html#xi-an-jiao-tong-da-xue-ke-ji-zai-xian",
        source:[ "/tzgg/:category",
          "/" ],
        target:(params, url) => `/xjtu/std/${new URL(url).toString().match(/\/(\w+)\.htm/)[1]}` } ],
    "www.dyyy":[ { title:"第一附属医院新闻",
        docs:"https://rssdocs.quickso.cn/university.html#xi-an-jiao-tong-da-xue",
        source:[ "/*" ],
        target:(_, url) => `/xjtu/dyyy${new URL(url).pathname.replace('.htm', '')}` } ] },
  "xmanhua.com":{ _name:"X 漫画",
    ".":[ { title:"最新动态",
        docs:"https://rssdocs.quickso.cn/anime.html#x-man-hua",
        source:[ "/:uid" ],
        target:"/xmanhua/:uid" } ] },
  "xmnn.cn":{ _name:"厦门网",
    epaper:[ { title:"数字媒体",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#xia-men-wang-shu-zi-mei-ti",
        source:[ "/:id",
          "/" ],
        target:"/xmnn/epaper/:id" } ] },
  "danjuanapp.com":{ _name:"雪球",
    ".":[ { title:"蛋卷基金净值更新",
        docs:"https://rssdocs.quickso.cn/finance.html#xue-qiu",
        source:[ "/funding/:id" ],
  ...
  "xwlb.com.cn":{ _name:"新闻联播直播",
    ".":[ { title:"新闻联播文字版完整版",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#yang-shi-xin-wen",
        source:[ "/cctv.html",
          "/" ],
        target:"/xwlb" } ] },
  "xyzrank.com":{ _name:"中文播客榜",
    ".":[ { title:"热门节目",
        docs:"https://rssdocs.quickso.cn/multimedia.html#zhong-wen-bo-ke-bang-re-men-jie-mu",
        source:[ "/#/",
          "/" ],
        target:"/xyzrank" },
      { title:"热门播客",
        docs:"https://rssdocs.quickso.cn/multimedia.html#zhong-wen-bo-ke-bang-re-men-bo-ke",
        source:[ "/#/hot-podcasts",
          "/" ],
        target:"/xyzrank/hot-podcasts" },
      { title:"新锐节目",
        docs:"https://rssdocs.quickso.cn/multimedia.html#zhong-wen-bo-ke-bang-xin-rui-jie-mu",
        source:[ "/#/hot-episodes-new",
          "/" ],
        target:"/xyzrank/hot-episodes-new" },
      { title:"新锐播客",
        docs:"https://rssdocs.quickso.cn/multimedia.html#zhong-wen-bo-ke-bang-xin-rui-bo-ke",
        source:[ "/#/new-podcasts",
          "/" ],
        target:"/xyzrank/new-podcasts" } ] },
  "yaohuo.me":{ _name:"妖火",
    ".":[ { title:"首页",
        docs:"https://rssdocs.quickso.cn/new-media.html#yao-huo-shou-ye",
        source:[ "/" ],
        target:"/yaohuo" } ] },
  "yicai.com":{ _name:"第一财经",
    ".":[ { title:"最新",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#di-yi-cai-jing-zui-xin",
        source:[ "/" ],
        target:"/yicai/latest" },
      { title:"头条",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#di-yi-cai-jing-tou-tiao",
        source:[ "/" ],
        target:"/yicai/headline" },
      { title:"VIP 频道",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#di-yi-cai-jing-vip-pin-dao",
        source:[ "/vip/product/:id",
          "/" ],
        target:"/yicai/vip/:id" },
      { title:"新闻",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#di-yi-cai-jing-xin-wen",
        source:[ "/news/:id",
          "/news" ],
        target:"/yicai/news/:id" },
      { title:"关注",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#di-yi-cai-jing-guan-zhu",
        source:[ "/feed/:id",
          "/feed" ],
        target:"/yicai/feed/:id" },
      { title:"视听",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#di-yi-cai-jing-shi-ting",
        source:[ "/video/:id",
          "/video" ],
        target:"/yicai/video/:id" },
      { title:"正在",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#di-yi-cai-jing-zheng-zai",
        source:[ "/brief" ],
        target:"/yicai/brief" },
      { title:"一财号",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#di-yi-cai-jing-yi-cai-hao",
        source:[ "/author/:id",
          "/author" ],
        target:"/yicai/author/:id" } ] },
  "ymgal.games":{ _name:"月幕 Galgame",
    ".":[ { title:"全部文章",
        docs:"https://rssdocs.quickso.cn/anime.html#yue-mu-galgame",
        source:[ "/co/article" ],
  ...
  "yoasobi-music.jp":{ _name:"Yoasobi Official",
    www:[ { title:"News",
        docs:"https://rssdocs.quickso.cn/en/live.html#yoasobi",
        source:[ "/",
          "/:category" ],
  ...
  "yomiuri.co.jp":{ _name:"読売新聞",
    www:[ { title:"読売新聞",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#du-mai-xin-wen",
        source:[ "/:category" ],
        target:"/yomiuri/:category" } ] },
  "youku.com":{ _name:"优酷",
    i:[ { title:"订阅作者",
        docs:"https://rssdocs.quickso.cn/multimedia.html#you-ku",
        source:[ "/i/:id" ],
        target:"/youku/channel/:id" } ] },
  "youtube.com":{ _name:"YouTube",
    www:[ { title:"用户",
        docs:"https://rssdocs.quickso.cn/social-media.html#youtube",
  ...
  "youzhiyouxing.cn":{ _name:"有知有行",
    ".":[ { title:"有知 - 全部",
        docs:"https://rssdocs.quickso.cn/finance.html#you-you-wei-zhi-zhi-you-you-wei-xing-hang-xing-hang-heng-you-you-wei-zhi-zhi-wen-zhang-zhang",
        source:[ "/materials" ],
  ...
  "yunspe.com":{ _name:"云奇网",
    ".":[ { title:"微语简报",
        docs:"https://rssdocs.quickso.cn/new-media.html#wei-yu-jian-bao",
  ...
  "yxdown.com":{ _name:"游讯网",
    ".":[ { title:"资讯",
        docs:"https://rssdocs.quickso.cn/game.html#you-xun-wang",
        source:[ "/news/:category",
          "/news" ],
  ...
  "yxdzqb.com":{ _name:"游戏打折情报",
    ".":[ { title:"游戏折扣",
        docs:"https://rssdocs.quickso.cn/game.html#you-xi-da-zhe-qing-bao-you-xi-zhe-kou",
        source:"/",
        target:"/yxdzqb/:type" } ] },
  "yysub.net":{ _name:"人人影视",
    ".":[ { title:"影视资讯",
        docs:"https://rssdocs.quickso.cn/multimedia#ren-ren-ying-shi",
        source:"/article",
  ...
  "yystv.cn":{ _name:"游研社",
    ".":[ { title:"推游",
        docs:"https://rssdocs.quickso.cn/game.html#you-yan-she",
        source:"/b/recommend",
  ...
  "myzaker.com":{ _name:"ZAKER",
    ".":[ { title:"分类",
        docs:"https://rssdocs.quickso.cn/new-media.html#zaker",
        source:[ "/:type/:id" ],
  ...
  "zaobao.com":{ _name:"联合早报",
    www:[ { title:"新闻-新加坡",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#lian-he-zao-bao-xin-wen",
        source:[ "/",
          "/news",
          "/news/singapore" ],
  ...
  "zcool.com.cn":{ _name:"站酷",
    www:[ { title:"发现",
        docs:"https://rssdocs.quickso.cn/design.html#zhan-ku",
        source:[ "/discover",
          "/" ],
  ...
  "zhangyoubao.com":{ _name:"掌游宝",
    mobile:[ { title:"推荐",
        docs:"https://rssdocs.quickso.cn/game.html#zhang-you-bao-tui-jian",
        source:[ "/:category/" ],
        target:"/zhangyoubao/:category" } ] },
  "zhibo8.cc":{ _name:"直播吧",
    bbs:[ { title:"子论坛",
        docs:"https://rssdocs.quickso.cn/bbs.html#zhi-bo-ba",
        source:[ "/" ],
  ...
  "zhitongcaijing.com":{ _name:"智通财经",
    ".":[ { title:"资讯",
        docs:"https://rssdocs.quickso.cn/finance.html#zhi-tong-cai-jing-zi-xun",
        source:[ "/:category",
          "/" ],
        target:(params, url) => {
  ...
  "zhubai.love":{ _name:"竹白",
    ".":[ { title:"文章",
        docs:"https://rssdocs.quickso.cn/blog.html#zhu-bai",
        source:[ "/" ] } ] },
  "zjgtjy.cn":{ _name:"浙江省土地使用权网上交易系统",
    ".":[ { title:"全部更新",
        docs:"https://rssdocs.quickso.cn/government.html",
        source:"/",
        target:"/zjgtjy/all" },
      { title:"挂牌公告",
        docs:"https://rssdocs.quickso.cn/government.html",
  ...
  "zju.edu.cn":{ _name:"浙江大学",
    physics:[ { title:"物理学院",
        docs:"https://rssdocs.quickso.cn/university.html#zhe-jiang-da-xue",
        source:[ "/*path" ],
        target:(params) => {
                    let type;
                    switch (params.path) {
  ...
  "zodgame.xyz":{ _name:"zodgame",
    ".":[ { title:"论坛版块",
        docs:"https://rssdocs.quickso.cn/bbs.html#zodgame",
        source:"/forum.php",
        target:(params, url) => {
  ...
  "zoo.team":{ _name:"政采云前端技术团队",
    weekly:[ { title:"小报",
        docs:"https://rssdocs.quickso.cn/blog.html#zheng-cai-yun-qian-duan-ji-shu-tuan-dui",
        source:"/",
  ...
  "zotero.org":{ _name:"Zotero",
    ".":[ { title:"Version History",
        docs:"https://rssdocs.quickso.cn/program-update.html#zotero",
        source:[ "/",
          "/support/changelog" ],
        target:"/zotero/versions" } ] },
  "zuel.edu.cn":{ _name:"中南财经政法大学",
    wap:[ { title:"通知公告",
        docs:"https://rssdocs.quickso.cn/univeristy.html#zhong-nan-cai-jing-zheng-fa-da-xue-tong-zhi-gong-gao",
        source:[ "/",
          "/notice/list.htm" ],
        target:"/zuel/notice" } ] },
  "zuvio.com.tw":{ _name:"Zuvio",
    irs:[ { title:"校園話題",
        docs:"https://rssdocs.quickso.cn/bbs.html#zuvio",
  ...
  "zyshow.net":{ _name:"综艺秀",
    ".":[ { title:"综艺",
        docs:"https://rssdocs.quickso.cn/multimedia.html#zong-yi-xiu-zong-yi",
        source:[ "/:region/:id",
          "/:id",
          "/" ],
        target:(params, url) =>
  ...
  "ximalaya.com":{ _name:"喜马拉雅",
    ".":[ { title:"专辑",
        docs:"https://rssdocs.quickso.cn/multimedia.html#xi-ma-la-ya",
        source:"/:type/:id",
        target:(params) => {
  ...
  "algocasts.io":{ _name:"AlgoCasts",
    ".":[ { title:"视频更新",
        docs:"https://rssdocs.quickso.cn/programming.html#algocasts",
        source:"/episodes",
        target:"/algocasts" } ] },
  "soulapp.cn":{ _name:"Soul",
    ".":[ { title:"瞬间更新",
        docs:"https://rssdocs.quickso.cn/social-media.html#soul" } ] },
  "anime1.me":{ _name:"Anime1",
    ".":[ { title:"動畫",
        docs:"https://rssdocs.quickso.cn/anime.html#anime1",
  ...
  "swufe.edu.cn":{ _name:"西南财经大学",
    it:[ { title:"经济信息工程学院 - 通知公告",
        docs:"https://rssdocs.quickso.cn/university.html#xi-nan-cai-jing-da-xue",
        source:"/index/tzgg.htm",
  ...
  "ishuhui.com":{ _name:"鼠绘漫画",
    www:[ { title:"鼠绘漫画",
        docs:"https://rssdocs.quickso.cn/anime.html#shu-hui-man-hua",
        source:"/comics/anime/:id",
        target:"/shuhui/comics/:id" } ] },
  "www.chicagotribune.com":{ _name:"Chicago Tribune",
    www:[ { title:"Chicago Tribune",
        docs:"https://rssdocs.quickso.cn/traditional_media.html#chicago-tribune",
        source:"/" } ] },
  "haimaoba.com":{ _name:"海猫吧",
    www:[ { title:"漫画更新",
        docs:"https://rssdocs.quickso.cn/anime.html#hai-mao-ba",
        source:"/catalog/:id",
        target:"/haimaoba/:id" } ] },
  "pgyer.com":{ _name:"蒲公英应用分发",
    www:[ { title:"app更新",
        docs:"https://rssdocs.quickso.cn/program-update.html#pu-gong-ying-ying-yong-fen-fa",
        source:"/:app",
        target:"/pgyer/:app" } ] },
  "wineyun.com":{ _name:"酒云网",
    www:[ { title:"最新商品",
        docs:"https://rssdocs.quickso.cn/other.html#jiu-yun-wang",
        source:[ "/:category" ],
        target:"/wineyun/:category" } ] },
  "epicgames.com":{ _name:"Epic Games",
    www:[ { title:"每周免费游戏",
        docs:"https://rssdocs.quickso.cn/game.html#epicgames-freegame",
        source:"/store/zh-CN/free-games",
        target:"/epicgames/freegames" } ] },
  "playstation.com":{ _name:"PlayStation",
    store:[ { title:"游戏列表",
        docs:"https://rssdocs.quickso.cn/game.html#playstation",
  ...
  "monsterhunter.com":{ _name:"怪物猎人世界",
    www:[ { title:"更新情报",
        docs:"https://rssdocs.quickso.cn/game.html#guai-wu-lie-ren-shi-jie",
        source:[ "",
          "/*tpath" ],
        target:"/mhw/update" },
      { title:"最新消息",
  ...
  "vgtime.com":{ _name:"游戏时光",
    www:[ { title:"新闻",
        docs:"https://rssdocs.quickso.cn/game.html#you-xi-shi-guang",
  ...
  "bing.com":{ _name:"Bing",
    www:[ { title:"每日壁纸",
        docs:"https://rssdocs.quickso.cn/picture.html#bing-bi-zhi",
        source:"",
        target:"/bing" } ] },
  "wegene.com":{ _name:"WeGene",
    www:[ { title:"最近更新",
        docs:"https://rssdocs.quickso.cn/other.html#wegene",
        source:"",
  ...
  "qdaily.com":{ _name:"好奇心日报",
    www:[ { title:"标签",
        docs:"https://rssdocs.quickso.cn/new-media.html#hao-qi-xin-ri-bao",
        source:"/tags/:idd",
  ...
  "3ycy.com":{ _name:"三界异次元",
    www:[ { title:"最近更新",
        docs:"https://rssdocs.quickso.cn/anime.html#san-jie-yi-ci-yuan",
        source:"/",
        target:"/3ycy/home" } ] },
  "emi-nitta.net":{ _name:"Emi Nitta",
    ".":[ { title:"最近更新",
        docs:"https://rssdocs.quickso.cn/other.html#xin-tian-hui-hai-guan-fang-wang-zhan",
        source:"/updates",
  ...
  "alter-shanghai.cn":{ _name:"Alter",
    ".":[ { title:"新闻",
        docs:"https://rssdocs.quickso.cn/shopping.html#alter-zhong-guo",
        source:"/cn/news.html",
        target:"/alter-cn/news" } ] },
  "itslide.com":{ _name:"ITSlide",
    www:[ { title:"最新",
        docs:"https://rssdocs.quickso.cn/programming.html#itslide",
        source:"/*",
        target:"/itslide/new" } ] },
  "leboncoin.fr":{ _name:"leboncoin",
    www:[ { title:"ads",
        docs:"https://rssdocs.quickso.cn/en/shopping.html#leboncoin",
        source:"/recherche",
        target:(params, url) => '/leboncoin/ad/' + url.split('?')[1] } ] },
  "yuancheng.work":{ _name:"远程.work",
    ".":[ { title:"招聘信息",
        docs:"https://rssdocs.quickso.cn/other.html#yuan-cheng-work",
        source:"/:caty",
        target:(params, url) => {
                    if (!url) {
                        return '/remote-work';
  ...
  "chinatimes.com":{ _name:"中時電子報",
    www:[ { title:"新聞",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#zhong-shi-dian-zi-bao",
        source:"/:caty",
        target:(params) => '/chinatimes/' + params.caty } ] },
  "govopendata.com":{ _name:"新闻联播文字版",
    cn:[ { title:"新闻联播文字版",
        docs:"https://rssdocs.quickso.cn/traditional-media.html#xin-wen-lian-bo-wen-zi-ban",
        source:"/xinwenlianbo",
        target:"/xinwenlianbo/index" } ] },
  "steampowered.com":{ _name:"Steam",
    store:[ { title:"search",
        docs:"https://rssdocs.quickso.cn/game.html#steam",
        source:"/search/",
        target:(params, url) => `/steam/search/${new URL(url).searchParams}` } ] },
  "xiaomi.cn":{ _name:"小米社区",
    www:[ { title:"圈子",
        docs:"https://rssdocs.quickso.cn/bbs.html#xiao-mi-she-qu",
        source:"/board/:boardId",
        target:"/mi/bbs/board/:boardId" } ] },
  "suzhou.gov.cn":{ _name:"苏州市政府",
    www:[ { title:"政府新闻",
        docs:"https://rssdocs.quickso.cn/government.html#su-zhou-shi-ren-min-zheng-fu",
        source:"/szsrmzf/:uid/nav_list.shtml",
        target:"/gov/suzhou/news/:uid" } ] },
  "mqube.net":{ _name:"MQube",
    www:[ { title:"全站最近更新",
        docs:"https://rssdocs.quickso.cn/multimedia.html#mqube",
        source:"/",
        target:"/mqube/latest" },
      { title:"全站每日排行",
        docs:"https://rssdocs.quickso.cn/multimedia.html#mqube",
  ...
  "last.fm":{ _name:"Last.fm",
    www:[ { title:"用户播放记录",
        docs:"https://rssdocs.quickso.cn/multimedia.html#last-fm",
        source:[ "/user/:user",
          "/user/:user/*" ],
  ...
  "ddrk.me":{ _name:"低端影视",
    www:[ { title:"首页",
        docs:"https://rssdocs.quickso.cn/multimedia.html#di-duan-ying-shi",
        source:"/",
        target:"/ddrk/index" },
      { title:"标签",
        docs:"https://rssdocs.quickso.cn/multimedia.html#di-duan-ying-shi",
  ...
  "hackerone.com":{ _name:"HackerOne",
    ".":[ { title:"HackerOne Hacker Activity",
        docs:"https://rssdocs.quickso.cn/other.html#hackerone-hacker-activity",
        source:"/hacktivity",
        target:"/hackerone/hacktivity" } ] },
  "cowlevel.net":{ _name:"奶牛关",
    ".":[ { title:"元素文章",
        docs:"https://rssdocs.quickso.cn/game.html#nai-niu-guan",
        source:[ "/element/:id",
          "/element/:id/article" ],
        target:"/cowlevel/element/:id" } ] },
  "ynu.edu.cn":{ _name:"云南大学",
    home:[ { title:"官网消息通告",
        docs:"https://rssdocs.quickso.cn/university.html#yun-nan-da-xue",
        source:"/tzgg.htm",
        target:"/ynu/home" } ],
    jwc:[ { title:"教务处教务科通知",
        docs:"https://rssdocs.quickso.cn/university.html#yun-nan-da-xue",
  ...
  "japanpost.jp":{ _name:"日本郵便",
    "trackings.post":[ { title:"郵便・荷物の追跡",
        docs:"https://rssdocs.quickso.cn/other.html#ri-ben-you-bian-you-bian-zhui-ji-サービス",
  ...
  "matters.news":{ _name:"Matters",
    ".":[ { title:"最新排序",
        docs:"https://rssdocs.quickso.cn/new-media.html#matters",
        source:"",
  ...
  "zhaishuyuan.com":{ _name:"斋书苑",
    ".":[ { title:"最新章节",
        docs:"https://rssdocs.quickso.cn/reading.html#zhai-shu-yuan",
        source:[ "/book/:id",
          "/read/:id" ],
        target:"/novel/zhaishuyuan/:id" } ] },
  "hbut.edu.cn":{ _name:"湖北工业大学",
    www:[ { title:"新闻中心",
        docs:"http://rssdocs.quickso.cn/university.html#hu-bei-gong-ye-da-xue",
        source:"/xwzx/:name",
        target:(params) => {
  ...
  "zhuixinfan.com":{ _name:"追新番日剧站",
    ".":[ { title:"更新列表",
        docs:"https://rssdocs.quickso.cn/multimedia.html#zhui-xin-fan-ri-ju-zhan",
        source:[ "/main.php" ],
        target:"/zhuixinfan/list" } ] },
  "etoland.co.kr":{ _name:"eTOLAND",
    ".":[ { title:"主题贴",
        docs:"https://rssdocs.quickso.cn/bbs.html#etoland",
  ...
  "onejav.com":{ _name:"OneJAV BT",
    ".":[ { title:"今日种子",
        docs:"https://rssdocs.quickso.cn/multimedia.html#onejav",
        source:"/",
        target:(params, url, document) => {
  ...
  "141jav.com":{ _name:"141JAV BT",
    ".":[ { title:"今日种子",
        docs:"https://rssdocs.quickso.cn/multimedia.html#141jav",
        source:"/",
        target:(params, url, document) => {
                    const today = document.querySelector('div.card.mb-1.card-overview').getAttribute('data-date').replace(/-/g, '');
  ...
  "141ppv.com":{ _name:"141ppv BT",
    ".":[ { title:"今日种子",
        docs:"https://rssdocs.quickso.cn/multimedia.html#141pvp",
        source:"/",
        target:(params, url, document) => {
                    const today = document.querySelector('div.card.mb-1.card-overview').getAttribute('data-date').replace(/-/g, '');
      ...
      { title:"今日演员",
        docs:"https://rssdocs.quickso.cn/multimedia.html#141ppv",
        source:"/",
        target:(params, url, document) => {
                    const star = document.querySelector('div.card-content > div > a').getAttribute('href');
                    return `/141ppv${star}`;
  ...
  "sexinsex.net":{ _name:"sexinsex",
    ".":[ { title:"分区帖子",
        docs:"https://rssdocs.quickso.cn/multimedia.html#sexinsex",
        source:"/bbs/:path",
        target:(params, url) => {
                    let pid, typeid;
                    const static_matched = params.path.match(/forum-(\d+)-\d+.html/);
  ...
  "t66y.com":{ _name:"草榴社区",
    www:[ { title:"分区帖子",
        docs:"https://rssdocs.quickso.cn/multimedia.html#cao-liu-she-qu",
  ...
  "umass.edu":{ _name:"UMASS Amherst",
    ece:[ { title:"ECE News",
        docs:"http://rssdocs.quickso.cn/en/university.html#umass-amherst",
        source:"/news",
  ...
  "yuque.com":{ _name:"语雀",
    www:[ { title:"知识库",
        docs:"https://rssdocs.quickso.cn/study.html#yu-que",
        source:[ "/:space/:book" ],
        target:(params, url, document) => {
  ...
  "bjeea.com":{ _name:"北京考试院",
    www:[ { title:"首页 / 通知公告",
        docs:"https://rssdocs.quickso.cn/government.html#bei-jing-jiao-yu-kao-shi-yuan",
        source:[ "/html/bjeeagg" ],
  ...
  "popiapp.cn":{ _name:"Popi 提问箱",
    www:[ { title:"提问箱新回答",
        docs:"https://rssdocs.quickso.cn/social-media.html#popi-ti-wen-xiang",
        source:"/:id",
        target:(params) => {
                    if (params.id) {
                        return '/popiask/:id';
  ...
  "nppa.gov.cn":{ _name:"国家新闻出版署",
    www:[ { title:"栏目",
        docs:"https://rssdocs.quickso.cn/government.html#guo-jia-xin-wen-chu-ban-shu",
  ...
  "jjmhw.cc":{ _name:"漫小肆",
    www:[ { title:"漫画更新",
        docs:"https://rssdocs.quickso.cn/anime.html#man-xiao-si",
        source:"/book/:id",
        target:"/manxiaosi/book/:id" } ] },
  "wenxuecity.com":{ _name:"文学城",
    blog:[ { title:"博客",
        docs:"https://rssdocs.quickso.cn/bbs.html#wen-xue-cheng-bo-ke",
        source:"/myblog/:id",
      ...
      { title:"博客",
        ...
        target:"/wenxuecity/blog/:id" } ],
    bbs:[ { title:"最新主题",
        docs:"https://rssdocs.quickso.cn/bbs.html#wen-xue-cheng-zui-xin-zhu-ti",
        source:"/:cat",
      ...
      { title:"最热主题",
        docs:"https://rssdocs.quickso.cn/bbs.html#wen-xue-cheng-zui-re-zhu-ti",
        source:"/?cid=*",
        target:(params, url, document) => {
  ...
  "buaq.net":{ _name:"不安全资讯",
    ".":[ { title:"不安全资讯",
        docs:"http://rssdocs.quickso.cn/new-media.html#bu-an-quan",
        source:"/",
        target:"/buaq" } ] },
  "jian-ning.com":{ _name:"建宁闲谈",
    ".":[ { title:"文章",
        docs:"https://rssdocs.quickso.cn/blog.html#jian-ning-xian-tan",
        source:"/*",
        target:"/blogs/jianning" } ] },
  "matataki.io":{ _name:"matataki",
    www:[ { title:"最热作品",
        docs:"https://rssdocs.quickso.cn/new-media.html#matataki",
        source:"/article/",
  ...
  "instagram.com":{ _name:"Instagram",
    www:[ { title:"用户",
        docs:"https://rssdocs.quickso.cn/social-media.html#instagram",
        source:"/:id",
        target:(params) => {
  ...
  "huya.com":{ _name:"虎牙直播",
    ".":[ { title:"直播间开播",
        docs:"https://rssdocs.quickso.cn/live.html#hu-ya-zhi-bo-zhi-bo-jian-kai-bo",
        source:"/:id",
        target:"/huya/live/:id" } ] },
  "craigslist.org":{ _name:"Craigslist",
    ".":[ { title:"商品搜索列表",
        docs:"https://rssdocs.quickso.cn/shopping.html#craigslist" } ] },
  "scboy.com":{ _name:"scboy 论坛",
    www:[ { title:"帖子",
        docs:"https://rssdocs.quickso.cn/bbs.html#scboy",
        source:"",
        target:(params, url) => {
  ...
  "cqut.edu.cn":{ _name:"重庆理工大学",
    tz:[ { title:"通知",
        docs:"https://rssdocs.quickso.cn/university.html#chong-qing-li-gong-da-xue",
        source:"/*" } ],
    lib:[ { title:"图书馆通知",
        docs:"https://rssdocs.quickso.cn/university.html#chong-qing-li-gong-da-xue",
        source:"/*" } ] },
  "trakt.tv":{ _name:"Trakt.tv",
    ".":[ { title:"用户收藏",
        docs:"https://rssdocs.quickso.cn/multimedia.html#trakt-tv-yong-hu-shou-cang",
  ...
  "furaffinity.net":{ _name:"Fur Affinity",
    www:[ { title:"主页",
        docs:"https://rssdocs.quickso.cn/social-media.html#fur-affinity",
        source:"/",
  ...
  "e-hentai.org/":{ _name:"E-Hentai",
    ".":[ { title:"收藏",
        docs:"https://rssdocs.quickso.cn/picture.html#ehentai",
        source:"/favorites.php",
  ...
  "macwk.com":{ _name:"MacWk",
    ".":[ { title:"应用更新",
        docs:"https://rssdocs.quickso.cn/program-update.html#macwk",
        source:"/soft/:name",
